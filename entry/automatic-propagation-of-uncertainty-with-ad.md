...
![12.3\\,\\mathrm{cm}](https://latex.codecogs.com/gif.latex?12.3%5C%2C%5Cmathrm%7Bcm%7D "12.3\,\mathrm{cm}"),
that doesn’t mean it’s
![12.300000\\,\\mathrm{cm}](https://latex.codecogs.com/gif.latex?12.300000%5C%2C%5Cmathrm%7Bcm%7D "12.300000\,\mathrm{cm}")
— it means that it’s somewhere between
![12.2\\,\\mathrm{cm}](https://latex.codecogs.com/gif.latex?12.2%5C%2C%5Cmathrm%7Bcm%7D "12.2\,\mathrm{cm}")
and
![12.4\\,\\mathrm{cm}](https://latex.codecogs.com/gif.latex?12.4%5C%2C%5Cmathrm%7Bcm%7D "12.4\,\mathrm{cm}")…and
we don’t know exactly. We can write it as
![12.3 \\pm 0.1\\,\\mathrm{cm}](https://latex.codecogs.com/gif.latex?12.3%20%5Cpm%200.1%5C%2C%5Cmathrm%7Bcm%7D "12.3 \pm 0.1\,\mathrm{cm}").
The interesting thing happens when we try to add, multiply, divide numbers with
uncertainty. What happens when you “add”
![12 \\pm 3](https://latex.codecogs.com/gif.latex?12%20%5Cpm%203 "12 \pm 3") and
![19 \\pm 6](https://latex.codecogs.com/gif.latex?19%20%5Cpm%206 "19 \pm 6")?

The initial guess might be
![31 \\pm 9](https://latex.codecogs.com/gif.latex?31%20%5Cpm%209 "31 \pm 9"),
because one is ![\\pm 3](https://latex.codecogs.com/gif.latex?%5Cpm%203 "\pm 3")
and the other is
![\\pm 6](https://latex.codecogs.com/gif.latex?%5Cpm%206 "\pm 6"). But! If you
...
![31 \\pm 7](https://latex.codecogs.com/gif.latex?31%20%5Cpm%207 "31 \pm 7").
...
If I have a value
![16 \\pm 3](https://latex.codecogs.com/gif.latex?16%20%5Cpm%203 "16 \pm 3")
...
![25 \\pm 4](https://latex.codecogs.com/gif.latex?25%20%5Cpm%204 "25 \pm 4"), it
...
![\\pm 7](https://latex.codecogs.com/gif.latex?%5Cpm%207 "\pm 7"). It would only
be ![\\pm 7](https://latex.codecogs.com/gif.latex?%5Cpm%207 "\pm 7") if the
...
![\\pm 7](https://latex.codecogs.com/gif.latex?%5Cpm%207 "\pm 7"). But, because
...
![\\pm 7](https://latex.codecogs.com/gif.latex?%5Cpm%207 "\pm 7"). In fact,
it’ll actually be around
![\\pm 5](https://latex.codecogs.com/gif.latex?%5Cpm%205 "\pm 5").

In general, we find that for *independent*
![X](https://latex.codecogs.com/gif.latex?X "X") and
![Y](https://latex.codecogs.com/gif.latex?Y "Y"):

![
\\operatorname{Var}\[aX + bY + c\] = a\^2 \\sigma\_X\^2 + b\^2 \\sigma\_Y\^2
](https://latex.codecogs.com/gif.latex?%0A%5Coperatorname%7BVar%7D%5BaX%20%2B%20bY%20%2B%20c%5D%20%3D%20a%5E2%20%5Csigma_X%5E2%20%2B%20b%5E2%20%5Csigma_Y%5E2%0A "
\operatorname{Var}[aX + bY + c] = a^2 \sigma_X^2 + b^2 \sigma_Y^2
")

Where
![\\sigma\_X\^2](https://latex.codecogs.com/gif.latex?%5Csigma_X%5E2 "\sigma_X^2")
is the variance in ![X](https://latex.codecogs.com/gif.latex?X "X"). We consider
![\\sigma\_X](https://latex.codecogs.com/gif.latex?%5Csigma_X "\sigma_X") to be
the standard deviation of ![X](https://latex.codecogs.com/gif.latex?X "X"), or
the “plus or minus” part of our numbers. In the simple case of addition, we have
![\\operatorname{Var}\[X + Y\] = \\sigma\_X\^2 + \\sigma\_Y\^2](https://latex.codecogs.com/gif.latex?%5Coperatorname%7BVar%7D%5BX%20%2B%20Y%5D%20%3D%20%5Csigma_X%5E2%20%2B%20%5Csigma_Y%5E2 "\operatorname{Var}[X + Y] = \sigma_X^2 + \sigma_Y^2"),
so our new uncertainty is
![\\sqrt{\\sigma\_X\^2 + \\sigma\_Y\^2}](https://latex.codecogs.com/gif.latex?%5Csqrt%7B%5Csigma_X%5E2%20%2B%20%5Csigma_Y%5E2%7D "\sqrt{\sigma_X^2 + \sigma_Y^2}").[^2]

However, not all functions that combine
![X](https://latex.codecogs.com/gif.latex?X "X") and
![Y](https://latex.codecogs.com/gif.latex?Y "Y") can be expressed as simple
linear combinations
![aX + bY + c](https://latex.codecogs.com/gif.latex?aX%20%2B%20bY%20%2B%20c "aX + bY + c").
...
](https://latex.codecogs.com/gif.latex?%0Af%28x_0%20%2B%20x%2C%20y_0%20%2B%20y%29%20%5Capprox%20f_x%28x_0%2C%20y_0%29%20x%20%2B%20f_y%28x_0%2C%20y_0%29%20y%20%2B%20f%28x_0%2C%20y_0%29%0A "
f(x_0 + x, y_0 + y) \approx f_x(x_0, y_0) x + f_y(x_0, y_0) y + f(x_0, y_0)
")

Where
![f\_x(x\_0,y\_0)](https://latex.codecogs.com/gif.latex?f_x%28x_0%2Cy_0%29 "f_x(x_0,y_0)")
is the first (partial) derivative with respect to
![x](https://latex.codecogs.com/gif.latex?x "x") at
![(x\_0, y\_0)](https://latex.codecogs.com/gif.latex?%28x_0%2C%20y_0%29 "(x_0, y_0)").
This gives us an approximation of
![f](https://latex.codecogs.com/gif.latex?f "f") at locations close to
![(x\_0, y\_0)](https://latex.codecogs.com/gif.latex?%28x_0%2C%20y_0%29 "(x_0, y_0)").
...
![(\\mu\_X, \\mu\_Y)](https://latex.codecogs.com/gif.latex?%28%5Cmu_X%2C%20%5Cmu_Y%29 "(\mu_X, \mu_Y)"),
the center/expected value of ![X](https://latex.codecogs.com/gif.latex?X "X")
and ![Y](https://latex.codecogs.com/gif.latex?Y "Y"), we see:

![
\\operatorname{Var}\[f(X,Y)\] \\approx f\_x(\\mu\_X, \\mu\_Y)\^2 \\sigma\_X\^2 + f\_y(\\mu\_X,\\mu\_Y)\^2 \\sigma\_Y\^2
](https://latex.codecogs.com/gif.latex?%0A%5Coperatorname%7BVar%7D%5Bf%28X%2CY%29%5D%20%5Capprox%20f_x%28%5Cmu_X%2C%20%5Cmu_Y%29%5E2%20%5Csigma_X%5E2%20%2B%20f_y%28%5Cmu_X%2C%5Cmu_Y%29%5E2%20%5Csigma_Y%5E2%0A "
...
](https://latex.codecogs.com/gif.latex?%0A%5Coperatorname%7BE%7D%5Bf%28X%2CY%29%5D%20%5Capprox%0Af%28%5Cmu_X%2C%20%5Cmu_Y%29%20%2B%20%5Cfrac%7B1%7D%7B2%7D%0A%5Cleft%5B%20f_%7Bxx%7D%28%5Cmu_X%2C%20%5Cmu_Y%29%20%5Csigma_X%5E2%20%2B%20f_%7Byy%7D%28%5Cmu_X%2C%20%5Cmu_Y%29%20%5Csigma_Y%5E2%20%5Cright%5D%0A "
\operatorname{E}[f(X,Y)] \approx
...
Where
![f\_{xx}(\\mu\_X, \\mu\_Y)](https://latex.codecogs.com/gif.latex?f_%7Bxx%7D%28%5Cmu_X%2C%20%5Cmu_Y%29 "f_{xx}(\mu_X, \mu_Y)")
is the second (partial) derivative with respect to
![x](https://latex.codecogs.com/gif.latex?x "x") twice at
![(\\mu\_X, \\mu\_Y)](https://latex.codecogs.com/gif.latex?%28%5Cmu_X%2C%20%5Cmu_Y%29 "(\mu_X, \mu_Y)")

For our case of simple addition,
![\\operatorname{E}\[X + Y\] = \\mu\_X + \\mu\_Y](https://latex.codecogs.com/gif.latex?%5Coperatorname%7BE%7D%5BX%20%2B%20Y%5D%20%3D%20%5Cmu_X%20%2B%20%5Cmu_Y "\operatorname{E}[X + Y] = \mu_X + \mu_Y"),
because the second-order partials of
![f(x,y) = x + y](https://latex.codecogs.com/gif.latex?f%28x%2Cy%29%20%3D%20x%20%2B%20y "f(x,y) = x + y")
are 0.
...
![4\^2 - 2 \\times 4\^3](https://latex.codecogs.com/gif.latex?4%5E2%20-%202%20%5Ctimes%204%5E3 "4^2 - 2 \times 4^3").
The second is the derivative
(![2 x - 6x\^2](https://latex.codecogs.com/gif.latex?2%20x%20-%206x%5E2 "2 x - 6x^2"))
at 4, the third is the second derivative
![2 - 12 x](https://latex.codecogs.com/gif.latex?2%20-%2012%20x "2 - 12 x") at
4, then the third derivative
![-12](https://latex.codecogs.com/gif.latex?-12 "-12"), then the fourth
derivative ![0](https://latex.codecogs.com/gif.latex?0 "0"), etc.
...
](https://latex.codecogs.com/gif.latex?%0A%5Coperatorname%7BE%7D%5Bf%28X%29%5D%20%3D%20f%28%5Cmu_X%29%20%2B%20%5Cfrac%7B1%7D%7B2%7D%20f_%7Bxx%7D%28%5Cmu_X%29%20%5Csigma_X%5E2%0A "
\operatorname{E}[f(X)] = f(\mu_X) + \frac{1}{2} f_{xx}(\mu_X) \sigma_X^2
")

![
\\operatorname{Var}\[f(X)\] = f\_x(\\mu\_X)\^2 \\sigma\_X\^2
](https://latex.codecogs.com/gif.latex?%0A%5Coperatorname%7BVar%7D%5Bf%28X%29%5D%20%3D%20f_x%28%5Cmu_X%29%5E2%20%5Csigma_X%5E2%0A "
\operatorname{Var}[f(X)] = f_x(\mu_X)^2 \sigma_X^2
")

And we call ![\\mu\_X](https://latex.codecogs.com/gif.latex?%5Cmu_X "\mu_X") `x`
and
![\\sigma\_X\^2](https://latex.codecogs.com/gif.latex?%5Csigma_X%5E2 "\sigma_X^2")
`vx`, and this becomes:
...
The gradient of
![f(x, y) = x y\^2 + 3x](https://latex.codecogs.com/gif.latex?f%28x%2C%20y%29%20%3D%20x%20y%5E2%20%2B%203x "f(x, y) = x y^2 + 3x")
is
![(y\^2 + 3, 2xy)](https://latex.codecogs.com/gif.latex?%28y%5E2%20%2B%203%2C%202xy%29 "(y^2 + 3, 2xy)"),
which, at
![(3, 1)](https://latex.codecogs.com/gif.latex?%283%2C%201%29 "(3, 1)"), is
indeed ![(4, 6)](https://latex.codecogs.com/gif.latex?%284%2C%206%29 "(4, 6)").
...
![f(x,y)](https://latex.codecogs.com/gif.latex?f%28x%2Cy%29 "f(x,y)") is
...
\\end{bmatrix}
](https://latex.codecogs.com/gif.latex?%0A%5Cbegin%7Bbmatrix%7D%0Af_%7Bxx%7D%28x%2C%20y%29%20%26%20f_%7Byx%7D%28x%2C%20y%29%20%5C%5C%0Af_%7Byx%7D%28x%2C%20y%29%20%26%20f_%7Byy%7D%28x%2C%20y%29%0A%5Cend%7Bbmatrix%7D%0A "
\begin{bmatrix}
f_{xx}(x, y) & f_{yx}(x, y) \\
f_{yx}(x, y) & f_{yy}(x, y)
\end{bmatrix}
...
![f\_{xx}](https://latex.codecogs.com/gif.latex?f_%7Bxx%7D "f_{xx}") and
![f\_{yy}](https://latex.codecogs.com/gif.latex?f_%7Byy%7D "f_{yy}"). Indeed,
the double-partial of our function respect to
![x](https://latex.codecogs.com/gif.latex?x "x") is
![0](https://latex.codecogs.com/gif.latex?0 "0"), and the double-partial with
respect to ![y](https://latex.codecogs.com/gif.latex?y "y") is
![2x](https://latex.codecogs.com/gif.latex?2x "2x"), which gives us a hessian
with a diagonal
![(0, 6)](https://latex.codecogs.com/gif.latex?%280%2C%206%29 "(0, 6)") for the
input ![(3, 1)](https://latex.codecogs.com/gif.latex?%283%2C%201%29 "(3, 1)").
...
![\\operatorname{log}(x\^y)](https://latex.codecogs.com/gif.latex?%5Coperatorname%7Blog%7D%28x%5Ey%29 "\operatorname{log}(x^y)")
