...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{!!!}\NormalTok{monad}\FunctionTok{-}\NormalTok{plus}\FunctionTok{/}\NormalTok{MaybeGame.hs }\StringTok{"die or fail"} \StringTok{"if not dead"} \StringTok{"damage the player"} \StringTok{"an alternative"} \StringTok{"increase"}
\end{Highlighting}
\end{Shaded}
