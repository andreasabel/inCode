...
\OtherTok{centralize ::}\NormalTok{ [}\DataTypeTok{Point}\NormalTok{] }\OtherTok{->}\NormalTok{ [}\DataTypeTok{Point}\NormalTok{]}
...
\NormalTok{    mean               }\FunctionTok{=}\NormalTok{ tot }\FunctionTok{L.^/}\NormalTok{ len}
