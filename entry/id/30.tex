...
\NormalTok{    fs }\OperatorTok{<*>}\NormalTok{ xs }\OtherTok{=}\NormalTok{ [ f x }\OperatorTok{|}\NormalTok{ f }\OtherTok{<{-}}\NormalTok{ fs, x }\OtherTok{<{-}}\NormalTok{ xs ]}

\KeywordTok{instance} \DataTypeTok{Applicative}\NormalTok{ [] }\KeywordTok{where}
    \FunctionTok{pure}      \OtherTok{=} \FunctionTok{repeat}
\NormalTok{    fs }\OperatorTok{<*>}\NormalTok{ xs }\OtherTok{=} \FunctionTok{zipWith}\NormalTok{ (}\OperatorTok{$}\NormalTok{) fs xs}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{    fi }\OperatorTok{<*>}\NormalTok{ xi }\OtherTok{=} \DataTypeTok{FlipIO} \OperatorTok{$} \KeywordTok{do}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{data} \DataTypeTok{State}\NormalTok{ s a }\OtherTok{=} \DataTypeTok{State}\NormalTok{ \{}\OtherTok{ runState ::}\NormalTok{ s }\OtherTok{{-}>}\NormalTok{ (a, s) \}}
...
\KeywordTok{instance} \DataTypeTok{Applicative}\NormalTok{ (}\DataTypeTok{State}\NormalTok{ s) }\KeywordTok{where}
    \FunctionTok{pure}\NormalTok{ x    }\OtherTok{=} \DataTypeTok{State} \OperatorTok{$}\NormalTok{ \textbackslash{}s0 }\OtherTok{{-}>}\NormalTok{ (x, s0)}
\NormalTok{    fs }\OperatorTok{<*>}\NormalTok{ xs }\OtherTok{=} \DataTypeTok{State} \OperatorTok{$}\NormalTok{ \textbackslash{}s0 }\OtherTok{{-}>} \KeywordTok{let}\NormalTok{ (f, s1) }\OtherTok{=}\NormalTok{ runState fs s0}
...
\KeywordTok{instance} \DataTypeTok{Applicative}\NormalTok{ (}\DataTypeTok{State}\NormalTok{ s) }\KeywordTok{where}
    \FunctionTok{pure}\NormalTok{ x    }\OtherTok{=} \DataTypeTok{State} \OperatorTok{$}\NormalTok{ \textbackslash{}s0 }\OtherTok{{-}>}\NormalTok{ (x, s0)}
\NormalTok{    fs }\OperatorTok{<*>}\NormalTok{ xs }\OtherTok{=} \DataTypeTok{State} \OperatorTok{$}\NormalTok{ \textbackslash{}s0 }\OtherTok{{-}>} \KeywordTok{let}\NormalTok{ (x, s1) }\OtherTok{=}\NormalTok{ runState xs s0}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{ghci}\OperatorTok{>}\NormalTok{ liftA2 (,) }\FunctionTok{getLine} \FunctionTok{getLine}
\OperatorTok{>}\NormalTok{ hello         }\CommentTok{{-}{-} asking for the first field}
\OperatorTok{>}\NormalTok{ world         }\CommentTok{{-}{-} asking for the second field}
\NormalTok{(}\StringTok{"hello"}\NormalTok{, }\StringTok{"world"}\NormalTok{)}
\NormalTok{ghci}\OperatorTok{>}\NormalTok{ runFlipIO }\OperatorTok{$}\NormalTok{ liftA2 (,) (}\DataTypeTok{FlipIO} \FunctionTok{getLine}\NormalTok{) (}\DataTypeTok{FlipIO} \FunctionTok{getLine}\NormalTok{)}
\OperatorTok{>}\NormalTok{ hello         }\CommentTok{{-}{-} asking for the second field}
\OperatorTok{>}\NormalTok{ world         }\CommentTok{{-}{-} asking for the first field}
...
\KeywordTok{instance} \DataTypeTok{Applicative}\NormalTok{ f }\OtherTok{=>} \DataTypeTok{Applicative}\NormalTok{ (}\DataTypeTok{Flipped}\NormalTok{ f) }\KeywordTok{where}
    ...
    \DataTypeTok{Flipped}\NormalTok{ f }\OperatorTok{<*>} \DataTypeTok{Flipped}\NormalTok{ x }\OtherTok{=} \DataTypeTok{Flipped} \OperatorTok{$}\NormalTok{ liftA2 (}\FunctionTok{flip}\NormalTok{ (}\OperatorTok{$}\NormalTok{)) x f}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{ghci}\OperatorTok{>} \KeywordTok{let}\NormalTok{ counterexample }\OtherTok{=}\NormalTok{ [[[}\DecValTok{1}\NormalTok{]], [[], [}\DecValTok{2}\NormalTok{,}\DecValTok{3}\NormalTok{]]]}
\NormalTok{ghci}\OperatorTok{>}\NormalTok{ join counterexample}
\NormalTok{[[}\DecValTok{1}\NormalTok{], [}\DecValTok{2}\NormalTok{,}\DecValTok{3}\NormalTok{]]}
\NormalTok{ghci}\OperatorTok{>}\NormalTok{ join}\OperatorTok{.}\NormalTok{ join }\OperatorTok{$}\NormalTok{ counterexample}
\NormalTok{[}\DecValTok{1}\NormalTok{,}\DecValTok{3}\NormalTok{]}
\NormalTok{ghci}\OperatorTok{>} \FunctionTok{fmap}\NormalTok{ join counterexample}
\NormalTok{[[}\DecValTok{1}\NormalTok{], []]}
\NormalTok{ghci}\OperatorTok{>}\NormalTok{ join }\OperatorTok{.} \FunctionTok{fmap}\NormalTok{ join }\OperatorTok{$}\NormalTok{ counterexample}
\NormalTok{[}\DecValTok{1}\NormalTok{]}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{ghci}\OperatorTok{>} \FunctionTok{id} \OperatorTok{<=<}\NormalTok{ (}\FunctionTok{id} \OperatorTok{<=<} \FunctionTok{id}\NormalTok{) }\OperatorTok{$}\NormalTok{ counterexample}
\NormalTok{[}\DecValTok{1}\NormalTok{,}\DecValTok{2}\NormalTok{]}
\NormalTok{ghci}\OperatorTok{>}\NormalTok{ (}\FunctionTok{id} \OperatorTok{<=<} \FunctionTok{id}\NormalTok{) }\OperatorTok{<=<} \FunctionTok{id} \OperatorTok{$}\NormalTok{ counterexample}
\NormalTok{[}\DecValTok{1}\NormalTok{]}
\end{Highlighting}
\end{Shaded}
