...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{ghci}\OperatorTok{>}\NormalTok{ halve }\DecValTok{6}
...
\OtherTok{halve\textquotesingle{} ::} \DataTypeTok{Int} \OtherTok{{-}>}\NormalTok{ [}\DataTypeTok{Int}\NormalTok{]}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{ghci}\OperatorTok{>}\NormalTok{ genericHalve }\DecValTok{8}\OtherTok{ ::} \DataTypeTok{Maybe} \DataTypeTok{Int}
\DataTypeTok{Just} \DecValTok{4}
\NormalTok{ghci}\OperatorTok{>}\NormalTok{ genericHalve }\DecValTok{8}\OtherTok{ ::}\NormalTok{ [}\DataTypeTok{Int}\NormalTok{]}
\NormalTok{[}\DecValTok{4}\NormalTok{]}
\NormalTok{ghci}\OperatorTok{>}\NormalTok{ genericHalve }\DecValTok{7}\OtherTok{ ::} \DataTypeTok{Maybe} \DataTypeTok{Int}
\DataTypeTok{Nothing}
\NormalTok{ghci}\OperatorTok{>}\NormalTok{ genericHalve }\DecValTok{7}\OtherTok{ ::}\NormalTok{ [}\DataTypeTok{Int}\NormalTok{]}
\NormalTok{[]}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{ghci}\OperatorTok{>}\NormalTok{ halveOrDouble }\DecValTok{6}
\NormalTok{[ }\DecValTok{3}\NormalTok{,}\DecValTok{12}\NormalTok{]}
\NormalTok{ghci}\OperatorTok{>}\NormalTok{ halveOrDouble }\DecValTok{7}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{ghci}\OperatorTok{>}\NormalTok{ halveOrDouble }\DecValTok{5} \OperatorTok{>>=}\NormalTok{ halveOrDouble}
\NormalTok{[       }\DecValTok{5}\NormalTok{, }\DecValTok{20}\NormalTok{]}
\NormalTok{ghci}\OperatorTok{>}\NormalTok{ halveOrDouble }\DecValTok{6} \OperatorTok{>>=}\NormalTok{ halveOrDouble}
\NormalTok{[    }\DecValTok{6}\NormalTok{, }\DecValTok{6}\NormalTok{, }\DecValTok{24}\NormalTok{]}
\NormalTok{ghci}\OperatorTok{>}\NormalTok{ halveOrDouble }\DecValTok{8} \OperatorTok{>>=}\NormalTok{ halveOrDouble}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{ghci}\OperatorTok{>}\NormalTok{ hod2PlusOne }\DecValTok{6}
...
\NormalTok{    a }\OtherTok{<{-}}\NormalTok{ [}\DecValTok{1}\OperatorTok{..}\NormalTok{n]}
\NormalTok{    b }\OtherTok{<{-}}\NormalTok{ [a}\OperatorTok{..}\NormalTok{n]}
\NormalTok{    c }\OtherTok{<{-}}\NormalTok{ [b}\OperatorTok{..}\NormalTok{n]}
...
\begin{Shaded}
\begin{Highlighting}[]
\OtherTok{triplesUnder\textquotesingle{} ::} \DataTypeTok{Int} \OtherTok{{-}>} \DataTypeTok{Maybe} \DataTypeTok{Int}
