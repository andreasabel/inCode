...
\KeywordTok{instance} \DataTypeTok{Monad}\NormalTok{ m }\OtherTok{=>} \DataTypeTok{Category}\NormalTok{ (}\DataTypeTok{AutoM}\NormalTok{ m) }\KeywordTok{where}
    \FunctionTok{id}    \OtherTok{=} \DataTypeTok{AConsM} \OperatorTok{$}\NormalTok{ \textbackslash{}x }\OtherTok{{-}>} \FunctionTok{return}\NormalTok{ (x, }\FunctionTok{id}\NormalTok{)}
\NormalTok{    g }\OperatorTok{.}\NormalTok{ f }\OtherTok{=} \DataTypeTok{AConsM} \OperatorTok{$}\NormalTok{ \textbackslash{}x }\OtherTok{{-}>} \KeywordTok{do}
\NormalTok{              (y, f\textquotesingle{}) }\OtherTok{<{-}}\NormalTok{ runAutoM f x}
\NormalTok{              (z, g\textquotesingle{}) }\OtherTok{<{-}}\NormalTok{ runAutoM g y}
...
\KeywordTok{instance} \DataTypeTok{Category} \DataTypeTok{Auto} \KeywordTok{where}
    \FunctionTok{id}    \OtherTok{=} \DataTypeTok{ACons} \OperatorTok{$}\NormalTok{ \textbackslash{}x }\OtherTok{{-}>}\NormalTok{ (x, }\FunctionTok{id}\NormalTok{)}
\NormalTok{    g }\OperatorTok{.}\NormalTok{ f }\OtherTok{=} \DataTypeTok{ACons} \OperatorTok{$}\NormalTok{ \textbackslash{}x }\OtherTok{{-}>}
...
\KeywordTok{instance} \DataTypeTok{Functor}\NormalTok{ (}\DataTypeTok{Auto}\NormalTok{ r) }\KeywordTok{where}
    \FunctionTok{fmap}\NormalTok{ f a }\OtherTok{=} \DataTypeTok{ACons} \OperatorTok{$}\NormalTok{ \textbackslash{}x }\OtherTok{{-}>}
...
\NormalTok{    arr f     }\OtherTok{=} \DataTypeTok{ACons} \OperatorTok{$}\NormalTok{ \textbackslash{}x }\OtherTok{{-}>}\NormalTok{ (f x, arr f)}
\NormalTok{    first a   }\OtherTok{=} \DataTypeTok{ACons} \OperatorTok{$}\NormalTok{ \textbackslash{}(x, z) }\OtherTok{{-}>}
                  \KeywordTok{let}\NormalTok{ (y, a\textquotesingle{}) }\OtherTok{=}\NormalTok{ runAuto a x}
                  \KeywordTok{in}\NormalTok{  ((y, z), first a\textquotesingle{})}
\NormalTok{    second a  }\OtherTok{=} \DataTypeTok{ACons} \OperatorTok{$}\NormalTok{ \textbackslash{}(z, x) }\OtherTok{{-}>}
                  \KeywordTok{let}\NormalTok{ (y, a\textquotesingle{}) }\OtherTok{=}\NormalTok{ runAuto a x}
                  \KeywordTok{in}\NormalTok{  ((z, y), second a\textquotesingle{})}
\NormalTok{    a1 }\OperatorTok{***}\NormalTok{ a2 }\OtherTok{=} \DataTypeTok{ACons} \OperatorTok{$}\NormalTok{ \textbackslash{}(x1, x2) }\OtherTok{{-}>}
...
\NormalTok{    a1 }\OperatorTok{\&\&\&}\NormalTok{ a2 }\OtherTok{=} \DataTypeTok{ACons} \OperatorTok{$}\NormalTok{ \textbackslash{}x }\OtherTok{{-}>}
...
\KeywordTok{instance} \DataTypeTok{Monad}\NormalTok{ m }\OtherTok{=>} \DataTypeTok{Functor}\NormalTok{ (}\DataTypeTok{AutoM}\NormalTok{ m r) }\KeywordTok{where}
    \FunctionTok{fmap}\NormalTok{ f a }\OtherTok{=} \DataTypeTok{AConsM} \OperatorTok{$}\NormalTok{ \textbackslash{}x }\OtherTok{{-}>} \KeywordTok{do}
...
\NormalTok{    arr f     }\OtherTok{=} \DataTypeTok{AConsM} \OperatorTok{$}\NormalTok{ \textbackslash{}x }\OtherTok{{-}>} \FunctionTok{return}\NormalTok{ (f x, arr f)}
\NormalTok{    first a   }\OtherTok{=} \DataTypeTok{AConsM} \OperatorTok{$}\NormalTok{ \textbackslash{}(x, z) }\OtherTok{{-}>} \KeywordTok{do}
\NormalTok{                  (y, a\textquotesingle{}) }\OtherTok{<{-}}\NormalTok{ runAutoM a x}
                  \FunctionTok{return}\NormalTok{ ((y, z), first a\textquotesingle{})}
\NormalTok{    second a  }\OtherTok{=} \DataTypeTok{AConsM} \OperatorTok{$}\NormalTok{ \textbackslash{}(z, x) }\OtherTok{{-}>} \KeywordTok{do}
\NormalTok{                  (y, a\textquotesingle{}) }\OtherTok{<{-}}\NormalTok{ runAutoM a x}
                  \FunctionTok{return}\NormalTok{ ((z, y), second a\textquotesingle{})}
\NormalTok{    a1 }\OperatorTok{***}\NormalTok{ a2 }\OtherTok{=} \DataTypeTok{AConsM} \OperatorTok{$}\NormalTok{ \textbackslash{}(x1, x2) }\OtherTok{{-}>} \KeywordTok{do}
\NormalTok{                  (y1, a1\textquotesingle{}) }\OtherTok{<{-}}\NormalTok{ runAutoM a1 x1}
\NormalTok{                  (y2, a2\textquotesingle{}) }\OtherTok{<{-}}\NormalTok{ runAutoM a2 x2}
                  \FunctionTok{return}\NormalTok{ ((y1, y2), a1\textquotesingle{} }\OperatorTok{***}\NormalTok{ a2\textquotesingle{})}
\NormalTok{    a1 }\OperatorTok{\&\&\&}\NormalTok{ a2 }\OtherTok{=} \DataTypeTok{AConsM} \OperatorTok{$}\NormalTok{ \textbackslash{}x }\OtherTok{{-}>} \KeywordTok{do}
\NormalTok{                  (y1, a1\textquotesingle{}) }\OtherTok{<{-}}\NormalTok{ runAutoM a1 x}
\NormalTok{                  (y2, a2\textquotesingle{}) }\OtherTok{<{-}}\NormalTok{ runAutoM a2 x}
                  \FunctionTok{return}\NormalTok{ ((y1, y2), a1\textquotesingle{} }\OperatorTok{\&\&\&}\NormalTok{ a2\textquotesingle{})}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{autoM a }\OtherTok{=} \DataTypeTok{AConsM} \OperatorTok{$}\NormalTok{ \textbackslash{}x }\OtherTok{{-}>} \KeywordTok{let}\NormalTok{ (y, a\textquotesingle{}) }\OtherTok{=}\NormalTok{ runAuto a x}
...
\NormalTok{arrM f }\OtherTok{=} \DataTypeTok{AConsM} \OperatorTok{$}\NormalTok{ \textbackslash{}x }\OtherTok{{-}>} \KeywordTok{do}
...
\NormalTok{limit cost a }\OtherTok{=}\NormalTok{ proc x }\OtherTok{{-}>} \KeywordTok{do}
\NormalTok{    fuel }\OtherTok{<{-}}\NormalTok{ arrM (\textbackslash{}\_ }\OtherTok{{-}>}\NormalTok{ get) }\OperatorTok{{-}<}\NormalTok{ ()}
    \KeywordTok{if}\NormalTok{ fuel }\OperatorTok{>=}\NormalTok{ cost}
      \KeywordTok{then} \KeywordTok{do}
\NormalTok{        arrM (\textbackslash{}\_ }\OtherTok{{-}>}\NormalTok{ modify (}\FunctionTok{subtract}\NormalTok{ cost)) }\OperatorTok{{-}<}\NormalTok{ ()}
\NormalTok{        y }\OtherTok{<{-}}\NormalTok{ autoM a }\OperatorTok{{-}<}\NormalTok{ x}
        \FunctionTok{id} \OperatorTok{{-}<} \DataTypeTok{Just}\NormalTok{ y}
      \KeywordTok{else}
        \FunctionTok{id} \OperatorTok{{-}<} \DataTypeTok{Nothing}
...
\NormalTok{sumSqDiff }\OtherTok{=}\NormalTok{ proc x }\OtherTok{{-}>} \KeywordTok{do}
\NormalTok{  sums   }\OtherTok{<{-}}\NormalTok{ fromMaybe }\DecValTok{0} \OperatorTok{<$>}\NormalTok{ limit }\DecValTok{3}\NormalTok{ summer }\OperatorTok{{-}<}\NormalTok{ x}
\NormalTok{  sumSqs }\OtherTok{<{-}}\NormalTok{ fromMaybe }\DecValTok{0} \OperatorTok{<$>}\NormalTok{ limit }\DecValTok{1}\NormalTok{ summer }\OperatorTok{{-}<}\NormalTok{ x}\OperatorTok{\^{}}\DecValTok{2}
  \FunctionTok{id} \OperatorTok{{-}<}\NormalTok{ sumSqs }\OperatorTok{{-}}\NormalTok{ sums}
...
\NormalTok{stuff }\OtherTok{=}\NormalTok{ proc x }\OtherTok{{-}>} \KeywordTok{do}
\NormalTok{    doubled }\OtherTok{<{-}}\NormalTok{ limit }\DecValTok{1} \FunctionTok{id} \OperatorTok{{-}<}\NormalTok{ x }\OperatorTok{*} \DecValTok{2}
\NormalTok{    tripled }\OtherTok{<{-}} \KeywordTok{if} \FunctionTok{even}\NormalTok{ x}
                 \KeywordTok{then}\NormalTok{ limit }\DecValTok{2} \FunctionTok{id} \OperatorTok{{-}<}\NormalTok{ x }\OperatorTok{*} \DecValTok{3}
                 \KeywordTok{else} \FunctionTok{id}         \OperatorTok{{-}<} \DataTypeTok{Just}\NormalTok{ (x }\OperatorTok{*} \DecValTok{3}\NormalTok{)}
\NormalTok{    sumSqD  }\OtherTok{<{-}}\NormalTok{ sumSqDiff }\OperatorTok{{-}<}\NormalTok{ x}
    \FunctionTok{id} \OperatorTok{{-}<}\NormalTok{ (doubled, tripled, sumSqD)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{ghci}\OperatorTok{>} \KeywordTok{let}\NormalTok{ stuffState  }\OtherTok{=}\NormalTok{ runAutoM stuff }\DecValTok{4}
\CommentTok{{-}{-} a State machine returning the result}
\NormalTok{ghci}\OperatorTok{>} \KeywordTok{let}\NormalTok{ stuffState\_ }\OtherTok{=} \FunctionTok{fst} \OperatorTok{<$>}\NormalTok{ stuffState}
\NormalTok{ghci}\OperatorTok{>} \OperatorTok{:}\NormalTok{t stuffState\_}
...
\NormalTok{ghci}\OperatorTok{>}\NormalTok{ runState stuffState\_ }\DecValTok{10}
...
\NormalTok{ghci}\OperatorTok{>}\NormalTok{ runState stuffState\_ }\DecValTok{2}
...
\NormalTok{integral x0 }\OtherTok{=} \DataTypeTok{AConsM} \OperatorTok{$}\NormalTok{ \textbackslash{}dx }\OtherTok{{-}>} \KeywordTok{do}
...
\NormalTok{derivative }\OtherTok{=} \DataTypeTok{AConsM} \OperatorTok{$}\NormalTok{ \textbackslash{}x }\OtherTok{{-}>} \FunctionTok{return}\NormalTok{ (}\DataTypeTok{Nothing}\NormalTok{, derivative\textquotesingle{} x)}
  \KeywordTok{where}
                 \CommentTok{{-}{-} x0 is the "previous input"}
\NormalTok{    derivative\textquotesingle{} x0 }\OtherTok{=} \DataTypeTok{AConsM} \OperatorTok{$}\NormalTok{ \textbackslash{}x1 }\OtherTok{{-}>} \KeywordTok{do}
...
\NormalTok{fancyCalculus }\OtherTok{=}\NormalTok{ proc x }\OtherTok{{-}>} \KeywordTok{do}
\NormalTok{    deriv  }\OtherTok{<{-}}\NormalTok{ fromMaybe }\DecValTok{0} \OperatorTok{<$>}\NormalTok{ derivative }\OperatorTok{{-}<}\NormalTok{ x}
\NormalTok{    deriv2 }\OtherTok{<{-}}\NormalTok{ fromMaybe }\DecValTok{0} \OperatorTok{<$>}\NormalTok{ derivative }\OperatorTok{{-}<}\NormalTok{ deriv}
\NormalTok{    intdev }\OtherTok{<{-}}\NormalTok{                 integral }\DecValTok{0} \OperatorTok{{-}<}\NormalTok{ deriv}
    \FunctionTok{id} \OperatorTok{{-}<}\NormalTok{ (deriv2, intdev)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{sealStateAuto a s0 }\OtherTok{=} \DataTypeTok{ACons} \OperatorTok{$}\NormalTok{ \textbackslash{}x }\OtherTok{{-}>}
...
\NormalTok{runStateAuto a }\OtherTok{=} \DataTypeTok{ACons} \OperatorTok{$}\NormalTok{ \textbackslash{}(x, s) }\OtherTok{{-}>}
...
\NormalTok{runReaderAuto a }\OtherTok{=} \DataTypeTok{ACons} \OperatorTok{$}\NormalTok{ \textbackslash{}(x, e) }\OtherTok{{-}>}
...
\NormalTok{    sumFrom x0 }\OtherTok{=} \DataTypeTok{ACons} \OperatorTok{$}\NormalTok{ \textbackslash{}x }\OtherTok{{-}>}\NormalTok{ (x0, sumFrom (x0 }\OperatorTok{+}\NormalTok{ x))}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{ghci}\OperatorTok{>}\NormalTok{ testAuto\_ laggingSummer [}\DecValTok{5}\OperatorTok{..}\DecValTok{10}\NormalTok{]}
...
\NormalTok{    loop a }\OtherTok{=} \DataTypeTok{ACons} \OperatorTok{$}\NormalTok{ \textbackslash{}x }\OtherTok{{-}>}
...
\NormalTok{    loop a }\OtherTok{=} \DataTypeTok{AConsM} \OperatorTok{$}\NormalTok{ \textbackslash{}x }\OtherTok{{-}>} \KeywordTok{do}
\NormalTok{               rec ((y, d), a\textquotesingle{}) }\OtherTok{<{-}}\NormalTok{ runAutoM a (x, d)}
...
\KeywordTok{instance} \DataTypeTok{Category} \DataTypeTok{AutoOn} \KeywordTok{where}
    \FunctionTok{id}    \OtherTok{=} \DataTypeTok{AConsOn} \OperatorTok{$}\NormalTok{ \textbackslash{}x }\OtherTok{{-}>}\NormalTok{ (}\DataTypeTok{Just}\NormalTok{ x, }\FunctionTok{id}\NormalTok{)}
\NormalTok{    g }\OperatorTok{.}\NormalTok{ f }\OtherTok{=} \DataTypeTok{AConsOn} \OperatorTok{$}\NormalTok{ \textbackslash{}x }\OtherTok{{-}>}
...
\NormalTok{    fmapA a }\OtherTok{=} \DataTypeTok{ACons} \OperatorTok{$}\NormalTok{ \textbackslash{}x }\OtherTok{{-}>}
                \KeywordTok{case}\NormalTok{ x }\KeywordTok{of}
                  \DataTypeTok{Just}\NormalTok{ \_x }\OtherTok{{-}>} \KeywordTok{let}\NormalTok{ (y, a\textquotesingle{}) }\OtherTok{=}\NormalTok{ runAuto a x}
...
\NormalTok{    empty     }\OtherTok{=} \DataTypeTok{AConsOn} \OperatorTok{$}\NormalTok{ \textbackslash{}\_ }\OtherTok{{-}>}\NormalTok{ (}\DataTypeTok{Nothing}\NormalTok{, empty)}
    \CommentTok{{-}{-} (<|>) :: AutoOn a b {-}> AutoOn a b {-}> AutoOn a b}
\NormalTok{    a1 }\OperatorTok{<|>}\NormalTok{ a2 }\OtherTok{=} \DataTypeTok{AConsOn} \OperatorTok{$}\NormalTok{ \textbackslash{}x }\OtherTok{{-}>}
...
\NormalTok{                      (y2, a2\textquotesingle{}) }\OtherTok{=}\NormalTok{ runAutoOn a2 x}
                  \KeywordTok{in}\NormalTok{  (y1 }\OperatorTok{<|>}\NormalTok{ y2, a1\textquotesingle{} }\OperatorTok{<|>}\NormalTok{ a2\textquotesingle{})}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{a1 }\OperatorTok{{-}{-}>}\NormalTok{ a2 }\OtherTok{=} \DataTypeTok{AConsOn} \OperatorTok{$}\NormalTok{ \textbackslash{}x }\OtherTok{{-}>}
              ...
              \KeywordTok{in}   \KeywordTok{case}\NormalTok{ y1 }\KeywordTok{of}
                     \DataTypeTok{Just}\NormalTok{ \_  }\OtherTok{{-}>}\NormalTok{ (y1, a1\textquotesingle{} }\OperatorTok{{-}{-}>}\NormalTok{ a2)}
                     \DataTypeTok{Nothing} \OtherTok{{-}>}\NormalTok{ runAutoOn a2 x}
\KeywordTok{infixr} \DecValTok{1} \OperatorTok{{-}{-}>}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{autoOn a }\OtherTok{=} \DataTypeTok{AConsOn} \OperatorTok{$}\NormalTok{ \textbackslash{}x }\OtherTok{{-}>}
             \KeywordTok{let}\NormalTok{ (y, a\textquotesingle{}) }\OtherTok{=}\NormalTok{ runAuto a x}
...
\NormalTok{arrOn f }\OtherTok{=} \DataTypeTok{AConsOn} \OperatorTok{$}\NormalTok{ \textbackslash{}x }\OtherTok{{-}>}\NormalTok{ (f x, arrOn f)}

\OtherTok{fromAutoOn ::} \DataTypeTok{AutoOn}\NormalTok{ a b }\OtherTok{{-}>} \DataTypeTok{Auto}\NormalTok{ a (}\DataTypeTok{Maybe}\NormalTok{ b)}
\NormalTok{fromAutoOn a }\OtherTok{=} \DataTypeTok{ACons} \OperatorTok{$}\NormalTok{ \textbackslash{}x }\OtherTok{{-}>}
...
\NormalTok{onFor n }\OtherTok{=}\NormalTok{ proc x }\OtherTok{{-}>} \KeywordTok{do}
\NormalTok{    i }\OtherTok{<{-}}\NormalTok{ autoOn summer }\OperatorTok{{-}<} \DecValTok{1}
    \KeywordTok{if}\NormalTok{ i }\OperatorTok{<=}\NormalTok{ n}
      \KeywordTok{then} \FunctionTok{id}    \OperatorTok{{-}<}\NormalTok{ x       }\CommentTok{{-}{-} succeed}
      \KeywordTok{else}\NormalTok{ empty }\OperatorTok{{-}<}\NormalTok{ x       }\CommentTok{{-}{-} fail}
\CommentTok{{-}{-} alternatively, using explit recursion:}
\CommentTok{{-}{-} onFor 0 = empty}
\CommentTok{{-}{-} onFor n = AConsOn $ \textbackslash{}x {-}> (Just x, onFor\textquotesingle{} (n{-}1))}

\OtherTok{filterA ::}\NormalTok{ (a }\OtherTok{{-}>} \DataTypeTok{Bool}\NormalTok{) }\OtherTok{{-}>} \DataTypeTok{AutoOn}\NormalTok{ a a}
\NormalTok{filterA p }\OtherTok{=}\NormalTok{ arrOn (\textbackslash{}x }\OtherTok{{-}>}\NormalTok{ x }\OperatorTok{<$}\NormalTok{ guard (p x))}

\OtherTok{untilA ::}\NormalTok{ (a }\OtherTok{{-}>} \DataTypeTok{Bool}\NormalTok{) }\OtherTok{{-}>} \DataTypeTok{AutoOn}\NormalTok{ a a}
\NormalTok{untilA p }\OtherTok{=}\NormalTok{ proc x }\OtherTok{{-}>} \KeywordTok{do}
\NormalTok{    stopped }\OtherTok{<{-}}\NormalTok{ autoOn (autoFold (}\OperatorTok{||}\NormalTok{) }\DataTypeTok{False}\NormalTok{) }\OperatorTok{{-}<}\NormalTok{ p x}
    \KeywordTok{if}\NormalTok{ stopped}
      \KeywordTok{then}\NormalTok{ empty }\OperatorTok{{-}<}\NormalTok{ x       }\CommentTok{{-}{-} fail}
      \KeywordTok{else} \FunctionTok{id}    \OperatorTok{{-}<}\NormalTok{ x       }\CommentTok{{-}{-} succeed}
...
\KeywordTok{newtype} \DataTypeTok{AutoOn2}\NormalTok{ a b }\OtherTok{=} \DataTypeTok{ACons2}\NormalTok{ \{}\OtherTok{ runAutoOn2 ::} \DataTypeTok{Maybe}\NormalTok{ a }\OtherTok{{-}>}\NormalTok{ (}\DataTypeTok{Maybe}\NormalTok{ b, }\DataTypeTok{AutoOn2}\NormalTok{ a b) \}}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{onFor }\DecValTok{0} \OtherTok{=} \DataTypeTok{ACons2} \OperatorTok{$}\NormalTok{ \textbackslash{}\_ }\OtherTok{{-}>}\NormalTok{ (}\DataTypeTok{Nothing}\NormalTok{, onFor }\DecValTok{0}\NormalTok{)}
\NormalTok{onFor n }\OtherTok{=} \DataTypeTok{ACons2} \OperatorTok{$}\NormalTok{ \textbackslash{}x }\OtherTok{{-}>}\NormalTok{ (x, onFor (n }\OperatorTok{{-}} \DecValTok{1}\NormalTok{))}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{autoOn a }\OtherTok{=} \DataTypeTok{ACons2} \OperatorTok{$}\NormalTok{ \textbackslash{}x }\OtherTok{{-}>}
             \KeywordTok{case}\NormalTok{ x }\KeywordTok{of}
...
\NormalTok{aCons a }\OtherTok{=} \DataTypeTok{AConsX} \OperatorTok{$}\NormalTok{ \textbackslash{}x }\OtherTok{{-}>}
...
\NormalTok{aConsM a }\OtherTok{=} \DataTypeTok{AConsX} \OperatorTok{$}\NormalTok{ \textbackslash{}x }\OtherTok{{-}>} \KeywordTok{do}
...
\NormalTok{aConsOn a }\OtherTok{=} \DataTypeTok{AConsX} \OperatorTok{$}\NormalTok{ \textbackslash{}x }\OtherTok{{-}>}
              \KeywordTok{let}\NormalTok{ (y, aX) }\OtherTok{=}\NormalTok{ a x}
...
\NormalTok{summer }\OtherTok{=}\NormalTok{ sumFrom }\DecValTok{0}
  \KeywordTok{where}
\OtherTok{    sumFrom ::} \DataTypeTok{Num}\NormalTok{ a }\OtherTok{=>}\NormalTok{ a }\OtherTok{{-}>} \DataTypeTok{Auto}\NormalTok{ a a}
\NormalTok{    sumFrom n }\OtherTok{=} \DataTypeTok{ACons} \OperatorTok{$}\NormalTok{ \textbackslash{}input }\OtherTok{{-}>}
...
\OtherTok{untilA\textquotesingle{} ::}\NormalTok{ (a }\OtherTok{{-}>} \DataTypeTok{Bool}\NormalTok{) }\OtherTok{{-}>} \DataTypeTok{AutoOn}\NormalTok{ a a}
\NormalTok{untilA\textquotesingle{} p }\OtherTok{=} \DataTypeTok{AConsOn} \OperatorTok{$}\NormalTok{ \textbackslash{}x }\OtherTok{{-}>}
...
\NormalTok{summer }\OtherTok{=}\NormalTok{ sumFrom }\DecValTok{0}
  \KeywordTok{where}
\NormalTok{    sumFrom n }\OtherTok{=}\NormalTok{ aCons }\OperatorTok{$}\NormalTok{ \textbackslash{}input }\OtherTok{{-}>}
      \KeywordTok{let}\NormalTok{ s }\OtherTok{=}\NormalTok{ n }\OperatorTok{+}\NormalTok{ input}
      \KeywordTok{in}\NormalTok{  ( s , sumFrom s )}
...
\NormalTok{arrM f }\OtherTok{=}\NormalTok{ aConsM }\OperatorTok{$}\NormalTok{ \textbackslash{}x }\OtherTok{{-}>} \KeywordTok{do}
\NormalTok{                    y }\OtherTok{<{-}}\NormalTok{ f x}
                    \FunctionTok{return}\NormalTok{ (y, arrM f)}
...
\NormalTok{untilA p }\OtherTok{=}\NormalTok{ aConsOn }\OperatorTok{$}\NormalTok{ \textbackslash{}x }\OtherTok{{-}>}
             \KeywordTok{if}\NormalTok{ p x}
               \KeywordTok{then}\NormalTok{ (}\DataTypeTok{Just}\NormalTok{ x , untilA p)}
               \KeywordTok{else}\NormalTok{ (}\DataTypeTok{Nothing}\NormalTok{, empty   )}
\end{Highlighting}
...
\NormalTok{aCons f }\OtherTok{=} \DataTypeTok{AConsM} \OperatorTok{$}\NormalTok{ \textbackslash{}x }\OtherTok{{-}>} \FunctionTok{return}\NormalTok{ (f x)}
\end{Highlighting}
\end{Shaded}
