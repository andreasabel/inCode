...
\texttt{massTaskB} to know \texttt{taskMap}, and we need to know \texttt{allIds}
to know \texttt{massTaskB}, and\ldots{}recursive dependency!
...
\hypertarget{interfacing-with-the-world}{%
...
\hypertarget{testingcommand-line}{%
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{data} \DataTypeTok{GUIOpts} \FunctionTok{=} \DataTypeTok{GUI}\NormalTok{ \{}\OtherTok{ _currFilter   ::} \DataTypeTok{Filter}        \CommentTok{-- currently applied filter}
...
\NormalTok{    filt  }\OtherTok{<-}\NormalTok{ holdWith }\DataTypeTok{All}
           \FunctionTok{.}\NormalTok{ emitJusts (preview (_Right }\FunctionTok{.}\NormalTok{ _GIFilter)) }\FunctionTok{-<}\NormalTok{ inp}
\NormalTok{    selc  }\OtherTok{<-}\NormalTok{ holdWith }\DataTypeTok{Nothing}
           \FunctionTok{.}\NormalTok{ emitJusts (preview (_Right }\FunctionTok{.}\NormalTok{ _GISelect)) }\FunctionTok{-<}\NormalTok{ inp}
\NormalTok{    tasks }\OtherTok{<-}\NormalTok{ holdWith mempty }\FunctionTok{.}\NormalTok{ perBlip todoApp}
           \FunctionTok{.}\NormalTok{ emitJusts (preview _Left)                }\FunctionTok{-<}\NormalTok{ inp}
