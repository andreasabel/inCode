...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{chef.json.merge!(\{ }\StringTok{:ghc\_version}\NormalTok{ => }\StringTok{\textquotesingle{}7.4.4\textquotesingle{}}\NormalTok{,}
                   \StringTok{:haskell\_platform\_version}\NormalTok{ => }\StringTok{\textquotesingle{}2012.4.0.0\textquotesingle{}}\NormalTok{\})}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{$ }\ExtensionTok{\textasciitilde{}/.cabal/bin/cabal{-}dev}\NormalTok{ install}
\end{Highlighting}
\end{Shaded}
