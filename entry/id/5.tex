...
\% Deploying Medium to Large Haskell Apps to Heroku by Precompiling \% Justin Le
\% October 7, 2013
...
\section{Old Article (Written 2013)}
...
\item
  ...
  \textasciitilde{}\textasciitilde{}\textasciitilde{}ruby chef.json.merge!(\{
  :ghc\emph{version =\textgreater{} '7.4.4', :haskell}platform\_version
  =\textgreater{} '2012.4.0.0'\})
...
\item
  ...
  \textasciitilde{}\textasciitilde{}\textasciitilde{}bash \$ vagrant up
  \textasciitilde{}\textasciitilde{}\textasciitilde{}
  ...
  \textasciitilde{}\textasciitilde{}\textasciitilde{}bash \$ vagrant ssh
  \textasciitilde{}\textasciitilde{}\textasciitilde{}
  ...
  \textasciitilde{}\textasciitilde{}\textasciitilde{}bash \$ sudo apt-get update
  \$ sudo apt-get upgrade \$ sudo apt-get install git-core \$ cabal update
  \textasciitilde{}\textasciitilde{}\textasciitilde{}
\end{enumerate}
...
\item
  ...
  \section{using cabal-dev}

  \$ cabal install cabal-dev

  \section{you can add \textasciitilde{}/.cabal/bin to your \$PATH if you want}

  \$ \textasciitilde{}/.cabal/bin/cabal-dev install
  \textasciitilde{}\textasciitilde{}\textasciitilde{}
...
\item
  ...
  \textasciitilde{}\textasciitilde{}\textasciitilde{}bash \$ git add -f
...
\item
  ...
  \textasciitilde{}\textasciitilde{}\textasciitilde{}yaml
...
\item
  ...
  \emph{sass}, so adding it is as simple as using a \emph{Gemfile} -\/-\/- just
  like in any normal ruby app.
...
\item
  ...
  \section{and, after making sure everything is set up, committed, and in
  order...}

  \$ git push heroku master \textasciitilde{}\textasciitilde{}\textasciitilde{}
...
\item
  ...
  \$ vagrant resume \textasciitilde{}\textasciitilde{}\textasciitilde{}
