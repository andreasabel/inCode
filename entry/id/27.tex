...
\ControlFlowTok{return}\NormalTok{ false;           }\CommentTok{// exit points}
\end{Highlighting}
\end{Shaded}
...
\hypertarget{statements-as-data}{%
...
\NormalTok{helloThenWorld }\OtherTok{=} \FunctionTok{putStrLn} \StringTok{"hello"} \OperatorTok{>>} \FunctionTok{putStrLn} \StringTok{"world"}

\CommentTok{{-}{-} define \textasciigrave{}helloThenWorld\textasciigrave{} as putStrLn "hello" >> putStrLn "world"; and its}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{when (}\DecValTok{4} \OperatorTok{>} \DecValTok{0}\NormalTok{) (}\FunctionTok{putStrLn} \StringTok{"it\textquotesingle{}s True!"}\NormalTok{)}\OtherTok{ ::} \DataTypeTok{IO}\NormalTok{ ()}
\NormalTok{when }\DataTypeTok{True}\NormalTok{ (}\FunctionTok{putStrLn} \StringTok{"it\textquotesingle{}s True!"}\NormalTok{)}\OtherTok{    ::} \DataTypeTok{IO}\NormalTok{ ()  }\CommentTok{{-}{-} evaluate 4 > 0}
...
\NormalTok{when (}\DecValTok{4} \OperatorTok{<} \DecValTok{0}\NormalTok{) (}\FunctionTok{putStrLn} \StringTok{"it\textquotesingle{}s True!"}\NormalTok{)}\OtherTok{ ::} \DataTypeTok{IO}\NormalTok{ ()}
\NormalTok{when }\DataTypeTok{False}\NormalTok{ (}\FunctionTok{putStrLn} \StringTok{"it\textquotesingle{}s True!"}\NormalTok{)}\OtherTok{   ::} \DataTypeTok{IO}\NormalTok{ ()  }\CommentTok{{-}{-} evaluate 4 < 0}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{sequence\_}\OtherTok{ ::}\NormalTok{ [}\DataTypeTok{IO}\NormalTok{ ()] }\OtherTok{{-}>} \DataTypeTok{IO}\NormalTok{ ()}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\FunctionTok{sequence\_}\OtherTok{ ::}\NormalTok{ [}\DataTypeTok{IO}\NormalTok{ ()] }\OtherTok{{-}>} \DataTypeTok{IO}\NormalTok{ ()}
\FunctionTok{sequence\_}\NormalTok{ xs }\OtherTok{=} \FunctionTok{foldr}\NormalTok{ (}\OperatorTok{>>}\NormalTok{) (}\FunctionTok{return}\NormalTok{ ()) xs}
\end{Highlighting}
\end{Shaded}
...
\FunctionTok{putStrLn} \StringTok{"hello"} \OperatorTok{>>}\NormalTok{ (}\FunctionTok{putStrLn} \StringTok{"world"} \OperatorTok{>>}\NormalTok{ (}\FunctionTok{putStrLn} \StringTok{"goodbye!"} \OperatorTok{>>} \FunctionTok{return}\NormalTok{ ()))}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{helloworld }\OtherTok{=}\NormalTok{ hello }\OperatorTok{>>}\NormalTok{ world}
...
\begin{Highlighting}[]
\OtherTok{bothPar ::} \DataTypeTok{IO}\NormalTok{ () }\OtherTok{{-}>} \DataTypeTok{IO}\NormalTok{ () }\OtherTok{{-}>} \DataTypeTok{IO}\NormalTok{ ()}
\NormalTok{bothPar x y }\OtherTok{=}\NormalTok{ makePar x }\OperatorTok{>>}\NormalTok{ makePar y}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{catch}\OtherTok{ ::} \DataTypeTok{IO}\NormalTok{ () }\OtherTok{{-}>}\NormalTok{ (}\DataTypeTok{SomeException} \OtherTok{{-}>} \DataTypeTok{IO}\NormalTok{ ()) }\OtherTok{{-}>} \DataTypeTok{IO}\NormalTok{ ()}
\CommentTok{{-}{-}       \^{}         \^{}                          \^{}}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{getLine} \OperatorTok{>>} \FunctionTok{putStrLn} \StringTok{"hello?"}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{getLine} \OperatorTok{>>=} \FunctionTok{putStrLn}
