...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{-- source: https://github.com/mstksg/inCode/tree/master/code-samples/auto/chatbot.hs#L72-75}
...
\NormalTok{perRoom rb }\FunctionTok{=}\NormalTok{ proc inp}\FunctionTok{@}\NormalTok{(}\DataTypeTok{InMessage}\NormalTok{ _ _ src _) }\OtherTok{->} \KeywordTok{do}
\NormalTok{    messages }\OtherTok{<-}\NormalTok{ fromBlips [] }\FunctionTok{.}\NormalTok{ rb }\FunctionTok{-<}\NormalTok{ inp}
\NormalTok{    id }\FunctionTok{-<} \DataTypeTok{OutMessages} \FunctionTok{$}\NormalTok{ M.singleton src messages}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{-- source: https://github.com/mstksg/inCode/tree/master/code-samples/auto/chatbot.hs#L45-228}
...
\NormalTok{channels }\FunctionTok{=}\NormalTok{ [}\StringTok{"#testchan1"}\NormalTok{, }\StringTok{"#testchan2"}\NormalTok{]}

\OtherTok{conf ::} \DataTypeTok{IrcConfig}
\NormalTok{conf }\FunctionTok{=}\NormalTok{ (mkDefaultConfig }\StringTok{"myserver"} \StringTok{"mynick"}\NormalTok{) \{ cChannels }\FunctionTok{=}\NormalTok{ channels \}}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{-- source: https://github.com/mstksg/inCode/tree/master/code-samples/auto/chatbot.hs#L230-236}
...
\CommentTok{-- source: https://github.com/mstksg/inCode/tree/master/code-samples/auto/chatbot.hs#L96-115}
...
\CommentTok{-- source: https://github.com/mstksg/inCode/tree/master/code-samples/auto/chatbot.hs#L149-183}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{-- source: https://github.com/mstksg/inCode/tree/master/code-samples/auto/chatbot.hs#L83-88}
\OtherTok{chatBot ::} \DataTypeTok{MonadIO}\NormalTok{ m }\OtherTok{=>} \DataTypeTok{ChatBot}\NormalTok{ m}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{-- source: https://github.com/mstksg/inCode/tree/master/code-samples/auto/chatbot.hs#L90-94}
\OtherTok{chatBot' ::} \DataTypeTok{MonadIO}\NormalTok{ m }\OtherTok{=>} \DataTypeTok{ChatBot}\NormalTok{ m}
...
\NormalTok{                   ,           serializing' }\StringTok{"anns.dat"}  \FunctionTok{$}\NormalTok{ announceBot channels}
\NormalTok{                   ]}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{-- source: https://github.com/mstksg/inCode/tree/master/code-samples/auto/chatbot.hs#L78-81}
...
\NormalTok{isolatedRooms rb }\FunctionTok{=}\NormalTok{ proc inp}\FunctionTok{@}\NormalTok{(}\DataTypeTok{InMessage}\NormalTok{ _ _ src _) }\OtherTok{->} \KeywordTok{do}
\NormalTok{    messages }\OtherTok{<-}\NormalTok{ fromBlips [] }\FunctionTok{.}\NormalTok{ mux (const rb) }\FunctionTok{-<}\NormalTok{ (src, inp)}
\NormalTok{    id }\FunctionTok{-<} \DataTypeTok{OutMessages} \FunctionTok{$}\NormalTok{ M.singleton src messages}
\end{Highlighting}
\end{Shaded}
