...
\FunctionTok{replicate}\OtherTok{ ::} \KeywordTok{forall}\NormalTok{ n a}\OperatorTok{.} \DataTypeTok{KnownNat}\NormalTok{ n }\OtherTok{=>}\NormalTok{ a }\OtherTok{{-}>} \DataTypeTok{Vec}\NormalTok{ n a}
...
\OtherTok{generate ::} \KeywordTok{forall}\NormalTok{ n a}\OperatorTok{.} \DataTypeTok{KnownNat}\NormalTok{ n }\OtherTok{=>}\NormalTok{ (}\DataTypeTok{Finite}\NormalTok{ n }\OtherTok{{-}>}\NormalTok{ a) }\OtherTok{{-}>} \DataTypeTok{Vec}\NormalTok{ n a}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{ghci}\OperatorTok{>}\NormalTok{ myVector }\OtherTok{=}\NormalTok{ V.fromList [}\DecValTok{10}\NormalTok{,}\DecValTok{5}\NormalTok{,}\DecValTok{8}\NormalTok{]}\OtherTok{ ::} \DataTypeTok{V.Vector} \DataTypeTok{Int}
\NormalTok{ghci}\OperatorTok{>}\NormalTok{ withVec myVector }\OperatorTok{$}\NormalTok{ \textbackslash{}(}\OtherTok{v ::} \DataTypeTok{Vec}\NormalTok{ n }\DataTypeTok{Int}\NormalTok{) }\OtherTok{{-}>}
          ...
          \KeywordTok{case}\NormalTok{ packFinite }\DecValTok{1}\OtherTok{ ::} \DataTypeTok{Maybe}\NormalTok{ (}\DataTypeTok{Finite}\NormalTok{ n) }\KeywordTok{of}      \CommentTok{{-}{-} Finite 3}
            ...
            \DataTypeTok{Just}\NormalTok{ i  }\OtherTok{{-}>}\NormalTok{ v }\OtherTok{\textasciigrave{}index\textasciigrave{}}\NormalTok{ i}
\DecValTok{5}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{getThird v }\OtherTok{=}\NormalTok{ withVec v }\OperatorTok{$}\NormalTok{ \textbackslash{}v\textquotesingle{} }\OtherTok{{-}>} \FunctionTok{fmap}\NormalTok{ (v\textquotesingle{} }\OtherTok{\textasciigrave{}index\textasciigrave{}}\NormalTok{) (packFinite }\DecValTok{2}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{ghci}\OperatorTok{>}\NormalTok{ getThird }\OperatorTok{$}\NormalTok{ V.fromList [}\DecValTok{1}\NormalTok{,}\DecValTok{2}\NormalTok{,}\DecValTok{3}\NormalTok{]}
\DataTypeTok{Just} \DecValTok{3}
\NormalTok{ghci}\OperatorTok{>}\NormalTok{ getThird }\OperatorTok{$}\NormalTok{ V.fromList [}\DecValTok{1}\NormalTok{,}\DecValTok{2}\NormalTok{]}
\DataTypeTok{Nothing}
\end{Highlighting}
\end{Shaded}
...
\OtherTok{zipSame ::} \KeywordTok{forall}\NormalTok{ a b}\OperatorTok{.} \DataTypeTok{V.Vector}\NormalTok{ a }\OtherTok{{-}>} \DataTypeTok{V.Vector}\NormalTok{ b }\OtherTok{{-}>} \DataTypeTok{Maybe}\NormalTok{ (}\DataTypeTok{V.Vector}\NormalTok{ (a, b))}
\NormalTok{zipSame v1 v2 }\OtherTok{=}\NormalTok{ withVec v1 }\OperatorTok{$}\NormalTok{ \textbackslash{}(}\OtherTok{v1\textquotesingle{} ::} \DataTypeTok{Vec}\NormalTok{ n a) }\OtherTok{{-}>}
\NormalTok{                withVec v2 }\OperatorTok{$}\NormalTok{ \textbackslash{}(}\OtherTok{v2\textquotesingle{} ::} \DataTypeTok{Vec}\NormalTok{ m b) }\OtherTok{{-}>}
      \KeywordTok{case}\NormalTok{ exactLength v1\textquotesingle{} }\KeywordTok{of}
        \DataTypeTok{Just}\NormalTok{ v1Same }\OtherTok{{-}>} \DataTypeTok{Just} \OperatorTok{$}\NormalTok{ getVector}
...
\OtherTok{withVec ::} \DataTypeTok{V.Vector}\NormalTok{ a }\OtherTok{{-}>}\NormalTok{ (}\KeywordTok{forall}\NormalTok{ n}\OperatorTok{.} \DataTypeTok{Sing}\NormalTok{ n }\OtherTok{{-}>} \DataTypeTok{Vec}\NormalTok{ n a }\OtherTok{{-}>}\NormalTok{ r) }\OtherTok{{-}>}\NormalTok{ r}
...
\OtherTok{withVec\textquotesingle{} ::} \DataTypeTok{V.Vector}\NormalTok{ a }\OtherTok{{-}>}\NormalTok{ (}\KeywordTok{forall}\NormalTok{ n}\OperatorTok{.} \DataTypeTok{Sing}\NormalTok{ n }\OtherTok{{-}>} \DataTypeTok{Vec}\NormalTok{ n a }\OtherTok{{-}>}\NormalTok{ r) }\OtherTok{{-}>}\NormalTok{ r}
\NormalTok{withVec\textquotesingle{} v0 f }\OtherTok{=}\NormalTok{ withSomeSing (}\FunctionTok{fromIntegral}\NormalTok{ (V.length v0)) }\OperatorTok{$}\NormalTok{ \textbackslash{}s }\OtherTok{{-}>}
\NormalTok{    f s (}\DataTypeTok{UnsafeMkVec}\NormalTok{ v0)}

\OtherTok{exactLength\_ ::} \DataTypeTok{Sing}\NormalTok{ m }\OtherTok{{-}>} \DataTypeTok{Sing}\NormalTok{ n }\OtherTok{{-}>} \DataTypeTok{Vec}\NormalTok{ n a }\OtherTok{{-}>} \DataTypeTok{Maybe}\NormalTok{ (}\DataTypeTok{Vec}\NormalTok{ m a)}
...
\OtherTok{generate\textquotesingle{}\_ ::} \DataTypeTok{Sing}\NormalTok{ n }\OtherTok{{-}>}\NormalTok{ (}\DataTypeTok{Finite}\NormalTok{ n }\OtherTok{{-}>}\NormalTok{ a) }\OtherTok{{-}>} \DataTypeTok{Vec}\NormalTok{ n a}
...
\KeywordTok{data} \KeywordTok{instance} \DataTypeTok{Sing}\OtherTok{ ::} \DataTypeTok{Nat} \OtherTok{{-}>} \DataTypeTok{Type} \KeywordTok{where}
    ...
    \DataTypeTok{SS}\OtherTok{ ::} \DataTypeTok{Sing}\NormalTok{ n }\OtherTok{{-}>} \DataTypeTok{Sing}\NormalTok{ (}\DataTypeTok{\textquotesingle{}S}\NormalTok{ n)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{    x}\OperatorTok{:}\NormalTok{xs }\OtherTok{{-}>}\NormalTok{ \textbackslash{}f }\OtherTok{{-}>}\NormalTok{ withVec xs }\OperatorTok{$}\NormalTok{ \textbackslash{}l ys }\OtherTok{{-}>}
...
\OtherTok{exactLengthInductive\_ ::} \DataTypeTok{Sing}\NormalTok{ m }\OtherTok{{-}>} \DataTypeTok{Vec}\NormalTok{ n a }\OtherTok{{-}>} \DataTypeTok{Maybe}\NormalTok{ (}\DataTypeTok{Vec}\NormalTok{ m a)}
...
\NormalTok{      \_ }\OperatorTok{:+}\NormalTok{ \_ }\OtherTok{{-}>} \DataTypeTok{Nothing}
    \DataTypeTok{SS}\NormalTok{ l }\OtherTok{{-}>}\NormalTok{ \textbackslash{}}\KeywordTok{case}
      \DataTypeTok{VNil}    \OtherTok{{-}>} \DataTypeTok{Nothing}
\NormalTok{      x }\OperatorTok{:+}\NormalTok{ xs }\OtherTok{{-}>}\NormalTok{ (x }\OperatorTok{:+}\NormalTok{) }\OperatorTok{<$>}\NormalTok{ exactLengthInductive\_ l xs}
...
\KeywordTok{data} \DataTypeTok{LTE}\OtherTok{ ::} \DataTypeTok{Nat} \OtherTok{{-}>} \DataTypeTok{Nat} \OtherTok{{-}>} \DataTypeTok{Type} \KeywordTok{where}
    ...
    \DataTypeTok{LES}\OtherTok{ ::} \DataTypeTok{LTE}\NormalTok{ n m }\OtherTok{{-}>} \DataTypeTok{LTE}\NormalTok{ (}\DataTypeTok{\textquotesingle{}S}\NormalTok{ n) (}\DataTypeTok{\textquotesingle{}S}\NormalTok{ m)}
...
\NormalTok{isLTE }\OtherTok{=}\NormalTok{ \textbackslash{}}\KeywordTok{case}
    ...
    \DataTypeTok{SS}\NormalTok{ n }\OtherTok{{-}>}\NormalTok{ \textbackslash{}}\KeywordTok{case}
      \DataTypeTok{SZ} \OtherTok{{-}>} \DataTypeTok{Disproved} \OperatorTok{$}\NormalTok{ \textbackslash{}}\KeywordTok{case}       \CommentTok{{-}{-} EmptyCase}
      \DataTypeTok{SS}\NormalTok{ m }\OtherTok{{-}>} \KeywordTok{case}\NormalTok{ isLTE n m }\KeywordTok{of}
        \DataTypeTok{Proved}\NormalTok{ l    }\OtherTok{{-}>} \DataTypeTok{Proved} \OperatorTok{$} \DataTypeTok{LES}\NormalTok{ l}
        \DataTypeTok{Disproved}\NormalTok{ p }\OtherTok{{-}>} \DataTypeTok{Disproved} \OperatorTok{$}\NormalTok{ \textbackslash{}}\KeywordTok{case}
...
\OtherTok{takeVecMaybe\_ ::} \DataTypeTok{Sing}\NormalTok{ n }\OtherTok{{-}>} \DataTypeTok{Vec}\NormalTok{ m a }\OtherTok{{-}>} \DataTypeTok{Maybe}\NormalTok{ (}\DataTypeTok{Vec}\NormalTok{ n a)}
\NormalTok{takeVecMaybe\_ sN v }\OtherTok{=} \FunctionTok{uncurry}\NormalTok{ takeVec }\OperatorTok{<$>}\NormalTok{ atLeast\_ sN v}
...
\NormalTok{takeVecMaybe v }\OtherTok{=} \FunctionTok{uncurry}\NormalTok{ takeVec }\OperatorTok{<$>}\NormalTok{ atLeast v}
\end{Highlighting}
\end{Shaded}
