...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{-- source: https://github.com/mstksg/inCode/tree/master/code-samples/interpreters/Duet.hs#L99-102}
...
\begin{Shaded}
\begin{Highlighting}[]
\OtherTok{non ::} \DataTypeTok{Eq}\NormalTok{ a }\OtherTok{=>}\NormalTok{ a }\OtherTok{->} \DataTypeTok{Lens'}\NormalTok{ (}\DataTypeTok{Maybe}\NormalTok{ a  ) a         }\CommentTok{-- actually `Iso'`, not `Lens'`}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{-- source: https://github.com/mstksg/inCode/tree/master/code-samples/interpreters/Duet.hs#L104-114}
\NormalTok{interpMem}
...
\texttt{P.moveN\ ::\ Int\ -\textgreater{}\ P.PointedList\ -\textgreater{}\ Maybe\ P.PointedList}
...
We also use \texttt{P.focus}, a lens that the \emph{pointedlist} library
provides to the current ``focus'' of the \texttt{PointedList}.
