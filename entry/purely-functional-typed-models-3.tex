...
best part is that they're never \emph{necessary}; just \emph{helpful}.
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{-- source: https://github.com/mstksg/inCode/tree/master/code-samples/functional-models/model.hs#L328-L334}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{-- source: https://github.com/mstksg/inCode/tree/master/code-samples/functional-models/model.hs#L336-L343}
...
\CommentTok{-- source: https://github.com/mstksg/inCode/tree/master/code-samples/functional-models/model.hs#L345-L351}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{-- source: https://github.com/mstksg/inCode/tree/master/code-samples/functional-models/model.hs#L353-L356}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{-- source: https://github.com/mstksg/inCode/tree/master/code-samples/functional-models/model.hs#L358-L366}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{-- source: https://github.com/mstksg/inCode/tree/master/code-samples/functional-models/model.hs#L368-L370}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{-- source: https://github.com/mstksg/inCode/tree/master/code-samples/functional-models/model.hs#L372-L373}
...
\item
  ...
  functional programming is very, very good at dealing with.
  ...
  functional programming staples like \texttt{foldl} (left folds) and
  \texttt{mapAccumL}.
...
\item
  ...
  as a property of our models. And I really believe here that purity is a
  \emph{benefit}, especially when reasoning with stateful models. Tying the
...
\item
  ...
  \emph{helps you write your code} --- it tells you what combinators are
  available to use for what models you have.
