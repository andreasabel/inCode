...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{pure}\NormalTok{ f }\OperatorTok{<*>}\NormalTok{ x }\OtherTok{=} \FunctionTok{fmap}\NormalTok{ f x}
\NormalTok{f }\OperatorTok{<*>} \FunctionTok{pure}\NormalTok{ x }\OtherTok{=} \FunctionTok{fmap}\NormalTok{ (}\OperatorTok{$}\NormalTok{ x) f}
\end{Highlighting}
\end{Shaded}
