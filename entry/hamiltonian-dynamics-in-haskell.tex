...
\(\frac{\partial}{\partial q} \hat{J}_f\) represents the \emph{second
derivatives} of \(f\) -- the derivative of the derivatives. And with that, we
have our final expression for
