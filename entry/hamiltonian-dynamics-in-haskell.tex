...
All of the code in this project can be found
\href{https://github.com/mstksg/inCode/tree/master/code-samples/hamilton1/Hamilton.hs}{hosted
here}, and executable as a stack script (just exec \texttt{./Hamilton.hs}!). It
was tested on the \href{https://www.stackage.org/lts-9.14}{Stackage LTS-9.14}
resolver.
...
\includegraphics{https://latex.codecogs.com/png.latex?\%5Cnabla}) as:
...
\textbackslash{}end\{aligned\}{]}(https://latex.codecogs.com/png.latex?\%0A\%5Cbegin\%7Baligned\%7D\%0A\%5Cdot\%7Bq\%7D\%20\%26\%20\%3D\%20\%5Cnabla\_\%7B\%5Cmathbf\%7Bp\_q\%7D\%7D\%20\%5Cmathcal\%7BH\%7D\%28\%5Cmathbf\%7Bq\%7D\%2C\%5Cmathbf\%7Bp\%7D\%29\%0A\%20\%20\%26\%26\%20\%3D\%20\%5Chat\%7BK\%7D\%5E\%7B-1\%7D\%20\%5Cmathbf\%7Bp\%7D\%20\%5C\%5C\%0A\%5Cdot\%7Bp\%7D\_q\%20\%26\%20\%3D\%20-\%20\%5Cnabla\_\%7B\%5Cmathbf\%7Bq\%7D\%7D\%20\%5Cmathcal\%7BH\%7D\%28\%5Cmathbf\%7Bq\%7D\%2C\%5Cmathbf\%7Bp\%7D\%29\%0A\%20\%20\%26\%26\%20\%3D\%20\%5Cmathbf\%7Bp\%7D\%5ET\%20\%5Chat\%7BK\%7D\%5E\%7B-1\%7D\%20\%5Chat\%7BJ\%7D\_f\%5ET\%20\%5Chat\%7BM\%7D\%0A\%20\%20\%20\%20\%20\%20\%20\%20\%5Cleft\%5B\%20\%5Cnabla\_\%7B\%5Cmathbf\%7Bq\%7D\%7D\%20\%5Chat\%7BJ\%7D\_f\%20\%5Cright\%5D\%20\%5Chat\%7BK\%7D\%5E\%7B-1\%7D\%20\%5Cmathbf\%7Bp\%7D\%0A\%20\%20\%20\%20-\%20\%5Cnabla\_\%7B\%5Cmathbf\%7Bq\%7D\%7D\%20PE\%28\%5Cmathbf\%7Bq\%7D\%29\%0A\%5Cend\%7Baligned\%7D\%0A
"
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{-- source: https://github.com/mstksg/inCode/tree/master/code-samples/hamilton1/Hamilton.hs#L19-26}
...
\texttt{R\ n} represents an n-vector (That is, an \texttt{R\ 4} is a 4-vector),
and an \texttt{L\ m\ n} represents an \texttt{m\ x\ n} matrix (That is, an
\texttt{L\ 5\ 3} is a 5x3 matrix).
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{-- source: https://github.com/mstksg/inCode/tree/master/code-samples/hamilton1/Hamilton.hs#L28-32}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{-- source: https://github.com/mstksg/inCode/tree/master/code-samples/hamilton1/Hamilton.hs#L34-38}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{-- source: https://github.com/mstksg/inCode/tree/master/code-samples/hamilton1/Hamilton.hs#L40-41}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{-- source: https://github.com/mstksg/inCode/tree/master/code-samples/hamilton1/Hamilton.hs#L49-50}
\OtherTok{toPhase ::}\NormalTok{ (}\DataTypeTok{KnownNat}\NormalTok{ n, }\DataTypeTok{KnownNat}\NormalTok{ m) }\OtherTok{=>} \DataTypeTok{System}\NormalTok{ m n }\OtherTok{->} \DataTypeTok{Config}\NormalTok{ n }\OtherTok{->} \DataTypeTok{Phase}\NormalTok{ n}
...
\href{http://hackage.haskell.org/package/vector-sized}{vector-sized} package,
where \texttt{V.Vector\ n\ a} is a \texttt{n}-vector of \texttt{a}s -- that is,
a \texttt{V.Vector\ 3\ Double} is a vector of 3 \texttt{Double}s.
...
\CommentTok{-- source: https://github.com/mstksg/inCode/tree/master/code-samples/hamilton1/Hamilton.hs#L52-60}
\NormalTok{jacobian2}
...
\texttt{unwrap} (like \texttt{tail}) for lists). The second item is the 1st
derivative, so we drop it again using \texttt{unwrap}. And finally, we only want
the third item (the 2nd derivatives) so we \texttt{extract} it (like
...
\emph{vector-sized} sized vectors and \emph{hmatrix} vectors and matrices:

\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{-- import qualified Data.Vector.Generic.Sized as VG}
\CommentTok{-- source: https://github.com/mstksg/inCode/tree/master/code-samples/hamilton1/Hamilton.hs#L62-69}
...
Remember that it is necessary to switch because \emph{ad} requires our vectors
to be \emph{Functors}, but \texttt{R} and \texttt{L} from \emph{hmatrix} are not
your typical Hask Functors. One nice thing is that because they both use
TypeLits to get their sized parameters, we can get type-safe conversions that
preserve their size information!

Also, even though \emph{ad} gives our second-order Jacobian as an
\includegraphics{https://latex.codecogs.com/png.latex?m\%20\%5Ctimes\%20n\%20\%5Ctimes\%20n}
tensor, we really want it as a \texttt{n}-vector of
\includegraphics{https://latex.codecogs.com/png.latex?m\%20\%5Ctimes\%20n}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{-- source: https://github.com/mstksg/inCode/tree/master/code-samples/hamilton1/Hamilton.hs#L71-71}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{-- source: https://github.com/mstksg/inCode/tree/master/code-samples/hamilton1/Hamilton.hs#L76-90}
\NormalTok{mkSystem}
...
Now, I hesitate to call this ``trivial''\ldots{}but, it really is a
...
Take a moment to marvel at the fact that the \emph{ad} library automatically
generated all of these for us and created a perfectly well-formed
\texttt{System} with all of its gradients and Jacobians by giving only the
coordinate function and the potential energy function, and in such a clean and
concise way!
...
\textbackslash{}nabla\_\{\textbackslash{}mathbf\{q\}\}
PE(\textbackslash{}mathbf\{q\})
\textbackslash{}end\{aligned\}{]}(https://latex.codecogs.com/png.latex?\%0A\%5Cbegin\%7Baligned\%7D\%0A\%5Cdot\%7Bq\%7D\%20\%26\%20\%3D\%20\%5Chat\%7BK\%7D\%5E\%7B-1\%7D\%20\%5Cmathbf\%7Bp\%7D\%20\%5C\%5C\%0A\%5Cdot\%7Bp\%7D\_q\%20\%26\%20\%3D\%20\%5Cmathbf\%7Bp\%7D\%5ET\%20\%5Chat\%7BK\%7D\%5E\%7B-1\%7D\%20\%5Chat\%7BJ\%7D\_f\%5ET\%20\%5Chat\%7BM\%7D\%0A\%20\%20\%20\%20\%20\%20\%20\%20\%5Cleft\%5B\%20\%5Cnabla\_\%7B\%5Cmathbf\%7Bq\%7D\%7D\%20\%5Chat\%7BJ\%7D\_f\%20\%5Cright\%5D\%20\%5Chat\%7BK\%7D\%5E\%7B-1\%7D\%20\%5Cmathbf\%7Bp\%7D\%0A\%20\%20\%20\%20-\%20\%5Cnabla\_\%7B\%5Cmathbf\%7Bq\%7D\%7D\%20PE\%28\%5Cmathbf\%7Bq\%7D\%29\%0A\%5Cend\%7Baligned\%7D\%0A
"
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{-- source: https://github.com/mstksg/inCode/tree/master/code-samples/hamilton1/Hamilton.hs#L92-109}
\NormalTok{hamilEqns}
...
The rest of the processes then is just to ``step'' \texttt{Phase\ n}. Gradually
...
``best'' way to do it is quite a big field, so for this article we're going to
be using the extremely extremely simple
...
{[} x(t + \textbackslash{}Delta t) = x(t) + \textbackslash{}dot\{x\}
\textbackslash{}Delta
t{]}(https://latex.codecogs.com/png.latex?\%0Ax\%28t\%20\%2B\%20\%5CDelta\%20t\%29\%20\%3D\%20x\%28t\%29\%20\%2B\%20\%5Cdot\%7Bx\%7D\%20\%5CDelta\%20t\%0A
...
\includegraphics{https://latex.codecogs.com/png.latex?\%5Cdot\%7Bx\%7D\%20\%5Capprox\%20\%5Cfrac\%7Bx\%28t\%20\%2B\%20\%5CDelta\%20t\%29\%20-\%20x\%28t\%29\%7D\%7B\%5CDelta\%20t\%7D}
...
\includegraphics{https://latex.codecogs.com/png.latex?x\%28t\%20\%2B\%20\%5CDelta\%20t\%29\%20\%5Capprox\%20\%5Cdot\%7Bx\%7D\%20\%5CDelta\%20t\%20\%2B\%20x\%28t\%29}.

We can directly translate this into Haskell:

\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{-- source: https://github.com/mstksg/inCode/tree/master/code-samples/hamilton1/Hamilton.hs#L111-119}
\NormalTok{stepEuler}
\OtherTok{    ::}\NormalTok{ (}\DataTypeTok{KnownNat}\NormalTok{ n, }\DataTypeTok{KnownNat}\NormalTok{ m)}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{-- source: https://github.com/mstksg/inCode/tree/master/code-samples/hamilton1/Hamilton.hs#L121-129}
\NormalTok{runSystem}
\OtherTok{    ::}\NormalTok{ (}\DataTypeTok{KnownNat}\NormalTok{ n, }\DataTypeTok{KnownNat}\NormalTok{ m)}
    \OtherTok{=>} \DataTypeTok{System}\NormalTok{ m n       }\CommentTok{-- ^ the system}
    \OtherTok{->} \DataTypeTok{Double}           \CommentTok{-- ^ dt}
...
\section{The Tests}\label{the-tests}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{-- source: https://github.com/mstksg/inCode/tree/master/code-samples/hamilton1/Hamilton.hs#L131-136}
\OtherTok{simpleSystem ::} \DataTypeTok{System} \DecValTok{2} \DecValTok{2}
\NormalTok{simpleSystem }\FunctionTok{=}\NormalTok{ mkSystem (vec2 }\DecValTok{5} \DecValTok{5}\NormalTok{) id pots}
  \KeywordTok{where}
    \CommentTok{-- U(x,y) = 9.8 * y}
\OtherTok{    pots ::} \DataTypeTok{RealFloat}\NormalTok{ a }\OtherTok{=>} \DataTypeTok{V.Vector} \DecValTok{2}\NormalTok{ a }\OtherTok{->}\NormalTok{ a}
\NormalTok{    pots xy }\FunctionTok{=} \FloatTok{9.8} \FunctionTok{*}\NormalTok{ (xy }\OtherTok{`V.index`} \DecValTok{1}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{-- source: https://github.com/mstksg/inCode/tree/master/code-samples/hamilton1/Hamilton.hs#L138-141}
\OtherTok{simpleConfig0 ::} \DataTypeTok{Config} \DecValTok{2}
\NormalTok{simpleConfig0 }\FunctionTok{=} \DataTypeTok{Config}\NormalTok{ \{ confPositions  }\FunctionTok{=}\NormalTok{ vec2 }\DecValTok{0} \DecValTok{0}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{-- source: https://github.com/mstksg/inCode/tree/master/code-samples/hamilton1/Hamilton.hs#L143-147}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{-- source: https://github.com/mstksg/inCode/tree/master/code-samples/hamilton1/Hamilton.hs#L150-172}
\OtherTok{pendulum ::} \DataTypeTok{System} \DecValTok{2} \DecValTok{1}
\NormalTok{pendulum }\FunctionTok{=}\NormalTok{ mkSystem (vec2 }\DecValTok{5} \DecValTok{5}\NormalTok{) coords pots      }\CommentTok{-- 5kg particle}
  \KeywordTok{where}
...
\NormalTok{    coords (V.head}\OtherTok{->}\NormalTok{theta) }\FunctionTok{=}\NormalTok{ fromJust}
    ...
    \CommentTok{-- U(x,y) = 9.8 * y}
\OtherTok{    pots ::} \DataTypeTok{RealFloat}\NormalTok{ a }\OtherTok{=>} \DataTypeTok{V.Vector} \DecValTok{1}\NormalTok{ a }\OtherTok{->}\NormalTok{ a}
\NormalTok{    pots q }\FunctionTok{=} \FloatTok{9.8} \FunctionTok{*}\NormalTok{ (coords q }\OtherTok{`V.index`} \DecValTok{1}\NormalTok{)}

\OtherTok{pendulumConfig0 ::} \DataTypeTok{Config} \DecValTok{1}
\NormalTok{pendulumConfig0 }\FunctionTok{=} \DataTypeTok{Config}\NormalTok{ \{ confPositions  }\FunctionTok{=} \DecValTok{0}
...
But, conceptually, this is a success! We \emph{automatically generated equations
...
potential energy function. See my
...
and more! \href{http://hackage.haskell.org/package/ad}{ad}:
...
\section{The Goal}\label{the-goal-1}
...
\section{Hamiltonian Mechanics}\label{hamiltonian-mechanics-1}
...
\subsection{Phase Space}\label{phase-space-1}
...
\subsection{Hamiltonian Dynamics}\label{hamiltonian-dynamics-1}
...
\section{Hamiltonian Dynamics and Physical
Systems}\label{hamiltonian-dynamics-and-physical-systems-1}
...
\subsection{Conjugate Momenta}\label{conjugate-momenta-1}
...
\subsection{Hamiltonians of Physical
Systems}\label{hamiltonians-of-physical-systems-1}
...
\subsection{Hamiltonian Equations}\label{hamiltonian-equations-1}
...
\section{The Haskell}\label{the-haskell-1}
...
\subsection{Our Data Structures}\label{our-data-structures-1}
...
\subsection{Getting comfortable with our data
types}\label{getting-comfortable-with-our-data-types-1}
...
\subsection{Automatic Differentiation}\label{automatic-differentiation-1}
...
\subsubsection{Quick Intro to AD}\label{quick-intro-to-ad-1}
...
\subsubsection{Conversion between vector-sized and
hmatrix}\label{conversion-between-vector-sized-and-hmatrix-1}
...
matrices -- that's how we interpreted it in our original math. So we just need
to write an function to convert what \emph{ad} gives us to the form we expect.
It's mostly just fiddling around with the internals of \emph{hmatrix}.

\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{-- source: https://github.com/mstksg/inCode/tree/master/code-samples/hamilton1/Hamilton.hs#L71-74}
\OtherTok{rejacobi ::}\NormalTok{ (}\DataTypeTok{KnownNat}\NormalTok{ m, }\DataTypeTok{KnownNat}\NormalTok{ n) }\OtherTok{=>} \DataTypeTok{V.Vector}\NormalTok{ m (}\DataTypeTok{L}\NormalTok{ n n) }\OtherTok{->} \DataTypeTok{V.Vector}\NormalTok{ n (}\DataTypeTok{L}\NormalTok{ m n)}
...
\subsubsection{Using AD to Auto-Derive
Systems}\label{using-ad-to-auto-derive-systems-1}
...
\subsection{Equations of Motion}\label{equations-of-motion-1}
...
\subsection{Numerical Integration}\label{numerical-integration-1}
...
\href{http://hackage.haskell.org/package/hamilton}{hamilton} library, which
includes demos for exotic interesting systems, rendered graphically on your
terminal.
