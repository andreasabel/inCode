...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{-- source: https://github.com/mstksg/inCode/tree/master/code-samples/trie/trie.hs#L27-L28}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{-- source: https://github.com/mstksg/inCode/tree/master/code-samples/trie/trie.hs#L43-L56}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{-- source: https://github.com/mstksg/inCode/tree/master/code-samples/trie/trie.hs#L33-L41}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{-- source: https://github.com/mstksg/inCode/tree/master/code-samples/trie/trie.hs#L61-L66}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{-- source: https://github.com/mstksg/inCode/tree/master/code-samples/trie/trie.hs#L58-L59}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{-- source: https://github.com/mstksg/inCode/tree/master/code-samples/trie/trie.hs#L68-L72}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{-- source: https://github.com/mstksg/inCode/tree/master/code-samples/trie/trie.hs#L82-L97}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{-- source: https://github.com/mstksg/inCode/tree/master/code-samples/trie/trie.hs#L74-L76}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{-- source: https://github.com/mstksg/inCode/tree/master/code-samples/trie/trie.hs#L78-L80}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{-- source: https://github.com/mstksg/inCode/tree/master/code-samples/trie/trie.hs#L99-L100}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{-- source: https://github.com/mstksg/inCode/tree/master/code-samples/trie/trie.hs#L105-L109}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{-- source: https://github.com/mstksg/inCode/tree/master/code-samples/trie/trie.hs#L111-L125}
...
\NormalTok{                       (M.unionsWith M.union (M.mapMaybeWithKey descend mp))}
  \KeywordTok{where}
\NormalTok{    descend []     _ }\FunctionTok{=} \DataTypeTok{Nothing}
\NormalTok{    descend (k}\FunctionTok{:}\NormalTok{ks) v }\FunctionTok{=} \DataTypeTok{Just} \FunctionTok{$}\NormalTok{ M.singleton k (M.singleton ks v)}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{-- source: https://github.com/mstksg/inCode/tree/master/code-samples/trie/trie.hs#L127-L128}
...
\hypertarget{this-is-where-the-fun-begins}{%
\section{This is where the fun begins}\label{this-is-where-the-fun-begins}}
...
file}} which the graphviz application can render. The \emph{graphviz} library
directly renders a value of the graph data type from
\emph{\href{https://hackage.haskell.org/package/fgl}{fgl}}, the functional graph
library that is the de-facto fully fleshed-out graph manipulation library of the
Haskell ecosystem.
...
\item
  ...
  quotes to their associated macro images 2 Use \texttt{ana} to turn a
  \texttt{Map\ String\ PrequelMeme} into a \texttt{Trie\ Char\ PrequelMeme}
\item
...
some (completely unnecessary) fun by taking care of it ourselves.
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{-- source: https://github.com/mstksg/inCode/tree/master/code-samples/trie/trie.hs#L146-L147}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{-- source: https://github.com/mstksg/inCode/tree/master/code-samples/trie/trie.hs#L154-L166}
...
\NormalTok{    gs }\OtherTok{<-}\NormalTok{ sequence xs}
    \KeywordTok{let}\OtherTok{ subroots ::}\NormalTok{ [(k, }\DataTypeTok{Int}\NormalTok{)]}
\NormalTok{        subroots }\FunctionTok{=}\NormalTok{ M.toList }\FunctionTok{.}\NormalTok{ fmap (fst }\FunctionTok{.}\NormalTok{ G.nodeRange) }\FunctionTok{$}\NormalTok{ gs}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{-- source: https://github.com/mstksg/inCode/tree/master/code-samples/trie/trie.hs#L149-L152}
