...
and safer code, and also for seeing our data types in a different light.
...
Haskell based on \emph{recursion-schemes} to see what it has to offer!
...
even need the original (recursive) \texttt{Trie} at all, if we just care about
the structure.
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{-- source: https://github.com/mstksg/inCode/tree/master/code-samples/trie/trie.hs#L134-L135}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{-- source: https://github.com/mstksg/inCode/tree/master/code-samples/trie/trie.hs#L142-L154}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{-- source: https://github.com/mstksg/inCode/tree/master/code-samples/trie/trie.hs#L203-L213}
