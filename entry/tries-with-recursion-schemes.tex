...
\NormalTok{    fromMaybe }\DecValTok{0}\NormalTok{ v }\FunctionTok{+} \FunctionTok{sum}\NormalTok{ subtrieSums}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{    subgraphs }\OtherTok{<-} \FunctionTok{sequence}\NormalTok{ xs}
    ...
    \KeywordTok{let}\NormalTok{ subroots }\FunctionTok{=}\NormalTok{ M.toList }\FunctionTok{.} \FunctionTok{fmap}\NormalTok{ (}\FunctionTok{fst} \FunctionTok{.}\NormalTok{ G.nodeRange) }\FunctionTok{$}\NormalTok{ subgraphs}
    \FunctionTok{pure} \FunctionTok{$}\NormalTok{ G.insEdges ((\textbackslash{}(k,i) }\OtherTok{->}\NormalTok{ (n,i,k)) }\FunctionTok{<$>}\NormalTok{ subroots)   }\CommentTok{-- insert root-to-subroots}
