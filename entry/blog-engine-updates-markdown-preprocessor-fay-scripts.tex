...
\NormalTok{    guard }\OperatorTok{$}\NormalTok{ isSolution p}
    ...
    \KeywordTok{where}
\NormalTok{        makeNMoves }\OtherTok{=} \FunctionTok{iterate}\NormalTok{ (}\OperatorTok{>>=}\NormalTok{ makeMove) (}\FunctionTok{return}\NormalTok{ startingPlan) }\OperatorTok{!!}\NormalTok{ n}
...
\NormalTok{    next }\OtherTok{<{-}} \DataTypeTok{MoveThe} \OperatorTok{<$>}\NormalTok{ [}\DataTypeTok{Farmer} \OperatorTok{..}\NormalTok{]}
...
\NormalTok{    filePath }\OtherTok{<{-}}\NormalTok{ noSpaces }\OperatorTok{<?>} \StringTok{"sample filePath"}
\NormalTok{    spaces}
\NormalTok{    keywords }\OtherTok{<{-}}\NormalTok{ many }\OperatorTok{$} \KeywordTok{do}
\NormalTok{      keyword }\OtherTok{<{-}}\NormalTok{ char }\CharTok{\textquotesingle{}"\textquotesingle{}} \OperatorTok{*>}\NormalTok{ manyTill anyChar (char }\CharTok{\textquotesingle{}"\textquotesingle{}}\NormalTok{) }\OperatorTok{<?>} \StringTok{"keyword"}
\NormalTok{      keylimit }\OtherTok{<{-}}\NormalTok{ optionMaybe (}\FunctionTok{read} \OperatorTok{<$>}\NormalTok{ many1 digit }\OperatorTok{<?>} \StringTok{"keyword limit"}\NormalTok{)}
\NormalTok{      spaces}
      \FunctionTok{return}\NormalTok{ (keyword,keylimit)}

\NormalTok{    live }\OtherTok{<{-}}\NormalTok{ optionMaybe noSpaces }\OperatorTok{<?>} \StringTok{"live url"}
    \KeywordTok{let}
\NormalTok{      live\textquotesingle{} }\OtherTok{=}\NormalTok{ mfilter (}\FunctionTok{not} \OperatorTok{.} \FunctionTok{null}\NormalTok{) live}
  ...
  \KeywordTok{where}
\NormalTok{    noSpaces }\OtherTok{=}\NormalTok{ manyTill anyChar (space }\OperatorTok{<|>} \CharTok{\textquotesingle{} \textquotesingle{}} \OperatorTok{<$}\NormalTok{ eof)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{  click (scrollTo }\DecValTok{400}\NormalTok{) topLinks}
  ...
  \KeywordTok{where}
\NormalTok{    topLink }\OtherTok{=} \StringTok{"<a href=\textquotesingle{}\#title\textquotesingle{} class=\textquotesingle{}top{-}link\textquotesingle{}>top</a>"}
\end{Highlighting}
\end{Shaded}
...
\VariableTok{container}\NormalTok{.}\AttributeTok{children}\NormalTok{(}\StringTok{\textquotesingle{}.contained\textquotesingle{}}\NormalTok{)}\OperatorTok{;}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{flip}\NormalTok{ click header }\OperatorTok{$}\NormalTok{ \textbackslash{}\_ }\OtherTok{{-}>} \KeywordTok{do}
