...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{ghci}\OperatorTok{>} \KeywordTok{let}\NormalTok{ (}\DataTypeTok{Cons}\NormalTok{ (x,xs)) }\OtherTok{=}\NormalTok{ myList}
\NormalTok{ghci}\OperatorTok{>}\NormalTok{ x}
\DecValTok{1}
\NormalTok{ghci}\OperatorTok{>} \OperatorTok{:}\NormalTok{t xs}
\OtherTok{xs ::} \DataTypeTok{List} \DataTypeTok{Int}
\NormalTok{ghci}\OperatorTok{>} \KeywordTok{let}\NormalTok{ (}\DataTypeTok{Cons}\NormalTok{ (y,ys)) }\OtherTok{=}\NormalTok{ xs}
\NormalTok{ghci}\OperatorTok{>}\NormalTok{ y}
\DecValTok{2}
\NormalTok{ghci}\OperatorTok{>} \KeywordTok{let}\NormalTok{ (}\DataTypeTok{Cons}\NormalTok{ (z,zs)) }\OtherTok{=}\NormalTok{ ys}
\NormalTok{ghci}\OperatorTok{>}\NormalTok{ z}
\DecValTok{3}
\NormalTok{ghci}\OperatorTok{>}\NormalTok{ zs}
\DataTypeTok{Nil}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{ghci}\OperatorTok{>} \KeywordTok{let}\NormalTok{ (}\DataTypeTok{SCons}\NormalTok{ (x, xs)) }\OtherTok{=}\NormalTok{ myStream}
\NormalTok{ghci}\OperatorTok{>}\NormalTok{ x}
\DecValTok{1}
\NormalTok{ghci}\OperatorTok{>} \OperatorTok{:}\NormalTok{t xs}
\OtherTok{xs ::} \DataTypeTok{Stream} \DataTypeTok{Int}
\NormalTok{ghci}\OperatorTok{>} \KeywordTok{let}\NormalTok{ (}\DataTypeTok{SCons}\NormalTok{ (y, ys)) }\OtherTok{=}\NormalTok{ xs}
\NormalTok{ghci}\OperatorTok{>}\NormalTok{ y}
\DecValTok{2}
\NormalTok{ghci}\OperatorTok{>} \KeywordTok{let}\NormalTok{ (}\DataTypeTok{SCons}\NormalTok{ (z, zs)) }\OtherTok{=}\NormalTok{ ys}
\NormalTok{ghci}\OperatorTok{>}\NormalTok{ z}
\DecValTok{3}
\NormalTok{ghci}\OperatorTok{>} \KeywordTok{let}\NormalTok{ (}\DataTypeTok{SCons}\NormalTok{ (j,js)) }\OtherTok{=}\NormalTok{ zs}
\NormalTok{ghci}\OperatorTok{>}\NormalTok{ j}
\DecValTok{4}
\NormalTok{ghci}\OperatorTok{>} \KeywordTok{let}\NormalTok{ (}\DataTypeTok{SCons}\NormalTok{ (k,ks)) }\OtherTok{=}\NormalTok{ js}
\NormalTok{ghci}\OperatorTok{>}\NormalTok{ k}
\DecValTok{5}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{ghci}\OperatorTok{>} \OperatorTok{:}\NormalTok{t runStream}
\OtherTok{runStream ::} \DataTypeTok{Stream}\NormalTok{ b }\OtherTok{{-}>}\NormalTok{ (b, }\DataTypeTok{Stream}\NormalTok{ b)}
\NormalTok{ghci}\OperatorTok{>} \KeywordTok{let}\NormalTok{ (x, xs) }\OtherTok{=}\NormalTok{ runStream myStream}
\NormalTok{ghci}\OperatorTok{>}\NormalTok{ x}
\DecValTok{1}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{ghci}\OperatorTok{>} \FunctionTok{take} \DecValTok{10} \OperatorTok{$}\NormalTok{ streamToList myStream}
...
\OtherTok{testStream\_ ::} \DataTypeTok{Stream}\NormalTok{ b }\OtherTok{{-}>} \DataTypeTok{Int} \OtherTok{{-}>}\NormalTok{ [b]}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{ghci}\OperatorTok{>}\NormalTok{ testStream\_ myStream }\DecValTok{10}
\NormalTok{[}\DecValTok{1}\NormalTok{,}\DecValTok{2}\NormalTok{,}\DecValTok{3}\NormalTok{,}\DecValTok{4}\NormalTok{,}\DecValTok{5}\NormalTok{,}\DecValTok{6}\NormalTok{,}\DecValTok{7}\NormalTok{,}\DecValTok{8}\NormalTok{,}\DecValTok{9}\NormalTok{,}\DecValTok{10}\NormalTok{]}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{ghci}\OperatorTok{>} \FunctionTok{take} \DecValTok{10} \OperatorTok{$}\NormalTok{ streamToList charStream}
...
\NormalTok{    streamAutoFrom n }\OtherTok{=} \DataTypeTok{ACons} \OperatorTok{$}\NormalTok{ \textbackslash{}\_ }\OtherTok{{-}>}\NormalTok{ ( n, streamAutoFrom (n}\OperatorTok{+}\DecValTok{1}\NormalTok{) )}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{ghci}\OperatorTok{>} \OperatorTok{:}\NormalTok{t runAuto}
\OtherTok{runAuto ::} \DataTypeTok{Auto}\NormalTok{ a b }\OtherTok{{-}>}\NormalTok{ (a }\OtherTok{{-}>}\NormalTok{ (b, }\DataTypeTok{Auto}\NormalTok{ a b))}
\NormalTok{ghci}\OperatorTok{>} \KeywordTok{let}\NormalTok{ (x, xs) }\OtherTok{=}\NormalTok{ runAuto myStreamAuto }\FunctionTok{undefined}
\NormalTok{ghci}\OperatorTok{>}\NormalTok{ x}
\DecValTok{1}
\NormalTok{ghci}\OperatorTok{>} \OperatorTok{:}\NormalTok{t xs}
\OtherTok{xs ::} \DataTypeTok{Auto}\NormalTok{ a }\DataTypeTok{Int}
\NormalTok{ghci}\OperatorTok{>} \KeywordTok{let}\NormalTok{ (y, ys) }\OtherTok{=}\NormalTok{ runAuto xs }\FunctionTok{undefined}
\NormalTok{ghci}\OperatorTok{>}\NormalTok{ y}
\DecValTok{2}
\NormalTok{ghci}\OperatorTok{>} \KeywordTok{let}\NormalTok{ (z, zs) }\OtherTok{=}\NormalTok{ runAuto ys }\FunctionTok{undefined}
\NormalTok{ghci}\OperatorTok{>}\NormalTok{ z}
\DecValTok{3}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{    counterFrom n }\OtherTok{=} \DataTypeTok{ACons} \OperatorTok{$}\NormalTok{ \textbackslash{}reset }\OtherTok{{-}>}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{ghci}\OperatorTok{>} \KeywordTok{let}\NormalTok{ (x, xs) }\OtherTok{=}\NormalTok{ runAuto settableAuto }\DataTypeTok{Nothing}
\NormalTok{ghci}\OperatorTok{>}\NormalTok{ x}
\DecValTok{1}
\NormalTok{ghci}\OperatorTok{>} \KeywordTok{let}\NormalTok{ (y, ys) }\OtherTok{=}\NormalTok{ runAuto xs }\DataTypeTok{Nothing}
\NormalTok{ghci}\OperatorTok{>}\NormalTok{ y}
\DecValTok{2}
\NormalTok{ghci}\OperatorTok{>} \KeywordTok{let}\NormalTok{ (z, zs) }\OtherTok{=}\NormalTok{ runAuto ys (}\DataTypeTok{Just} \DecValTok{10}\NormalTok{)}
\NormalTok{ghci}\OperatorTok{>}\NormalTok{ z}
\DecValTok{10}
\NormalTok{ghci}\OperatorTok{>} \KeywordTok{let}\NormalTok{ (j, js) }\OtherTok{=}\NormalTok{ runAuto zs }\DataTypeTok{Nothing}
\NormalTok{ghci}\OperatorTok{>}\NormalTok{ j}
\DecValTok{11}
\NormalTok{ghci}\OperatorTok{>} \KeywordTok{let}\NormalTok{ (k, ks) }\OtherTok{=}\NormalTok{ runAuto js }\DataTypeTok{Nothing}
\NormalTok{ghci}\OperatorTok{>}\NormalTok{ k}
\DecValTok{12}
\NormalTok{ghci}\OperatorTok{>} \KeywordTok{let}\NormalTok{ (l, ls) }\OtherTok{=}\NormalTok{ runAuto ks (}\DataTypeTok{Just}\NormalTok{ (}\OperatorTok{{-}}\DecValTok{1}\NormalTok{))}
\NormalTok{ghci}\OperatorTok{>}\NormalTok{ l}
\OperatorTok{{-}}\DecValTok{1}
\NormalTok{ghci}\OperatorTok{>} \KeywordTok{let}\NormalTok{ (m, ms) }\OtherTok{=}\NormalTok{ runAuto ls }\DataTypeTok{Nothing}
\NormalTok{ghci}\OperatorTok{>}\NormalTok{ m}
\DecValTok{0}
\end{Highlighting}
\end{Shaded}
...
\OtherTok{testAuto\_ ::} \DataTypeTok{Auto}\NormalTok{ a b }\OtherTok{{-}>}\NormalTok{ [a] }\OtherTok{{-}>}\NormalTok{ [b]}
...
\NormalTok{    inp }\OtherTok{<{-}} \FunctionTok{getLine}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{ghci}\OperatorTok{>}\NormalTok{ interactAuto settableAuto}
\OperatorTok{>} \DataTypeTok{Nothing}
\DecValTok{1}
\OperatorTok{>} \DataTypeTok{Nothing}
\DecValTok{2}
\OperatorTok{>} \DataTypeTok{Just} \DecValTok{10}
\DecValTok{10}
\OperatorTok{>} \DataTypeTok{Nothing}
\DecValTok{11}
\end{Highlighting}
...
\NormalTok{    isEvenAutoFrom n }\OtherTok{=} \DataTypeTok{ACons} \OperatorTok{$}\NormalTok{ \textbackslash{}reset }\OtherTok{{-}>}
      \KeywordTok{let}\NormalTok{ c }\OtherTok{=}\NormalTok{ fromMaybe n reset}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{ghci}\OperatorTok{>}\NormalTok{ testAuto isEvenAuto  [ }\DataTypeTok{Nothing}\NormalTok{, }\DataTypeTok{Nothing}\NormalTok{, }\DataTypeTok{Just} \DecValTok{10}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{ghci}\OperatorTok{>} \KeywordTok{let}\NormalTok{ (out1, auto1) }\OtherTok{=}\NormalTok{ runAuto summer }\DecValTok{10}
\NormalTok{ghci}\OperatorTok{>}\NormalTok{ out1}
\DecValTok{10}
\NormalTok{ghci}\OperatorTok{>} \KeywordTok{let}\NormalTok{ (out2, auto2) }\OtherTok{=}\NormalTok{ runAuto auto1 }\DecValTok{3}
\NormalTok{ghci}\OperatorTok{>}\NormalTok{ out2}
\DecValTok{13}
\NormalTok{ghci}\OperatorTok{>}\NormalTok{ testAuto\_ auto2 [}\DecValTok{15}\NormalTok{,}\OperatorTok{{-}}\DecValTok{17}\NormalTok{,}\DecValTok{6}\NormalTok{,}\DecValTok{0}\NormalTok{,}\OperatorTok{{-}}\DecValTok{1}\NormalTok{]}
...
\OtherTok{autoFold ::} \KeywordTok{forall}\NormalTok{ a b}\OperatorTok{.}\NormalTok{ (b }\OtherTok{{-}>}\NormalTok{ a }\OtherTok{{-}>}\NormalTok{ b) }\OtherTok{{-}>}\NormalTok{ b }\OtherTok{{-}>} \DataTypeTok{Auto}\NormalTok{ a b}
...
\NormalTok{    foldFrom x }\OtherTok{=} \DataTypeTok{ACons} \OperatorTok{$}\NormalTok{ \textbackslash{}input }\OtherTok{{-}>}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{foldl}\OtherTok{      ::}\NormalTok{ (b }\OtherTok{{-}>}\NormalTok{ a }\OtherTok{{-}>}\NormalTok{ b) }\OtherTok{{-}>}\NormalTok{ b }\OtherTok{{-}>}\NormalTok{ ( (}\OtherTok{{-}>}\NormalTok{) [a] b )}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{foldl}\NormalTok{    op}\OtherTok{ initial  ::}\NormalTok{ (}\OtherTok{{-}>}\NormalTok{) [a] b}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{map}\OtherTok{       f          ::}\NormalTok{ [a] }\OtherTok{{-}>}\NormalTok{ [b]}
\FunctionTok{scanl}\NormalTok{     op}\OtherTok{ initial ::}\NormalTok{ [a] }\OtherTok{{-}>}\NormalTok{ [b]}
\NormalTok{testAuto\_}\OtherTok{ auto       ::}\NormalTok{ [a] }\OtherTok{{-}>}\NormalTok{ [b]}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{ghci}\OperatorTok{>}\NormalTok{ testAuto\_ (autoMap }\DecValTok{3}\NormalTok{)}
