...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{ghci}\OperatorTok{>}\NormalTok{ knock }\DataTypeTok{KnockClosed}\NormalTok{ (mkDoor }\DataTypeTok{SClosed} \StringTok{"Birch"}\NormalTok{)}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{ghci}\OperatorTok{>}\NormalTok{ knock auto (mkDoor }\DataTypeTok{SClosed} \StringTok{"Acacia"}\NormalTok{)}
\DataTypeTok{Knock}\NormalTok{ knock on }\DataTypeTok{Acacia}\NormalTok{ door}\OperatorTok{!}

\NormalTok{ghci}\OperatorTok{>}\NormalTok{ knock auto (mkDoor }\DataTypeTok{SOpened} \StringTok{"Jungle"}\NormalTok{)}
...
\KeywordTok{type} \DataTypeTok{Refuted}\NormalTok{ a }\OtherTok{=}\NormalTok{ a }\OtherTok{{-}>} \DataTypeTok{Void}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{isKnockable }\OtherTok{=}\NormalTok{ \textbackslash{}}\KeywordTok{case}
    \DataTypeTok{SOpened} \OtherTok{{-}>} \DataTypeTok{Disproved} \OperatorTok{$}\NormalTok{ \textbackslash{}}\KeywordTok{case}\NormalTok{ \{\}    }\CommentTok{{-}{-} s \textasciitilde{} \textquotesingle{}Opened}
    \DataTypeTok{SClosed} \OtherTok{{-}>} \DataTypeTok{Proved} \DataTypeTok{KnockClosed}      \CommentTok{{-}{-} s \textasciitilde{} \textquotesingle{}Closed}
    \DataTypeTok{SLocked} \OtherTok{{-}>} \DataTypeTok{Proved} \DataTypeTok{KnockLocked}      \CommentTok{{-}{-} s \textasciitilde{} \textquotesingle{}Locked}
\end{Highlighting}
\end{Shaded}
...
\OtherTok{disproveOpened ::} \DataTypeTok{Knockable} \DataTypeTok{\textquotesingle{}Opened} \OtherTok{{-}>} \DataTypeTok{Void}
...
\NormalTok{disproveOpened k }\OtherTok{=} \KeywordTok{case}\NormalTok{ k }\KeywordTok{of}
    \DataTypeTok{KnockClosed} \OtherTok{{-}>} \OperatorTok{...}    \CommentTok{{-}{-} not a valid pattern, since it\textquotesingle{}s \textasciigrave{}Knockable \textquotesingle{}Closed\textasciigrave{}}
    \DataTypeTok{KnockLocked} \OtherTok{{-}>} \OperatorTok{...}    \CommentTok{{-}{-} not a valid pattern, since it\textquotesingle{}s \textasciigrave{}Knockable \textquotesingle{}Locked\textasciigrave{}}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{knockSomeDoor (}\DataTypeTok{MkSomeDoor}\NormalTok{ s d) }\OtherTok{=} \KeywordTok{case}\NormalTok{ isKnockable s }\KeywordTok{of}
    ...
    \DataTypeTok{Disproved}\NormalTok{ \_ }\OtherTok{{-}>} \FunctionTok{putStrLn} \StringTok{"No knocking allowed!"}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{isKnockable }\OtherTok{=}\NormalTok{ \textbackslash{}}\KeywordTok{case}
    \DataTypeTok{SOpened} \OtherTok{{-}>} \DataTypeTok{Disproved} \OperatorTok{$}\NormalTok{ \textbackslash{}}\KeywordTok{case}\NormalTok{ \{\}}
    \DataTypeTok{SClosed} \OtherTok{{-}>} \DataTypeTok{Disproved} \OperatorTok{$} \CommentTok{{-}{-} ????}
...
\OtherTok{    (\%\textasciitilde{}) ::} \DataTypeTok{Sing}\NormalTok{ (}\OtherTok{a ::}\NormalTok{ k)}
         ...
         \OtherTok{{-}>} \DataTypeTok{Decision}\NormalTok{ (a }\OperatorTok{:\textasciitilde{}:}\NormalTok{ b)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{(}\DataTypeTok{STrue} \OperatorTok{\%\textasciitilde{}}\NormalTok{)}\OtherTok{ ::} \DataTypeTok{Sing}\NormalTok{ b }\OtherTok{{-}>} \DataTypeTok{Decision}\NormalTok{ (}\DataTypeTok{\textquotesingle{}True} \OperatorTok{:\textasciitilde{}:}\NormalTok{ b)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{ghci}\OperatorTok{>} \OperatorTok{:}\NormalTok{kind}\OperatorTok{!} \DataTypeTok{StatePass} \DataTypeTok{\textquotesingle{}Opened}
\DataTypeTok{\textquotesingle{}Allow}
\NormalTok{ghci}\OperatorTok{>} \OperatorTok{:}\NormalTok{kind}\OperatorTok{!} \DataTypeTok{StatePass} \DataTypeTok{\textquotesingle{}Closed}
...
\NormalTok{ghci}\OperatorTok{>}\NormalTok{ knock door1}
\CommentTok{{-}{-} Knock knock on Oak door!}
\NormalTok{ghci}\OperatorTok{>}\NormalTok{ knock door2}
...
\NormalTok{knockSomeDoorP (}\DataTypeTok{MkSomeDoor}\NormalTok{ s d) }\OtherTok{=} \KeywordTok{case}\NormalTok{ sStatePass s }\KeywordTok{of}
    \DataTypeTok{SObstruct} \OtherTok{{-}>}\NormalTok{ knockP d                        }\CommentTok{{-}{-} \^{} \textasciigrave{}StatePass s \textasciitilde{} \textquotesingle{}Obstruct\textasciigrave{}}
    \DataTypeTok{SAllow}    \OtherTok{{-}>} \FunctionTok{putStrLn} \StringTok{"No knocking allowed!"} \CommentTok{{-}{-} \^{} \textasciigrave{}StatePass s \textasciitilde{} \textquotesingle{}Allow\textasciigrave{}}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{fst}\OtherTok{ ::}\NormalTok{ (a, b) }\OtherTok{{-}>}\NormalTok{ a}
...
\OtherTok{(\%++) ::} \DataTypeTok{Sing}\NormalTok{ xs }\OtherTok{{-}>} \DataTypeTok{Sing}\NormalTok{ ys }\OtherTok{{-}>} \DataTypeTok{Sing}\NormalTok{ (xs }\OperatorTok{++}\NormalTok{ ys)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{ghci}\OperatorTok{>} \OperatorTok{:}\NormalTok{kind}\OperatorTok{!} \DataTypeTok{\textquotesingle{}Obstruct} \OperatorTok{==} \DataTypeTok{\textquotesingle{}Obstruct}
\DataTypeTok{\textquotesingle{}True}
\NormalTok{ghci}\OperatorTok{>} \DataTypeTok{SAllow} \OperatorTok{\%==} \DataTypeTok{SObstruct}
\DataTypeTok{SFalse}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{ghci}\OperatorTok{>} \OperatorTok{:}\NormalTok{kind}\OperatorTok{!} \DataTypeTok{Show\_} \DataTypeTok{\textquotesingle{}Obstruct}      \CommentTok{{-}{-} is named Show\_ to not conflict with prelude Show}
\StringTok{"Obstruct"}
\NormalTok{ghci}\OperatorTok{>}\NormalTok{ sMax }\DataTypeTok{SObstruct} \DataTypeTok{SAllow}
\DataTypeTok{SAllow}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\OtherTok{absurd ::} \KeywordTok{forall}\NormalTok{ a}\OperatorTok{.} \DataTypeTok{Void} \OtherTok{{-}>}\NormalTok{ a}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{decideAnd}
\OtherTok{    ::}\NormalTok{ (}\KeywordTok{forall}\NormalTok{ x}\OperatorTok{.} \DataTypeTok{Sing}\NormalTok{ x }\OtherTok{{-}>} \DataTypeTok{Decision}\NormalTok{ (p x))}
    \OtherTok{{-}>}\NormalTok{ (}\KeywordTok{forall}\NormalTok{ x}\OperatorTok{.} \DataTypeTok{Sing}\NormalTok{ x }\OtherTok{{-}>} \DataTypeTok{Decision}\NormalTok{ (q x))}
...
\OtherTok{    ::} \KeywordTok{forall}\NormalTok{ s}\OperatorTok{.} \DataTypeTok{SingI}\NormalTok{ s}
    \OtherTok{=>} \DataTypeTok{Refuted}\NormalTok{ (}\DataTypeTok{And} \DataTypeTok{Knockable}\NormalTok{ ((}\OperatorTok{:\textasciitilde{}:}\NormalTok{) }\DataTypeTok{\textquotesingle{}Opened}\NormalTok{) s)}
\end{Highlighting}
\end{Shaded}
...
\OtherTok{    ::} \KeywordTok{forall}\NormalTok{ s}\OperatorTok{.} \DataTypeTok{SingI}\NormalTok{ s}
    \OtherTok{=>} \DataTypeTok{Or} \DataTypeTok{Knockable}\NormalTok{ ((}\OperatorTok{:\textasciitilde{}:}\NormalTok{) }\DataTypeTok{\textquotesingle{}Opened}\NormalTok{) s}
\end{Highlighting}
\end{Shaded}
  \end{enumerate}
...
\begin{Shaded}
\begin{Highlighting}[]
\OtherTok{knock ::} \DataTypeTok{Refuted}\NormalTok{ (s }\OperatorTok{:\textasciitilde{}:} \DataTypeTok{\textquotesingle{}Opened}\NormalTok{) }\OtherTok{{-}>} \DataTypeTok{Door}\NormalTok{ s }\OtherTok{{-}>} \DataTypeTok{IO}\NormalTok{ ()}
\end{Highlighting}
\end{Shaded}
...
\OtherTok{    ::} \KeywordTok{forall}\NormalTok{ s}\OperatorTok{.} \DataTypeTok{SingI}\NormalTok{ s}
    \OtherTok{=>} \DataTypeTok{Knockable}\NormalTok{ s}
    \OtherTok{{-}>} \DataTypeTok{Refuted}\NormalTok{ (s }\OperatorTok{:\textasciitilde{}:} \DataTypeTok{\textquotesingle{}Opened}\NormalTok{)}
...
\begin{Shaded}
\begin{Highlighting}[]
\OtherTok{knock ::}\NormalTok{ (}\DataTypeTok{StatePass}\NormalTok{ s }\OperatorTok{\textasciitilde{}} \DataTypeTok{\textquotesingle{}Obstruct}\NormalTok{) }\OtherTok{=>} \DataTypeTok{Door}\NormalTok{ s }\OtherTok{{-}>} \DataTypeTok{IO}\NormalTok{ ()}
\NormalTok{knock d }\OtherTok{=} \FunctionTok{putStrLn} \OperatorTok{$} \StringTok{"Knock knock on "} \OperatorTok{++}\NormalTok{ doorMaterial d }\OperatorTok{++} \StringTok{" door!"}
\end{Highlighting}
\end{Shaded}
...
\OtherTok{knockRefl ::}\NormalTok{ (}\DataTypeTok{StatePass}\NormalTok{ s }\OperatorTok{:\textasciitilde{}:} \DataTypeTok{\textquotesingle{}Obstruct}\NormalTok{) }\OtherTok{{-}>} \DataTypeTok{Door}\NormalTok{ s }\OtherTok{{-}>} \DataTypeTok{IO}\NormalTok{ ()}
...
\OtherTok{knockInv ::}\NormalTok{ (}\DataTypeTok{InvertPass}\NormalTok{ (}\DataTypeTok{StatePass}\NormalTok{ s) }\OperatorTok{\textasciitilde{}} \DataTypeTok{\textquotesingle{}Allow}\NormalTok{) }\OtherTok{=>} \DataTypeTok{Door}\NormalTok{ s }\OtherTok{{-}>} \DataTypeTok{IO}\NormalTok{ ()}
