...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{-- source: https://github.com/mstksg/inCode/tree/master/code-samples/singletons/Door3.hs#L28-L31}
...
\end{Shaded}
  ...
  Try to manually promote this instance for \texttt{DoorState} to the type
  level:
