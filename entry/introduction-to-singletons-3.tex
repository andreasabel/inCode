...
The first half of today's post doesn't deal \emph{directly} with the
\emph{singletons} library and the singleton design pattern, but, like usage of
phantom types, is a design pattern that the usage of singletons greatly
enhances. The second part of today's post deals directly with the lifting of
functions to the type level, which is made practical by the usage of singletons
and the \emph{singletons} library.

Code in this post is built on \emph{GHC 8.4.3} with the
\emph{\href{https://www.stackage.org/lts-12.9}{lts-12.9}} snapshot (so,
singletons-2.4.1). Again, you can download the source for this file
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{-- source: https://github.com/mstksg/inCode/tree/master/code-samples/singletons/Door3.hs#L28-L34}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{-- source: https://github.com/mstksg/inCode/tree/master/code-samples/singletons/Door3.hs#L36-L41}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{-- source: https://github.com/mstksg/inCode/tree/master/code-samples/singletons/Door3.hs#L43-L45}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{-- source: https://github.com/mstksg/inCode/tree/master/code-samples/singletons/Door3.hs#L47-L48}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{-- source: https://github.com/mstksg/inCode/tree/master/code-samples/singletons/Door3.hs#L50-L57}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{-- source: https://github.com/mstksg/inCode/tree/master/code-samples/singletons/Door3.hs#L59-L63}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{-- source: https://github.com/mstksg/inCode/tree/master/code-samples/singletons/Door3.hs#L65-L66}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{-- source: https://github.com/mstksg/inCode/tree/master/code-samples/singletons/Door3.hs#L68-L73}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{-- source: https://github.com/mstksg/inCode/tree/master/code-samples/singletons/Door3.hs#L85-L86}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{-- source: https://github.com/mstksg/inCode/tree/master/code-samples/singletons/Door3.hs#L88-L93}
...
\item
  ...
  Solution available
  \href{https://github.com/mstksg/inCode/tree/master/code-samples/singletons/Door3.hs\#L100-L105}{here}!
\item
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{-- source: https://github.com/mstksg/inCode/tree/master/code-samples/singletons/Door3.hs#L108-L108}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{-- source: https://github.com/mstksg/inCode/tree/master/code-samples/singletons/Door3.hs#L111-L111}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{-- source: https://github.com/mstksg/inCode/tree/master/code-samples/singletons/Door3.hs#L114-L129}
...
\end{Shaded}
  ...
  Solutions available
  \href{https://github.com/mstksg/inCode/tree/master/code-samples/singletons/Door3.hs\#L107-L136}{here}!
\item
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{-- source: https://github.com/mstksg/inCode/tree/master/code-samples/singletons/Door3.hs#L138-L141}
...
\end{Shaded}
  ...
  Solution available
  \href{https://github.com/mstksg/inCode/tree/master/code-samples/singletons/Door3.hs\#L138-L144}{here}!
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{-- source: https://github.com/mstksg/inCode/tree/master/code-samples/singletons/Door3.hs#L155-L156}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{-- source: https://github.com/mstksg/inCode/tree/master/code-samples/singletons/Door3.hs#L158-L161}
...
\end{Shaded}
  ...
  Solution available
  \href{https://github.com/mstksg/inCode/tree/master/code-samples/singletons/Door3.hs\#L155-L164}{here}.
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{-- source: https://github.com/mstksg/inCode/tree/master/code-samples/singletons/Door3.hs#L172-L173}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{-- source: https://github.com/mstksg/inCode/tree/master/code-samples/singletons/Door3.hs#L175-L178}
...
\end{Shaded}
  ...
  Solution available
  \href{https://github.com/mstksg/inCode/tree/master/code-samples/singletons/Door3.hs\#L172-L181}{here}!
\item
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{-- source: https://github.com/mstksg/inCode/tree/master/code-samples/singletons/Door3.hs#L189-L196}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{-- source: https://github.com/mstksg/inCode/tree/master/code-samples/singletons/Door3.hs#L198-L207}
...
\end{Shaded}
  ...
  Solution available
  \href{https://github.com/mstksg/inCode/tree/master/code-samples/singletons/Door3.hs\#L189-L216}{here}!
\end{enumerate}
