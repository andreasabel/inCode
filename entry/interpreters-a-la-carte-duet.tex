...
\hypertarget{wrap-up-and-expansion}{%
\section{Wrap Up and Expansion}\label{wrap-up-and-expansion}}
...
\OtherTok{    ::}\NormalTok{ (           }\DataTypeTok{Mem}            \FunctionTok{:|:} \DataTypeTok{Com}\NormalTok{) a}
    \OtherTok{->}\NormalTok{ ((}\DataTypeTok{PSL}\NormalTok{ (}\DataTypeTok{Thread}\NormalTok{, t) }\FunctionTok{:&:} \DataTypeTok{Mem}\NormalTok{) }\FunctionTok{:|:} \DataTypeTok{Com}\NormalTok{) a}
\end{Highlighting}
\end{Shaded}
