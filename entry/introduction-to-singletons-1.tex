...
\texttt{s} at the type level. It also lets GHC \emph{check} our implementations,
to help ensure that they are correct, because you maintain the \texttt{s} at the
type level.
