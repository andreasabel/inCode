...
``unsanitized'' (\texttt{UserString\ \textquotesingle{}Sanitized} type vs.
...
\CommentTok{-- or}
\CommentTok{-- source: https://github.com/mstksg/inCode/tree/master/code-samples/singletons/DoorSingletons.hs#L21-L24}
