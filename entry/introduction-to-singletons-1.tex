...
\href{https://ren.zone/articles/safe-money}{safe-money}). A particularly common
...
(Note, however, that this is still a step away from a \texttt{Door} whose status
can vary at runtime, since, as of now, we can't generate an arbitrary singleton
at runtime.)
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{-- source: https://github.com/mstksg/inCode/tree/master/code-samples/singletons/Door.hs#L99-103}
