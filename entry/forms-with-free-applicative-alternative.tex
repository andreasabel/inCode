...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{-- source: https://github.com/mstksg/inCode/tree/master/code-samples/free-applicative-forms/Form.hs#L41-L51}

\NormalTok{stringInput}
\OtherTok{    ::} \DataTypeTok{String}           \CommentTok{-- ^ description}
    \OtherTok{->} \DataTypeTok{String}           \CommentTok{-- ^ identifier}
    \OtherTok{->} \DataTypeTok{String}           \CommentTok{-- ^ initial}
    \OtherTok{->} \DataTypeTok{Form} \DataTypeTok{String}
\NormalTok{stringInput desc ident initial }\FunctionTok{=}\NormalTok{ liftAlt }\FunctionTok{$}
    \DataTypeTok{FE}\NormalTok{ \{ feElem  }\FunctionTok{=} \DataTypeTok{EText}\NormalTok{ initial}
\NormalTok{       , feParse }\FunctionTok{=} \DataTypeTok{Right}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{-- source: https://github.com/mstksg/inCode/tree/master/code-samples/free-applicative-forms/Form.hs#L53-L65}

\NormalTok{readInput}
\OtherTok{    ::}\NormalTok{ (}\DataTypeTok{Read}\NormalTok{ a, }\DataTypeTok{Show}\NormalTok{ a)}
    \OtherTok{=>} \DataTypeTok{String}           \CommentTok{-- ^ description}
    \OtherTok{->} \DataTypeTok{String}           \CommentTok{-- ^ identifier}
    \OtherTok{->} \DataTypeTok{Maybe}\NormalTok{ a          }\CommentTok{-- ^ initial}
    \OtherTok{->} \DataTypeTok{Form}\NormalTok{ a}
\NormalTok{readInput desc ident initial }\FunctionTok{=}\NormalTok{ liftAlt }\FunctionTok{$}
    \DataTypeTok{FE}\NormalTok{ \{ feElem  }\FunctionTok{=} \DataTypeTok{EText}\NormalTok{ (maybe }\StringTok{""}\NormalTok{ show initial)}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{-- source: https://github.com/mstksg/inCode/tree/master/code-samples/free-applicative-forms/Form.hs#L67-L93}
...
\OtherTok{    ::} \DataTypeTok{Integral}\NormalTok{ a}
    ...
    \OtherTok{->} \DataTypeTok{Maybe}\NormalTok{ a    }\CommentTok{-- ^ initial}
    \OtherTok{->} \DataTypeTok{Form}\NormalTok{ a}
\NormalTok{intInput desc ident initial }\FunctionTok{=}\NormalTok{ liftAlt }\FunctionTok{$}
    \DataTypeTok{FE}\NormalTok{ \{ feElem  }\FunctionTok{=} \DataTypeTok{ENumber}\NormalTok{ (fromIntegral }\FunctionTok{<$>}\NormalTok{ initial)}
...
\OtherTok{    ::} \DataTypeTok{RealFloat}\NormalTok{ a}
    ...
    \OtherTok{->} \DataTypeTok{Maybe}\NormalTok{ a          }\CommentTok{-- ^ initial}
    \OtherTok{->} \DataTypeTok{Form}\NormalTok{ a}
\NormalTok{floatInput desc ident initial }\FunctionTok{=}\NormalTok{ liftAlt }\FunctionTok{$}
    \DataTypeTok{FE}\NormalTok{ \{ feElem  }\FunctionTok{=} \DataTypeTok{ENumber}\NormalTok{ (realToFrac }\FunctionTok{<$>}\NormalTok{ initial)}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{-- source: https://github.com/mstksg/inCode/tree/master/code-samples/free-applicative-forms/Form.hs#L95-L105}

\NormalTok{selectInput}
\OtherTok{    ::} \DataTypeTok{Show}\NormalTok{ a}
    \OtherTok{=>} \DataTypeTok{String}           \CommentTok{-- ^ description}
    \OtherTok{->} \DataTypeTok{String}           \CommentTok{-- ^ identifier}
    \OtherTok{->} \DataTypeTok{Maybe} \DataTypeTok{Int}        \CommentTok{-- ^ initial}
    \OtherTok{->}\NormalTok{ [a]              }\CommentTok{-- ^ options}
    \OtherTok{->} \DataTypeTok{Form}\NormalTok{ a}
\NormalTok{selectInput desc ident initial opts }\FunctionTok{=}\NormalTok{ liftAlt }\FunctionTok{$}
    \DataTypeTok{FE}\NormalTok{ (}\DataTypeTok{ESelect}\NormalTok{ initial (show }\FunctionTok{<$>}\NormalTok{ opts)) p desc ident}
  \KeywordTok{where}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{-- source: https://github.com/mstksg/inCode/tree/master/code-samples/free-applicative-forms/Form.hs#L107-L120}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{-- source: https://github.com/mstksg/inCode/tree/master/code-samples/free-applicative-forms/Form.hs#L122-L125}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{-- source: https://github.com/mstksg/inCode/tree/master/code-samples/free-applicative-forms/Form.hs#L135-L145}

\OtherTok{accountForm ::} \DataTypeTok{Form} \DataTypeTok{Account}
\NormalTok{accountForm }\FunctionTok{=}
    \DataTypeTok{Acc} \FunctionTok{<$>}\NormalTok{ stringInput }\StringTok{"Name"} \StringTok{"name"} \StringTok{""}
        \FunctionTok{<*>}\NormalTok{ optional (stringInput }\StringTok{"Country"} \StringTok{"country"} \StringTok{"USA"}\NormalTok{)}
        \FunctionTok{<*>}\NormalTok{ intInput }\StringTok{"Age"} \StringTok{"age"} \DataTypeTok{Nothing}
  ...
  \KeywordTok{where}
\NormalTok{    favColor    }\FunctionTok{=}\NormalTok{ selectInput }\StringTok{"Favorite Color"} \StringTok{"fav-color"} \DataTypeTok{Nothing}
\NormalTok{                    [}\DataTypeTok{Red}\NormalTok{, }\DataTypeTok{Blue}\NormalTok{, }\DataTypeTok{Orange}\NormalTok{, }\DataTypeTok{Yellow}\NormalTok{]}
\NormalTok{    customColor }\FunctionTok{=}\NormalTok{ stringInput }\StringTok{"Custom Color"} \StringTok{"custum-color"} \StringTok{""}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{-- source: https://github.com/mstksg/inCode/tree/master/code-samples/free-applicative-forms/Form.hs#L147-L156}

\OtherTok{accountFormAdo ::} \DataTypeTok{Form} \DataTypeTok{Account}
\NormalTok{accountFormAdo }\FunctionTok{=} \KeywordTok{do}
\NormalTok{    nam }\OtherTok{<-}\NormalTok{ stringInput }\StringTok{"Name"} \StringTok{"name"} \StringTok{""}
\NormalTok{    con }\OtherTok{<-}\NormalTok{ optional }\FunctionTok{$}\NormalTok{ stringInput }\StringTok{"Country"} \StringTok{"country"} \StringTok{"USA"}
\NormalTok{    age }\OtherTok{<-}\NormalTok{ intInput }\StringTok{"Age"} \StringTok{"age"} \DataTypeTok{Nothing}
\NormalTok{    col }\OtherTok{<-} \DataTypeTok{Left}  \FunctionTok{<$>}\NormalTok{ selectInput }\StringTok{"Favorite Color"} \StringTok{"fav-color"} \DataTypeTok{Nothing}
\NormalTok{                       [}\DataTypeTok{Red}\NormalTok{, }\DataTypeTok{Blue}\NormalTok{, }\DataTypeTok{Orange}\NormalTok{, }\DataTypeTok{Yellow}\NormalTok{]}
       \FunctionTok{<|>} \DataTypeTok{Right} \FunctionTok{<$>}\NormalTok{ stringInput }\StringTok{"Custom Color"} \StringTok{"custum-color"} \StringTok{""}
...
\NormalTok{    pure (}\DataTypeTok{Acc}\NormalTok{ nam con age col typ)}
\end{Highlighting}
\end{Shaded}
