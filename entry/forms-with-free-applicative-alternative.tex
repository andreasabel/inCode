...
\NormalTok{addingForm }\OtherTok{=}\NormalTok{ (}\OperatorTok{+}\NormalTok{) }\OperatorTok{<$>}\NormalTok{ intForm }\OperatorTok{<*>}\NormalTok{ intForm}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{eitherInt }\OtherTok{=}\NormalTok{ (}\DataTypeTok{Left} \OperatorTok{<$>}\NormalTok{ intForm) }\OperatorTok{<|>}\NormalTok{ (}\DataTypeTok{Right} \OperatorTok{<$>}\NormalTok{ boolForm)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{oneOfMany }\OtherTok{=}\NormalTok{ choice [ }\FunctionTok{show} \OperatorTok{<$>}\NormalTok{ intForm}
\NormalTok{                   , }\FunctionTok{show} \OperatorTok{<$>}\NormalTok{ boolForm}
\NormalTok{                   , stringForm}
\NormalTok{                   , (}\OperatorTok{++}\NormalTok{) }\OperatorTok{<$>}\NormalTok{ stringForm }\OperatorTok{<*>}\NormalTok{ stringForm}
\NormalTok{                   ]}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{       , feParse }\OtherTok{=} \FunctionTok{either}\NormalTok{ (\textbackslash{}\_ }\OtherTok{{-}>} \DataTypeTok{Left}\NormalTok{ (ident }\OperatorTok{++} \StringTok{" should be integer"}\NormalTok{)) }\DataTypeTok{Right}
...
\NormalTok{selectInput desc ident opts }\OtherTok{=}\NormalTok{ liftAlt }\OperatorTok{$}
    \DataTypeTok{FE}\NormalTok{ (}\DataTypeTok{ESelect}\NormalTok{ (}\FunctionTok{show} \OperatorTok{<$>}\NormalTok{ opts)) p desc ident}
  \KeywordTok{where}
...
\NormalTok{accountForm }\OtherTok{=}
    \DataTypeTok{Acc} \OperatorTok{<$>}\NormalTok{ stringInput }\StringTok{"Name"} \StringTok{"name"}
        \OperatorTok{<*>}\NormalTok{ optional (intInput }\StringTok{"Age"} \StringTok{"age"}\NormalTok{)}
        \OperatorTok{<*>}\NormalTok{ (}\DataTypeTok{Left} \OperatorTok{<$>}\NormalTok{ favColor }\OperatorTok{<|>} \DataTypeTok{Right} \OperatorTok{<$>}\NormalTok{ customColor)}
        \OperatorTok{<*>}\NormalTok{ checkInput }\StringTok{"Premium Account"} \StringTok{"premium"} \DataTypeTok{Normal} \DataTypeTok{Premium} 
  \KeywordTok{where}
...
\NormalTok{    age }\OtherTok{<{-}}\NormalTok{ optional }\OperatorTok{$}\NormalTok{ intInput }\StringTok{"Age"} \StringTok{"age"}
\NormalTok{    col }\OtherTok{<{-}} \DataTypeTok{Left}  \OperatorTok{<$>}\NormalTok{ selectInput }\StringTok{"Favorite Color"} \StringTok{"fav{-}color"}
\NormalTok{                       [}\DataTypeTok{Red}\NormalTok{, }\DataTypeTok{Blue}\NormalTok{, }\DataTypeTok{Orange}\NormalTok{, }\DataTypeTok{Yellow}\NormalTok{]}
       \OperatorTok{<|>} \DataTypeTok{Right} \OperatorTok{<$>}\NormalTok{ stringInput }\StringTok{"Custom Color"} \StringTok{"custom{-}color"}
