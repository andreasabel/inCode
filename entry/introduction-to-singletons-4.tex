...
\NormalTok{'}\DataTypeTok{False}              \CommentTok{-- or FalseSym0, which is a synonym for 'False}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{type} \DataTypeTok{FalseSym0} \FunctionTok{=}\NormalTok{ '}\DataTypeTok{False}
\KeywordTok{type} \DataTypeTok{TrueSym0}  \FunctionTok{=}\NormalTok{ '}\DataTypeTok{True}
\end{Highlighting}
\end{Shaded}
