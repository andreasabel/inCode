...
\KeywordTok{type} \DataTypeTok{Model}\NormalTok{ p a b }\FunctionTok{=} \KeywordTok{forall}\NormalTok{ z}\FunctionTok{.} \DataTypeTok{Reifies}\NormalTok{ z }\DataTypeTok{W}
...
\NormalTok{    p0 }\OtherTok{<-}\NormalTok{ (}\FunctionTok{/} \DecValTok{10}\NormalTok{) }\FunctionTok{.} \FunctionTok{subtract} \FloatTok{0.5} \FunctionTok{<$>}\NormalTok{ randomIO}
    \FunctionTok{return} \FunctionTok{$}\NormalTok{ trainModel m p0 xs}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{ghci}\FunctionTok{>}\NormalTok{ trainModelIO linReg }\FunctionTok{$} \FunctionTok{take} \DecValTok{5000}\NormalTok{ (}\FunctionTok{cycle}\NormalTok{ samps)}
...
\NormalTok{logistic x }\FunctionTok{=} \DecValTok{1} \FunctionTok{/}\NormalTok{ (}\DecValTok{1} \FunctionTok{+} \FunctionTok{exp}\NormalTok{ (}\FunctionTok{-}\NormalTok{x))}
...
\NormalTok{ghci}\FunctionTok{>}\NormalTok{ trained }\OtherTok{<-}\NormalTok{ trainModelIO feedForwardLog }\FunctionTok{$} \FunctionTok{take} \DecValTok{10000}\NormalTok{ (}\FunctionTok{cycle}\NormalTok{ samps)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{softMax x }\FunctionTok{=}\NormalTok{ konst (}\DecValTok{1} \FunctionTok{/}\NormalTok{ sumElements expx) }\FunctionTok{*}\NormalTok{ expx}
  \KeywordTok{where}
\NormalTok{    expx }\FunctionTok{=} \FunctionTok{exp}\NormalTok{ x}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{ghci}\FunctionTok{>} \KeywordTok{let}\OtherTok{ samps ::}\NormalTok{ [(}\DataTypeTok{R} \DecValTok{2}\NormalTok{, }\DataTypeTok{R} \DecValTok{1}\NormalTok{)]}
\NormalTok{          samps }\FunctionTok{=}\NormalTok{ [(H.vec2 }\DecValTok{0} \DecValTok{0}\NormalTok{, }\DecValTok{0}\NormalTok{), (H.vec2 }\DecValTok{1} \DecValTok{0}\NormalTok{, }\DecValTok{1}\NormalTok{), (H.vec2 }\DecValTok{0} \DecValTok{1}\NormalTok{, }\DecValTok{1}\NormalTok{), (H.vec2 }\DecValTok{1} \DecValTok{1}\NormalTok{, }\DecValTok{0}\NormalTok{)]}
\NormalTok{ghci}\FunctionTok{>}\NormalTok{ trained }\OtherTok{<-}\NormalTok{ trainModelIO twoLayer }\FunctionTok{$} \FunctionTok{take} \DecValTok{50000}\NormalTok{ (}\FunctionTok{cycle}\NormalTok{ samps)}
\end{Highlighting}
\end{Shaded}
