...
\FunctionTok{showInt} \FunctionTok{=} \FunctionTok{show}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{certaintify }\DataTypeTok{Nothing}  \FunctionTok{=} \FunctionTok{error} \StringTok{"Nothing was there, you fool!"}
...
\NormalTok{ghci}\FunctionTok{>}\NormalTok{ (inMaybe }\FunctionTok{showInt}\NormalTok{) }\DataTypeTok{Nothing}
\DataTypeTok{Nothing}
\NormalTok{ghci}\FunctionTok{>}\NormalTok{ (inMaybe }\FunctionTok{showInt}\NormalTok{) (}\DataTypeTok{Just} \DecValTok{8}\NormalTok{)}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{ghci}\FunctionTok{>}\NormalTok{ (}\FunctionTok{fmap}\NormalTok{ square) (headMaybe [}\DecValTok{4}\NormalTok{,}\DecValTok{5}\NormalTok{,}\DecValTok{6}\NormalTok{])}
\DataTypeTok{Just} \DecValTok{16}
\NormalTok{ghci}\FunctionTok{>}\NormalTok{ (}\FunctionTok{fmap}\NormalTok{ square) (halveMaybe }\DecValTok{7}\NormalTok{)}
\DataTypeTok{Nothing}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{ghci}\FunctionTok{>} \FunctionTok{:}\NormalTok{t }\FunctionTok{fmap}\NormalTok{ halveMaybe}
...
\NormalTok{futureShorterThan n }\FunctionTok{=} \FunctionTok{fmap}\NormalTok{ (}\FunctionTok{<}\NormalTok{ n) futureLength}
