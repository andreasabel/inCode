...
*Originally posted by [Justin Le](https://blog.jle.im/) on April 3, 2014.  [Read online!](https://blog.jle.im/entry/a-dead-end-arrowized-dataflow-parallelism-interface-attempt.html)*
...
Ah. Everything is in terms of `arr` and `first`, and it never uses
...
Perhaps without the exception method, I could use `MVar`s to sort of
