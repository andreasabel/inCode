...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{{-}{-} source: https://github.com/mstksg/inCode/tree/master/code{-}samples/misc/streaming{-}combinators{-}free.hs\#L68{-}L75}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{{-}{-} source: https://github.com/mstksg/inCode/tree/master/code{-}samples/misc/streaming{-}combinators{-}free.hs\#L77{-}L84}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{{-}{-} source: https://github.com/mstksg/inCode/tree/master/code{-}samples/misc/streaming{-}combinators{-}free.hs\#L68{-}L104}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{{-}{-} source: https://github.com/mstksg/inCode/tree/master/code{-}samples/misc/streaming{-}combinators{-}free.hs\#L133{-}L133}

\OtherTok{sourceFile ::} \DataTypeTok{FilePath} \OtherTok{{-}>} \DataTypeTok{Pipe}\NormalTok{ i }\DataTypeTok{String}\NormalTok{ (}\DataTypeTok{ResourceT} \DataTypeTok{IO}\NormalTok{) ()}
\end{Highlighting}
\end{Shaded}

  (You might need to use
  \texttt{hoistFreeT\ lift\ ::\ Pipe\ i\ o\ IO\ a\ -\textgreater{}\ Pipe\ i\ o\ (ResourceT\ IO)\ a},
  given to us by the \emph{free} library, if you want to re-use
  \texttt{sourceHandle} in your implementation)

\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{{-}{-} source: https://github.com/mstksg/inCode/tree/master/code{-}samples/misc/streaming{-}combinators{-}free.hs\#L138{-}L143}
