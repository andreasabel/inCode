...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{data} \DataTypeTok{Vec}\OtherTok{ ::} \DataTypeTok{Nat} \OtherTok{{-}>} \OperatorTok{*} \OtherTok{{-}>} \OperatorTok{*}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{ghci}\OperatorTok{>} \FunctionTok{take} \DecValTok{5} \OperatorTok{$}\NormalTok{ unfold (\textbackslash{}x }\OtherTok{{-}>}\NormalTok{ (x }\OtherTok{\textasciigrave{}mod\textasciigrave{}} \DecValTok{3} \OperatorTok{==} \DecValTok{2}\NormalTok{, x}\OperatorTok{\^{}}\DecValTok{2} \OperatorTok{{-}} \DecValTok{1}\NormalTok{)) }\DecValTok{2}
...
\NormalTok{replicateU }\OtherTok{=}\NormalTok{ unfold (\textbackslash{}x }\OtherTok{{-}>}\NormalTok{ (x, x))}
...
\NormalTok{iterateU f }\OtherTok{=}\NormalTok{ unfold (\textbackslash{}x }\OtherTok{{-}>}\NormalTok{ (x, f x))}
...
\NormalTok{fromListMaybes }\OtherTok{=}\NormalTok{ unfold }\OperatorTok{$}\NormalTok{ \textbackslash{}l }\OtherTok{{-}>} \KeywordTok{case}\NormalTok{ l }\KeywordTok{of}
\NormalTok{                                  []   }\OtherTok{{-}>}\NormalTok{ (}\DataTypeTok{Nothing}\NormalTok{, [])}
\NormalTok{                                  x}\OperatorTok{:}\NormalTok{xs }\OtherTok{{-}>}\NormalTok{ (}\DataTypeTok{Just}\NormalTok{ x , xs)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{ghci}\OperatorTok{>}\NormalTok{ toList }\OperatorTok{$} \DecValTok{1} \OperatorTok{:\#} \DecValTok{2} \OperatorTok{:\#} \DecValTok{3} \OperatorTok{:\#} \DataTypeTok{Nil}
\NormalTok{[}\DecValTok{1}\NormalTok{,}\DecValTok{2}\NormalTok{,}\DecValTok{3}\NormalTok{]}
\NormalTok{ghci}\OperatorTok{>} \FunctionTok{traverse} \DataTypeTok{Identity} \OperatorTok{$} \DecValTok{1} \OperatorTok{:\#} \DecValTok{2} \OperatorTok{:\#} \DecValTok{3} \OperatorTok{:\#} \DataTypeTok{Nil}
...
\NormalTok{ghci}\OperatorTok{>} \FunctionTok{sequence\_} \OperatorTok{$} \FunctionTok{putStrLn} \StringTok{"hello"} \OperatorTok{:\#} \FunctionTok{putStrLn} \StringTok{"world"} \OperatorTok{:\#} \DataTypeTok{Nil}
\StringTok{"hello"}
\StringTok{"world"}
\NormalTok{ghci}\OperatorTok{>} \FunctionTok{sequence} \OperatorTok{$} \DataTypeTok{Just} \DecValTok{1} \OperatorTok{:\#} \DataTypeTok{Just} \DecValTok{2} \OperatorTok{:\#} \DataTypeTok{Nil}
\DataTypeTok{Just}\NormalTok{ (}\DecValTok{1} \OperatorTok{:\#} \DecValTok{2} \OperatorTok{:\#} \DataTypeTok{Nil}\NormalTok{)}
\NormalTok{ghci}\OperatorTok{>} \FunctionTok{sequence} \OperatorTok{$} \DataTypeTok{Just} \DecValTok{1} \OperatorTok{:\#} \DataTypeTok{Nothing} \OperatorTok{:\#} \DataTypeTok{Nil}
\DataTypeTok{Nothing}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{ghci}\OperatorTok{>}\NormalTok{ [}\DecValTok{1}\NormalTok{,}\DecValTok{2}\NormalTok{,}\DecValTok{3}\NormalTok{]}\OtherTok{ ::} \DataTypeTok{Vec}\NormalTok{ (}\DataTypeTok{S}\NormalTok{ (}\DataTypeTok{S} \DataTypeTok{Z}\NormalTok{)) }\DataTypeTok{Int}
\DecValTok{1} \OperatorTok{:\#} \DecValTok{2} \OperatorTok{:\#} \DataTypeTok{Nil}
\NormalTok{ghci}\OperatorTok{>}\NormalTok{ [}\DecValTok{1}\NormalTok{,}\DecValTok{2}\NormalTok{,}\DecValTok{3}\NormalTok{]}\OtherTok{ ::} \DataTypeTok{Vec}\NormalTok{ (}\DataTypeTok{S}\NormalTok{ (}\DataTypeTok{S}\NormalTok{ (}\DataTypeTok{S}\NormalTok{ (}\DataTypeTok{S} \DataTypeTok{Z}\NormalTok{)))) }\DataTypeTok{Int}
...
\NormalTok{ghci}\OperatorTok{>}\NormalTok{ [}\DecValTok{1}\NormalTok{,}\DecValTok{3}\OperatorTok{..}\NormalTok{]}\OtherTok{ ::} \DataTypeTok{Vec}\NormalTok{ (}\DataTypeTok{S}\NormalTok{ (}\DataTypeTok{S}\NormalTok{ (}\DataTypeTok{S}\NormalTok{ (}\DataTypeTok{S} \DataTypeTok{Z}\NormalTok{)))) }\DataTypeTok{Int}
