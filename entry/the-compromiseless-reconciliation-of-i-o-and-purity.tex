...
\OtherTok{first\_n\_fibs ::} \DataTypeTok{Int} \OtherTok{{-}>}\NormalTok{ [}\DataTypeTok{Int}\NormalTok{]}
...
\hypertarget{instructions-as-data-structures}{%
...
\CommentTok{{-}{-}  main: The IO object that we agree that the compiler will actually compile.}
\OtherTok{main ::} \DataTypeTok{IO}\NormalTok{ ()}
\NormalTok{main }\OtherTok{=}\NormalTok{ getStringFromStdin }\OperatorTok{>>=}\NormalTok{ (\textbackslash{}result }\OtherTok{{-}>} \FunctionTok{print}\NormalTok{ result)}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\OtherTok{ignoreAndSayHello ::} \DataTypeTok{IO}\NormalTok{ a }\OtherTok{{-}>} \DataTypeTok{IO}\NormalTok{ ()}
\NormalTok{ignoreAndSayHello to\_ignore }\OtherTok{=}\NormalTok{ to\_ignore }\OperatorTok{>>=}\NormalTok{ (\textbackslash{}result }\OtherTok{{-}>} \FunctionTok{print} \StringTok{"Hello!"}\NormalTok{)}
