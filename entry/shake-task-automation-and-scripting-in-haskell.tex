...
\NormalTok{(}\OperatorTok{\textasciitilde{}>}\NormalTok{) }\OtherTok{=}\NormalTok{ phony                                             }\CommentTok{{-}{-} 2}
                                                         \CommentTok{{-}{-} (obsolete)}
...
\NormalTok{    want []}
    ...
    \StringTok{"clean"} \OperatorTok{\textasciitilde{}>}\NormalTok{ removeFilesAfter }\StringTok{".shake"}\NormalTok{ [}\StringTok{"//*"}\NormalTok{]}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\StringTok{"out/report.doc"} \OperatorTok{*>}\NormalTok{ \textbackslash{}f }\OtherTok{{-}>} \KeywordTok{do}
...
\StringTok{"out/report.pdf"} \OperatorTok{*>}\NormalTok{ \textbackslash{}f }\OtherTok{{-}>} \KeywordTok{do}
\NormalTok{    need [}\StringTok{"src/report.md"}\NormalTok{,}\StringTok{"img/img1.jpg"}\NormalTok{,}\StringTok{"img/img2.jpg"}\NormalTok{]}
...
\StringTok{"out/report.html"} \OperatorTok{*>}\NormalTok{ \textbackslash{}f }\OtherTok{{-}>} \KeywordTok{do}
...
\StringTok{"img/img2.jpg"} \OperatorTok{*>}\NormalTok{ \textbackslash{}f }\OtherTok{{-}>} \KeywordTok{do}
...
\begin{Highlighting}[]
\StringTok{"out/report.doc"} \OperatorTok{*>}\NormalTok{ \textbackslash{}f }\OtherTok{{-}>} \KeywordTok{do}
\NormalTok{    need }\OperatorTok{=<<}\NormalTok{ srcFiles}
\NormalTok{    cmd }\StringTok{"pandoc"}\NormalTok{ [ }\StringTok{"src/report.md"}\NormalTok{, }\StringTok{"{-}o"}\NormalTok{, f ]}
\end{Highlighting}
\end{Shaded}
...
\begin{Highlighting}[]
\CommentTok{{-}{-} Bad}
\StringTok{"build{-}some"} \OperatorTok{*>}\NormalTok{ \textbackslash{}\_ }\OtherTok{{-}>} \KeywordTok{do}
...
\begin{Highlighting}[]
\CommentTok{{-}{-} Good}
\StringTok{"build{-}some"} \OperatorTok{\textasciitilde{}>} \KeywordTok{do}
\NormalTok{    need [}\StringTok{"out/report.pdf"}\NormalTok{,}\StringTok{"out/report.doc"}\NormalTok{]}
\NormalTok{    cmd }\StringTok{"fortune"}\NormalTok{ [}\StringTok{""}\NormalTok{]}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{want }\OperatorTok{$}\NormalTok{ (\textbackslash{}s f }\OtherTok{{-}>} \StringTok{"out/"} \OperatorTok{++}\NormalTok{ s }\OperatorTok{++} \StringTok{"."} \OperatorTok{++}\NormalTok{ f) }\OperatorTok{<$>}
\NormalTok{    [}\StringTok{"report1"}\NormalTok{,}\StringTok{"report2"}\NormalTok{,}\StringTok{"report3"}\NormalTok{] }\OperatorTok{<*>}\NormalTok{ [}\StringTok{"doc"}\NormalTok{,}\StringTok{"pdf"}\NormalTok{,}\StringTok{"html"}\NormalTok{]}

\NormalTok{forM\_ [}\StringTok{"report1"}\NormalTok{,}\StringTok{"report2"}\NormalTok{,}\StringTok{"report3"}\NormalTok{] }\OperatorTok{$}\NormalTok{ \textbackslash{}reportName }\OtherTok{{-}>} \KeywordTok{do}
    \KeywordTok{let}
...
\NormalTok{    outBase }\OperatorTok{++} \StringTok{".doc"} \OperatorTok{*>}\NormalTok{ \textbackslash{}f }\OtherTok{{-}>} \KeywordTok{do}
\NormalTok{        need }\OperatorTok{<$>}\NormalTok{ srcFiles}
\NormalTok{        cmd }\StringTok{"pandoc"}\NormalTok{ [ srcName, }\StringTok{"{-}o"}\NormalTok{, f ]}

\NormalTok{    outBase }\OperatorTok{++} \StringTok{".pdf"} \OperatorTok{*>}\NormalTok{ \textbackslash{}f }\OtherTok{{-}>} \KeywordTok{do}
\NormalTok{        need }\OperatorTok{<$>}\NormalTok{ srcFiles}
...
\NormalTok{    outBase }\OperatorTok{++} \StringTok{".html"} \OperatorTok{*>}\NormalTok{ \textbackslash{}f }\OtherTok{{-}>} \KeywordTok{do}
\NormalTok{        deps }\OtherTok{<{-}}\NormalTok{ srcFiles}
\NormalTok{        need }\OperatorTok{$} \StringTok{"css/report.css"} \OperatorTok{:}\NormalTok{ deps}
