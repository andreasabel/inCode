...
\NormalTok{testRegExp\_ }\OtherTok{=}\NormalTok{ void }\OperatorTok{$}\NormalTok{ (char }\CharTok{\textquotesingle{}a\textquotesingle{}} \OperatorTok{<|>}\NormalTok{ char }\CharTok{\textquotesingle{}b\textquotesingle{}}\NormalTok{)}
                  \OperatorTok{*>}\NormalTok{ many (string }\StringTok{"cd"}\NormalTok{)}
                  \OperatorTok{*>}\NormalTok{ char }\CharTok{\textquotesingle{}e\textquotesingle{}}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{testRegExp }\OtherTok{=}\NormalTok{ (char }\CharTok{\textquotesingle{}a\textquotesingle{}} \OperatorTok{<|>}\NormalTok{ char }\CharTok{\textquotesingle{}b\textquotesingle{}}\NormalTok{)}
          \OperatorTok{*>}\NormalTok{ (}\FunctionTok{length} \OperatorTok{<$>}\NormalTok{ many (string }\StringTok{"cd"}\NormalTok{))}
          \OperatorTok{<*}\NormalTok{ char }\CharTok{\textquotesingle{}e\textquotesingle{}}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{ghci}\OperatorTok{>}\NormalTok{ matchPrefix testRegexp\_ }\StringTok{"acdcdcde"}
\DataTypeTok{Just}\NormalTok{ ()}
\NormalTok{ghci}\OperatorTok{>}\NormalTok{ matchPrefix testRegexp\_ }\StringTok{"acdcdcdx"}
\DataTypeTok{Nothing}
\NormalTok{ghci}\OperatorTok{>}\NormalTok{ matchPrefix testRegexp }\StringTok{"acdcdcde"}
\DataTypeTok{Just} \DecValTok{3}
\NormalTok{ghci}\OperatorTok{>}\NormalTok{ matchPrefix testRegexp }\StringTok{"bcdcdcdcdcdcdcde"}
\DataTypeTok{Just} \DecValTok{7}
\NormalTok{ghci}\OperatorTok{>}\NormalTok{ matchPrefix digit }\StringTok{"9"}
\DataTypeTok{Just} \DecValTok{9}
\NormalTok{ghci}\OperatorTok{>}\NormalTok{ matchPrefix bracketDigit }\StringTok{"[2]"}
\DataTypeTok{Just} \DecValTok{2}
\NormalTok{ghci}\OperatorTok{>}\NormalTok{ matchPrefix (many bracketDigit) }\StringTok{"[2][3][4][5]"}
\DataTypeTok{Just}\NormalTok{ [}\DecValTok{2}\NormalTok{,}\DecValTok{3}\NormalTok{,}\DecValTok{4}\NormalTok{,}\DecValTok{5}\NormalTok{]}
\NormalTok{ghci}\OperatorTok{>}\NormalTok{ matchPrefix (}\FunctionTok{sum} \OperatorTok{<$>}\NormalTok{ many bracketDigit) }\StringTok{"[2][3][4][5]"}
...
\NormalTok{    d}\OperatorTok{:}\NormalTok{ds }\OperatorTok{|}\NormalTok{ c }\OperatorTok{==}\NormalTok{ d    }\OtherTok{{-}>}\NormalTok{ matchAlts ((}\OperatorTok{$}\NormalTok{ x) }\OperatorTok{<$>}\NormalTok{ next) ds}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{ghci}\OperatorTok{>}\NormalTok{ matchAlts testRegexp\_ }\StringTok{"acdcdcde"}
\DataTypeTok{Just}\NormalTok{ ()}
\NormalTok{ghci}\OperatorTok{>}\NormalTok{ matchAlts testRegexp\_ }\StringTok{"acdcdcdx"}
\DataTypeTok{Nothing}
\NormalTok{ghci}\OperatorTok{>}\NormalTok{ matchAlts testRegexp }\StringTok{"acdcdcde"}
\DataTypeTok{Just} \DecValTok{3}
\NormalTok{ghci}\OperatorTok{>}\NormalTok{ matchAlts testRegexp }\StringTok{"bcdcdcdcdcdcdcde"}
\DataTypeTok{Just} \DecValTok{7}
\NormalTok{ghci}\OperatorTok{>}\NormalTok{ matchAlts digit }\StringTok{"9"}
\DataTypeTok{Just} \DecValTok{9}
\NormalTok{ghci}\OperatorTok{>}\NormalTok{ matchAlts bracketDigit }\StringTok{"[2]"}
\DataTypeTok{Just} \DecValTok{2}
\NormalTok{ghci}\OperatorTok{>}\NormalTok{ matchAlts (many bracketDigit) }\StringTok{"[2][3][4][5]"}
\DataTypeTok{Just}\NormalTok{ [}\DecValTok{2}\NormalTok{,}\DecValTok{3}\NormalTok{,}\DecValTok{4}\NormalTok{,}\DecValTok{5}\NormalTok{]}
\NormalTok{ghci}\OperatorTok{>}\NormalTok{ matchAlts (}\FunctionTok{sum} \OperatorTok{<$>}\NormalTok{ many bracketDigit) }\StringTok{"[2][3][4][5]"}
\DataTypeTok{Just} \DecValTok{14}
\end{Highlighting}
\end{Shaded}
