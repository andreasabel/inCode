...
In fact, I'd actually argue that \texttt{OpaqueNet} is the real type you should
be offering to your users or using yourself, because it only exposes the types
...
easier type when writing the \emph{implementation}, \texttt{OpaqueNet} is a much
more ideal type to \emph{use}, in a lot of situations.
