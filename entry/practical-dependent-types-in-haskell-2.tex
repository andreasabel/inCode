...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{-- source: https://github.com/mstksg/inCode/tree/master/code-samples/dependent-haskell/NetworkTyped2.hs#L74-75}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{-- source: https://github.com/mstksg/inCode/tree/master/code-samples/dependent-haskell/NetworkTyped2.hs#L77-82}
...
singleton in, we'd have to do some work to recover the original \texttt{hs}.
...
\texttt{n\ ::\ Nat} in scope! We now have enough to write our
\texttt{randomONet}:

\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{-- source: https://github.com/mstksg/inCode/tree/master/code-samples/dependent-haskell/NetworkTyped2.hs#L100-104}
...
\CommentTok{-- main :: IO ()}
\CommentTok{-- main = do}
\CommentTok{--     putStrLn "What size random net?"}
\CommentTok{--     xs <- readLn}
\CommentTok{--     withSomeSing xs $ \textbackslash{}(ss :: Sing (hs :: [Nat])) -> do}
\CommentTok{--       net <- randomNet' ss :: IO (Network 10 hs 3)}
\CommentTok{--       print net}
