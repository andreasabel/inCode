...
\item
  ...
  constructors, so you can have \texttt{Maybe\ (OpaqueNet\ i\ o)}, but
  \emph{not} \texttt{Maybe\ (OpaqueNet\textquotesingle{}\ i\ o\ r)} or
  \texttt{Maybe\ ((forall\ hs.\ Network\ i\ hs\ o\ -\textgreater{}\ r)\ -\textgreater{}\ r)}.
...
their types --- is pretty straightforward, and its ease is one of the advantages
