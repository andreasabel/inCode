...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{ghci}\OperatorTok{>} \OperatorTok{:}\NormalTok{k }\DataTypeTok{Network}
\DataTypeTok{Network}\OtherTok{ ::} \DataTypeTok{Nat} \OtherTok{{-}>}\NormalTok{ [}\DataTypeTok{Nat}\NormalTok{] }\OtherTok{{-}>} \DataTypeTok{Nat} \OtherTok{{-}>} \OperatorTok{*}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{    net }\OtherTok{<{-} randomNet ::} \DataTypeTok{IO}\NormalTok{ (}\DataTypeTok{Network} \DecValTok{10} \OperatorTok{???} \DecValTok{3}\NormalTok{)   }\CommentTok{{-}{-} what is ???}
    \CommentTok{{-}{-} ...?}
\end{Highlighting}
\end{Shaded}
...
\KeywordTok{data} \DataTypeTok{OpaqueNet}\OtherTok{ ::} \DataTypeTok{Nat} \OtherTok{{-}>} \DataTypeTok{Nat} \OtherTok{{-}>} \OperatorTok{*} \KeywordTok{where}
...
\NormalTok{        \_ }\OperatorTok{:\&\textasciitilde{}}\NormalTok{ n\textquotesingle{} }\OtherTok{{-}>} \DecValTok{1} \OperatorTok{+}\NormalTok{ go n\textquotesingle{}}
\end{Highlighting}
\end{Shaded}
...
\KeywordTok{case}\NormalTok{ oN }\KeywordTok{of}
  \DataTypeTok{ONet}\NormalTok{ (}\OtherTok{n ::} \DataTypeTok{Network}\NormalTok{ i hs o) }\OtherTok{{-}>} \OperatorTok{...}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{map}\OtherTok{ ::} \KeywordTok{forall}\NormalTok{ a b}\OperatorTok{.}\NormalTok{ (a }\OtherTok{{-}>}\NormalTok{ b) }\OtherTok{{-}>}\NormalTok{ [a] }\OtherTok{{-}>}\NormalTok{ [b]}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\FunctionTok{map}\OtherTok{ ::}\NormalTok{ (}\DataTypeTok{Int} \OtherTok{{-}>} \DataTypeTok{Bool}\NormalTok{)    }\OtherTok{{-}>}\NormalTok{ [}\DataTypeTok{Int}\NormalTok{]    }\OtherTok{{-}>}\NormalTok{ [}\DataTypeTok{Bool}\NormalTok{]}
\FunctionTok{map}\OtherTok{ ::}\NormalTok{ (}\DataTypeTok{Double} \OtherTok{{-}>} \DataTypeTok{Void}\NormalTok{) }\OtherTok{{-}>}\NormalTok{ [}\DataTypeTok{Double}\NormalTok{] }\OtherTok{{-}>}\NormalTok{ [}\DataTypeTok{Void}\NormalTok{]}
\FunctionTok{map}\OtherTok{ ::}\NormalTok{ (}\DataTypeTok{String} \OtherTok{{-}>}\NormalTok{ (}\DataTypeTok{Bool} \OtherTok{{-}>} \DataTypeTok{Char}\NormalTok{)) }\OtherTok{{-}>}\NormalTok{ [}\DataTypeTok{String}\NormalTok{] }\OtherTok{{-}>}\NormalTok{ [}\DataTypeTok{Bool} \OtherTok{{-}>} \DataTypeTok{Char}\NormalTok{]}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{randomNet\textquotesingle{} }\OtherTok{=}\NormalTok{ \textbackslash{}}\KeywordTok{case}
    \DataTypeTok{SNil}            \OtherTok{{-}>}     \DataTypeTok{O} \OperatorTok{<$>}\NormalTok{ randomWeights}
    \DataTypeTok{SNat} \OtherTok{\textasciigrave{}SCons\textasciigrave{}}\NormalTok{ ss }\OtherTok{{-}>}\NormalTok{ (}\OperatorTok{:\&\textasciitilde{}}\NormalTok{) }\OperatorTok{<$>}\NormalTok{ randomWeights }\OperatorTok{<*>}\NormalTok{ randomNet\textquotesingle{} ss}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{data} \DataTypeTok{SomeSing}\OtherTok{ ::} \OperatorTok{*} \OtherTok{{-}>} \OperatorTok{*} \KeywordTok{where}
...
\NormalTok{randomONet hs }\OtherTok{=} \KeywordTok{case}\NormalTok{ toSing hs }\KeywordTok{of}
                  \DataTypeTok{SomeSing}\NormalTok{ ss }\OtherTok{{-}>} \DataTypeTok{ONet} \OperatorTok{<$>}\NormalTok{ randomNet\textquotesingle{} ss}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{main }\OtherTok{=} \KeywordTok{do}
    \FunctionTok{putStrLn} \StringTok{"What hidden layer structure do you want?"}
\NormalTok{    hs }\OtherTok{<{-}} \FunctionTok{readLn}
...
\KeywordTok{type} \DataTypeTok{OpaqueNet\textquotesingle{}}\NormalTok{ i o r }\OtherTok{=}\NormalTok{ (}\KeywordTok{forall}\NormalTok{ hs}\OperatorTok{.} \DataTypeTok{Network}\NormalTok{ i hs o }\OtherTok{{-}>}\NormalTok{ r) }\OtherTok{{-}>}\NormalTok{ r}
\end{Highlighting}
\end{Shaded}
...
\OtherTok{runOpaqueNet\textquotesingle{} ::}\NormalTok{ (}\DataTypeTok{KnownNat}\NormalTok{ i, }\DataTypeTok{KnownNat}\NormalTok{ o)}
              \OtherTok{=>} \DataTypeTok{OpaqueNet\textquotesingle{}}\NormalTok{ i o (}\DataTypeTok{R}\NormalTok{ o)}
              \OtherTok{{-}>} \DataTypeTok{R}\NormalTok{ i}
              \OtherTok{{-}>} \DataTypeTok{R}\NormalTok{ o}
\NormalTok{runOpaqueNet\textquotesingle{} oN x }\OtherTok{=}\NormalTok{ oN (\textbackslash{}n }\OtherTok{{-}>}\NormalTok{ runNet n x)}
\CommentTok{{-}{-}            :: ((forall hs. Network i hs o {-}> R o) {-}> R o)}
\CommentTok{{-}{-}            {-}> R i}
\CommentTok{{-}{-}            {-}> R o}

\OtherTok{numHiddens\textquotesingle{} ::} \DataTypeTok{OpaqueNet\textquotesingle{}}\NormalTok{ i o }\DataTypeTok{Int} \OtherTok{{-}>} \DataTypeTok{Int}
...
\OtherTok{oNet\textquotesingle{} ::} \DataTypeTok{Network}\NormalTok{ i hs o }\OtherTok{{-}>} \DataTypeTok{OpaqueNet\textquotesingle{}}\NormalTok{ i o r}
\NormalTok{oNet\textquotesingle{} n }\OtherTok{=}\NormalTok{ \textbackslash{}f }\OtherTok{{-}>}\NormalTok{ f n}
\end{Highlighting}
\end{Shaded}
...
\OtherTok{withRandomONet\textquotesingle{} ::}\NormalTok{ (}\DataTypeTok{MonadRandom}\NormalTok{ m, }\DataTypeTok{KnownNat}\NormalTok{ i, }\DataTypeTok{KnownNat}\NormalTok{ o)}
                \OtherTok{=>}\NormalTok{ [}\DataTypeTok{Integer}\NormalTok{]}
                \OtherTok{{-}>}\NormalTok{ (}\KeywordTok{forall}\NormalTok{ hs}\OperatorTok{.} \DataTypeTok{Network}\NormalTok{ i hs o }\OtherTok{{-}>}\NormalTok{ m r)}
                \OtherTok{{-}>}\NormalTok{ m r}
\CommentTok{{-}{-}         aka, => [Integer]}
\CommentTok{{-}{-}              {-}> OpaqueNet\textquotesingle{} i o (m r)}
...
\NormalTok{                           net }\OtherTok{<{-}}\NormalTok{ randomNet\textquotesingle{} ss}
\NormalTok{                           f net}
\end{Highlighting}
\end{Shaded}
...
\OtherTok{withSomeSing ::}\NormalTok{ [}\DataTypeTok{Integer}\NormalTok{]}
             \OtherTok{{-}>}\NormalTok{ (}\KeywordTok{forall}\NormalTok{ (}\OtherTok{hs ::}\NormalTok{ [}\DataTypeTok{Nat}\NormalTok{])}\OperatorTok{.} \DataTypeTok{Sing}\NormalTok{ hs }\OtherTok{{-}>}\NormalTok{ r)}
...
\CommentTok{{-}{-}         aka, => [Integer]}
\CommentTok{{-}{-}              {-}> OpaqueNet\textquotesingle{} i o (m r)}
\NormalTok{withRandomONet\textquotesingle{} hs f }\OtherTok{=}\NormalTok{ withSomeSing hs }\OperatorTok{$}\NormalTok{ \textbackslash{}ss }\OtherTok{{-}>} \KeywordTok{do}
\NormalTok{                         net }\OtherTok{<{-}}\NormalTok{ randomNet\textquotesingle{} ss}
\NormalTok{                         f net}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{main\textquotesingle{} }\OtherTok{=} \KeywordTok{do}
    \FunctionTok{putStrLn} \StringTok{"What hidden layer structure do you want?"}
\NormalTok{    hs }\OtherTok{<{-}} \FunctionTok{readLn}
\NormalTok{    withRandomONet\textquotesingle{} hs }\OperatorTok{$}\NormalTok{ \textbackslash{}(}\OtherTok{net ::} \DataTypeTok{Network} \DecValTok{10}\NormalTok{ hs }\DecValTok{3}\NormalTok{) }\OtherTok{{-}>} \KeywordTok{do}
      \FunctionTok{print}\NormalTok{ net}
      \CommentTok{{-}{-} blah blah stuff with our dynamically generated net}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{foo }\OtherTok{=}\NormalTok{ withSomeSing x }\OperatorTok{$}\NormalTok{ \textbackslash{}sx }\OtherTok{{-}>}
\NormalTok{      withSomeSing y }\OperatorTok{$}\NormalTok{ \textbackslash{}sy }\OtherTok{{-}>}
\NormalTok{      withSomeSing z }\OperatorTok{$}\NormalTok{ \textbackslash{}sz }\OtherTok{{-}>}
        \CommentTok{{-}{-} ...}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{main }\OtherTok{=}\NormalTok{ withRandomONet\textquotesingle{} [}\DecValTok{7}\NormalTok{,}\DecValTok{5}\NormalTok{,}\DecValTok{3}\NormalTok{] }\OperatorTok{$}\NormalTok{ \textbackslash{}n1 }\OtherTok{{-}>}
\NormalTok{       withRandomONet\textquotesingle{} [}\DecValTok{5}\NormalTok{,}\DecValTok{5}\NormalTok{,}\DecValTok{5}\NormalTok{] }\OperatorTok{$}\NormalTok{ \textbackslash{}n2 }\OtherTok{{-}>}
\NormalTok{       withRandomONet\textquotesingle{} [}\DecValTok{5}\NormalTok{,}\DecValTok{4}\NormalTok{,}\DecValTok{3}\NormalTok{] }\OperatorTok{$}\NormalTok{ \textbackslash{}n3 }\OtherTok{{-}>} \KeywordTok{do}
\NormalTok{         hs }\OtherTok{<{-}} \FunctionTok{readLn}
\NormalTok{         withRandomONet\textquotesingle{} hs }\OperatorTok{$}\NormalTok{ \textbackslash{}(}\OtherTok{n4 ::} \DataTypeTok{Network} \DecValTok{10}\NormalTok{ hs }\DecValTok{1}\NormalTok{) }\OtherTok{{-}>} \KeywordTok{do}
           \CommentTok{{-}{-} ...}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{foo }\OtherTok{=}\NormalTok{ runIdentity }\OperatorTok{$} \KeywordTok{do}
        \DataTypeTok{SomeSing}\NormalTok{ sx }\OtherTok{<{-}} \DataTypeTok{Identity} \OperatorTok{$}\NormalTok{ toSing x}
        \DataTypeTok{SomeSing}\NormalTok{ sy }\OtherTok{<{-}} \DataTypeTok{Identity} \OperatorTok{$}\NormalTok{ toSing y}
        \DataTypeTok{SomeSing}\NormalTok{ sz }\OtherTok{<{-}} \DataTypeTok{Identity} \OperatorTok{$}\NormalTok{ toSing z}
...
\begin{Shaded}
\begin{Highlighting}[]
\OtherTok{numHiddens\textquotesingle{} ::}\NormalTok{ ((}\KeywordTok{forall}\NormalTok{ hs}\OperatorTok{.} \DataTypeTok{Network}\NormalTok{ i hs o }\OtherTok{{-}>} \DataTypeTok{Int}\NormalTok{) }\OtherTok{{-}>} \DataTypeTok{Int}\NormalTok{)}
...
\NormalTok{    w }\OperatorTok{:\&\textasciitilde{}}\NormalTok{ n }\OtherTok{{-}>}\NormalTok{ put w }\OperatorTok{*>}\NormalTok{ putNet n}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{getNet }\OtherTok{=}\NormalTok{ \textbackslash{}}\KeywordTok{case}
    \DataTypeTok{SNil}            \OtherTok{{-}>}     \DataTypeTok{O} \OperatorTok{<$>}\NormalTok{ get}
    \DataTypeTok{SNat} \OtherTok{\textasciigrave{}SCons\textasciigrave{}}\NormalTok{ ss }\OtherTok{{-}>}\NormalTok{ (}\OperatorTok{:\&\textasciitilde{}}\NormalTok{) }\OperatorTok{<$>}\NormalTok{ get }\OperatorTok{<*>}\NormalTok{ getNet ss}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{    \_ }\OperatorTok{:\&\textasciitilde{}}\NormalTok{ (}\OtherTok{n\textquotesingle{} ::} \DataTypeTok{Network}\NormalTok{ h hs\textquotesingle{} o)}
           \OtherTok{{-}>}\NormalTok{ natVal (}\DataTypeTok{Proxy} \OperatorTok{@}\NormalTok{h)}
...
\NormalTok{    withSomeSing hs }\OperatorTok{$}\NormalTok{ \textbackslash{}ss }\OtherTok{{-}>}
      \DataTypeTok{ONet} \OperatorTok{<$>}\NormalTok{ getNet ss}
\end{Highlighting}
\end{Shaded}
