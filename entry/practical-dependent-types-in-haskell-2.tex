...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{-- source: https://github.com/mstksg/inCode/tree/master/code-samples/dependent-haskell/NetworkTyped2.hs#L176-179}
\KeywordTok{data} \DataTypeTok{SomeNet}\OtherTok{ ::} \FunctionTok{*} \KeywordTok{where}
