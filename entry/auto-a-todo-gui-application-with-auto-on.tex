...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{allIds }\OtherTok{<{-}}\NormalTok{ arr IM.keys }\OperatorTok{{-}<}\NormalTok{ taskMap}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{    onId n   te }\OtherTok{=}\NormalTok{ (}\OtherTok{\textasciigrave{}ITask\textasciigrave{}}\NormalTok{ te) }\OperatorTok{<$>}\NormalTok{ readMaybe n}
...
\NormalTok{                          toOn}
                        ...
                        \OperatorTok{.}\NormalTok{ fromBlips }\StringTok{"Bad command!"}
                          \CommentTok{{-}{-} run \textasciigrave{}formatTodo <$> todoApp\textasciigrave{} on emitted commands}
                        \OperatorTok{.}\NormalTok{ perBlip (formatTodo }\OperatorTok{<$>}\NormalTok{ todoApp)}
