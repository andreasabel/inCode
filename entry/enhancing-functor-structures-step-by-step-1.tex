...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{{-}{-} source: https://github.com/mstksg/inCode/tree/master/code{-}samples/functor{-}structures/serialize.hs\#L87{-}L102}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{{-}{-} source: https://github.com/mstksg/inCode/tree/master/code{-}samples/functor{-}structures/serialize.hs\#L143{-}L147}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{{-}{-} source: https://github.com/mstksg/inCode/tree/master/code{-}samples/functor{-}structures/serialize.hs\#L149{-}L151}
...
With these we could write \texttt{choiceToValue} as simply
\texttt{Choice\ a\ -\textgreater{}\ a\ -\textgreater{}\ Aeson.Value} and
\texttt{fieldToValue} as simply
\texttt{Field\ a\ -\textgreater{}\ a\ -\textgreater{}\ Aeson.Pair}, and then use
\texttt{iapply\ choiceToValue\ cs} and \texttt{ifanout\ fieldToValue\ fs}
instead of \texttt{getOp\ (interpret\ choiceToValue\ cs)} and
\texttt{getOp\ (interpret\ fieldToValie\ fs)}.
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{{-}{-} source: https://github.com/mstksg/inCode/tree/master/code{-}samples/functor{-}structures/serialize.hs\#L104{-}L131}
