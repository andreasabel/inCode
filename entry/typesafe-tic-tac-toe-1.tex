...
\NormalTok{printBoard }\FunctionTok{=}\NormalTok{ mapM_ }\FunctionTok{$}\NormalTok{ putStrLn }\FunctionTok{.}\NormalTok{ intercalate }\StringTok{"|"} \FunctionTok{.}\NormalTok{ map showPiece}
  \KeywordTok{where}
\NormalTok{    showPiece }\DataTypeTok{Nothing}   \FunctionTok{=} \StringTok{"   "}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{-- source: https://github.com/mstksg/inCode/tree/master/code-samples/ttt/Part1.hs#L223-L247}
