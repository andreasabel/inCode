...
than types you might encounter in everyday Haskell programming.
...
Essentially, we keep track of ``provably false'' because we can use it later to
build other useful decision functions and proving functions.
