...
\NormalTok{selFound_znil}
\OtherTok{    ::} \DataTypeTok{Decision}\NormalTok{ (}\DataTypeTok{SelFound}\NormalTok{ '}\DataTypeTok{Z} \FunctionTok{@@}\NormalTok{ '[])}
\NormalTok{selFound_znil }\FunctionTok{=} \DataTypeTok{Disproved}\NormalTok{ \textbackslash{}(_ }\FunctionTok{:&:}\NormalTok{ s) }\OtherTok{->}\NormalTok{ noEmptySel s}
\end{Highlighting}
\end{Shaded}
...
\OtherTok{    ::} \DataTypeTok{Sing}\NormalTok{ n}
    \OtherTok{->} \DataTypeTok{Decision}\NormalTok{ (}\DataTypeTok{SelFound}\NormalTok{ ('}\DataTypeTok{S}\NormalTok{ n) }\FunctionTok{@@}\NormalTok{ '[])}
\NormalTok{selFound_snil _ }\FunctionTok{=} \DataTypeTok{Disproved}\NormalTok{ \textbackslash{}(_ }\FunctionTok{:&:}\NormalTok{ s) }\OtherTok{->}\NormalTok{ noEmptySel s}
\end{Highlighting}
\end{Shaded}
\item
