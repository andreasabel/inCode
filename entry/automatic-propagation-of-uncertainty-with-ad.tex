...
\NormalTok{    []   }\OperatorTok{:}\NormalTok{yss }\OtherTok{{-}>}\NormalTok{ diag (}\FunctionTok{drop} \DecValTok{1} \OperatorTok{<$>}\NormalTok{ yss)}
\NormalTok{    (x}\OperatorTok{:}\NormalTok{\_)}\OperatorTok{:}\NormalTok{yss }\OtherTok{{-}>}\NormalTok{ x }\OperatorTok{:}\NormalTok{ diag (}\FunctionTok{drop} \DecValTok{1} \OperatorTok{<$>}\NormalTok{ yss)}
\end{Highlighting}
\end{Shaded}
...
\OtherTok{liftUF ::}\NormalTok{ (}\DataTypeTok{Traversable}\NormalTok{ f, }\DataTypeTok{Fractional}\NormalTok{ a)}
       \OtherTok{=>}\NormalTok{ (}\KeywordTok{forall}\NormalTok{ s}\OperatorTok{.}\NormalTok{ f (}\DataTypeTok{AD}\NormalTok{ s (}\DataTypeTok{Sparse}\NormalTok{ a)) }\OtherTok{{-}>} \DataTypeTok{AD}\NormalTok{ s (}\DataTypeTok{Sparse}\NormalTok{ a))}
       \OtherTok{{-}>}\NormalTok{ f (}\DataTypeTok{Uncert}\NormalTok{ a)}
       \OtherTok{{-}>} \DataTypeTok{Uncert}\NormalTok{ a}
\NormalTok{liftUF f us }\OtherTok{=} \DataTypeTok{Un}\NormalTok{ y vy}
  \KeywordTok{where}
\NormalTok{    xs          }\OtherTok{=}\NormalTok{         uMean }\OperatorTok{<$>}\NormalTok{ us}
\NormalTok{    vxs         }\OtherTok{=}\NormalTok{ toList (uVar  }\OperatorTok{<$>}\NormalTok{ us)}
\NormalTok{    (fx, hgrad) }\OtherTok{=}\NormalTok{ hessian\textquotesingle{} f xs}
\NormalTok{    dfxs        }\OtherTok{=} \FunctionTok{fst} \OperatorTok{<$>}\NormalTok{ hgrad}
\NormalTok{    hess        }\OtherTok{=} \FunctionTok{snd} \OperatorTok{<$>}\NormalTok{ hgrad}
...
\NormalTok{    vy          }\OtherTok{=}\NormalTok{ dot vxs}
                \OperatorTok{$}\NormalTok{ toList ((}\OperatorTok{\^{}}\DecValTok{2}\NormalTok{) }\OperatorTok{<$>}\NormalTok{ dfxs)}
\end{Highlighting}
\end{Shaded}
