...
\FloatTok{1.4} \FunctionTok{+/-} \FloatTok{0.1}
\NormalTok{ghci}\FunctionTok{>} \NormalTok{sin(x) }\FunctionTok{/} \NormalTok{y}
\FunctionTok{-}\FloatTok{0.2} \FunctionTok{+/-} \FloatTok{0.1}
\end{Highlighting}
\end{Shaded}
