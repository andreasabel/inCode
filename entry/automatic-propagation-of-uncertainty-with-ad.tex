...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{-- source: https://github.com/mstksg/inCode/tree/master/code-samples/uncertain/Uncertain.hs#L3-5}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{-- source: https://github.com/mstksg/inCode/tree/master/code-samples/uncertain/Uncertain.hs#L7-8}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{-- source: https://github.com/mstksg/inCode/tree/master/code-samples/uncertain/Uncertain.hs#L10-11}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{-- source: https://github.com/mstksg/inCode/tree/master/code-samples/uncertain/Uncertain.hs#L13-16}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{-- source: https://github.com/mstksg/inCode/tree/master/code-samples/uncertain/Uncertain.hs#L18-27}
\NormalTok{liftU}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{-- source: https://github.com/mstksg/inCode/tree/master/code-samples/uncertain/Uncertain.hs#L29-35}
\OtherTok{diag ::} \NormalTok{[[a]] }\OtherTok{->} \NormalTok{[a]}
\NormalTok{diag }\FunctionTok{=} \NormalTok{\textbackslash{}}\KeywordTok{case} \NormalTok{[]        }\OtherTok{->} \NormalTok{[]}
             \NormalTok{[]   }\FunctionTok{:}\NormalTok{yss }\OtherTok{->} \NormalTok{diag (drop1 }\FunctionTok{<$>} \NormalTok{yss)}
             \NormalTok{(x}\FunctionTok{:}\NormalTok{_)}\FunctionTok{:}\NormalTok{yss }\OtherTok{->} \NormalTok{x }\FunctionTok{:} \NormalTok{diag (drop1 }\FunctionTok{<$>} \NormalTok{yss)}
  \KeywordTok{where}
    \NormalTok{drop1 []     }\FunctionTok{=} \NormalTok{[]}
    \NormalTok{drop1 (_}\FunctionTok{:}\NormalTok{zs) }\FunctionTok{=} \NormalTok{zs}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{-- source: https://github.com/mstksg/inCode/tree/master/code-samples/uncertain/Uncertain.hs#L37-38}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{-- source: https://github.com/mstksg/inCode/tree/master/code-samples/uncertain/Uncertain.hs#L40-56}
\NormalTok{liftUF}
\OtherTok{    ::} \NormalTok{(}\DataTypeTok{Traversable} \NormalTok{f, }\DataTypeTok{Fractional} \NormalTok{a)}
...
\NormalTok{liftUF f us }\FunctionTok{=} \DataTypeTok{Un} \NormalTok{y vy}
  \KeywordTok{where}
    ...
    \NormalTok{vxs         }\FunctionTok{=} \NormalTok{uVar  }\FunctionTok{<$>} \NormalTok{us}
    ...
    \NormalTok{y           }\FunctionTok{=} \NormalTok{fx }\FunctionTok{+} \NormalTok{partials }\FunctionTok{/} \DecValTok{2}
      \KeywordTok{where}
        \NormalTok{partials }\FunctionTok{=} \NormalTok{dot vxs }\FunctionTok{.} \NormalTok{diag}
                 \FunctionTok{$} \NormalTok{toList (fmap toList hess))}
    \NormalTok{vy          }\FunctionTok{=} \NormalTok{vxs }\OtherTok{`dot`} \NormalTok{((}\FunctionTok{^}\DecValTok{2}\NormalTok{) }\FunctionTok{<$>} \NormalTok{dfxs)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{-- source: https://github.com/mstksg/inCode/tree/master/code-samples/uncertain/Uncertain.hs#L58-73}
\NormalTok{liftU2}
\OtherTok{    ::} \DataTypeTok{Fractional} \NormalTok{a}
