...
(\texttt{NatList} here), and getting the singleton skeleton from
``folding up'' using a typeclass (\texttt{KnownNats}, here).
...
The \texttt{KnownNat\ n} is used by the \texttt{KnownNats\ ns} instance.
Then \texttt{natList} uses the \texttt{KnownNat\ n} to construct the
