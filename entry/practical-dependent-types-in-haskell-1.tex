...
neural network}} implementation with back-propagation.
...
run-time than an \texttt{{[}Integer{]}}, and \texttt{KnownNats\ =\textgreater{}}
is no different than \texttt{{[}Integer{]}\ -\textgreater{}}.
...
\emph{most} potential implementations (though not all, yet).
