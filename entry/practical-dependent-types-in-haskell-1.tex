...
library\footnote{\href{https://www.reddit.com/r/haskell/comments/4l199z/practical_dependent_types_in_haskell_type_safe/d3jkslv}{Why
  don't we use the canonical \emph{singletons} library?}} offers a handy
singleton for just this job. If you have a type level list of nats, you get a
\texttt{KnownNats\ ns} constraint. This lets you create a \texttt{NatList}:
