...
\NormalTok{randomNet i []     o }\OtherTok{=}     \DataTypeTok{O} \OperatorTok{<$>}\NormalTok{ randomWeights i o}
\NormalTok{randomNet i (h}\OperatorTok{:}\NormalTok{hs) o }\OtherTok{=}\NormalTok{ (}\OperatorTok{:\&\textasciitilde{}}\NormalTok{) }\OperatorTok{<$>}\NormalTok{ randomWeights i h }\OperatorTok{<*>}\NormalTok{ randomNet h hs o}
\end{Highlighting}
\end{Shaded}
...
\OtherTok{    go ::} \KeywordTok{forall}\NormalTok{ h hs\textquotesingle{}}\OperatorTok{.} \DataTypeTok{KnownNat}\NormalTok{ h}
       \OtherTok{=>} \DataTypeTok{Sing}\NormalTok{ hs\textquotesingle{}}
       \OtherTok{{-}>}\NormalTok{ m (}\DataTypeTok{Network}\NormalTok{ h hs\textquotesingle{} o)}
\NormalTok{    go }\OtherTok{=}\NormalTok{ \textbackslash{}}\KeywordTok{case}
        ...
        \DataTypeTok{SNat} \OtherTok{\textasciigrave{}SCons\textasciigrave{}}\NormalTok{ ss }\OtherTok{{-}>}\NormalTok{ (}\OperatorTok{:\&\textasciitilde{}}\NormalTok{) }\OperatorTok{<$>}\NormalTok{ randomWeights }\OperatorTok{<*>}\NormalTok{ go ss}
\end{Highlighting}
\end{Shaded}
