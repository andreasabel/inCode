...
x\_i{]}(https://latex.codecogs.com/gif.latex?\%0Ay\_j\%20\%3D\%20b\_j\%20\%2B\%20\%5Csum\_i\%5Em\%20w\_\%7Bij\%7D\%20x\_i\%0A
...
\textbackslash{}mathbf\{x\}{]}(https://latex.codecogs.com/gif.latex?\%0A\%5Cmathbf\%7By\%7D\%20\%3D\%20\%5Cmathbf\%7Bb\%7D\%20\%2B\%20W\%20\%5Cmathbf\%7Bx\%7D\%0A
" \mathbf{y} = \mathbf{b} + W \mathbf{x} ``)

The result, the \includegraphics{https://latex.codecogs.com/gif.latex?n}-vector
of nodes
\includegraphics{https://latex.codecogs.com/gif.latex?\%5Cmathbf\%7By\%7D}, is
computed from the
\includegraphics{https://latex.codecogs.com/gif.latex?n}-vector of biases
\includegraphics{https://latex.codecogs.com/gif.latex?\%5Cmathbf\%7Bb\%7D} and
the \includegraphics{https://latex.codecogs.com/gif.latex?n\%20\%5Ctimes\%20m}
weight matrix \includegraphics{https://latex.codecogs.com/gif.latex?W}
multiplied with the
\includegraphics{https://latex.codecogs.com/gif.latex?m}-vector input,
\includegraphics{https://latex.codecogs.com/gif.latex?\%5Cmathbf\%7Bx\%7D}.
...
\includegraphics{https://latex.codecogs.com/gif.latex?f\%28x\%29\%20\%3D\%201\%20\%2F\%20\%281\%20\%2B\%20e\%5E\%7B-x\%7D\%29}.
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{-- source: https://github.com/mstksg/inCode/tree/master/code-samples/dependent-haskell/NetworkTyped.hs#L25-31}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{-- source: https://github.com/mstksg/inCode/tree/master/code-samples/dependent-haskell/NetworkTyped.hs#L65-72}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{-- source: https://github.com/mstksg/inCode/tree/master/code-samples/dependent-haskell/NetworkTyped.hs#L74-83}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{-- source: https://github.com/mstksg/inCode/tree/master/code-samples/dependent-haskell/NetworkTyped.hs#L41-51}
...
\OtherTok{runNet ::}\NormalTok{ (}\DataTypeTok{KnownNat}\NormalTok{ i, }\DataTypeTok{SingI}\NormalTok{ hs, }\DataTypeTok{KnownNat}\NormalTok{ o)}
       \OtherTok{=>} \DataTypeTok{Network}\NormalTok{ i hs o}
       \OtherTok{->} \DataTypeTok{R}\NormalTok{ i}
       \OtherTok{->} \DataTypeTok{R}\NormalTok{ o}
\NormalTok{runNet }\FunctionTok{=}\NormalTok{ runNet' sing}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{-- source: https://github.com/mstksg/inCode/tree/master/code-samples/dependent-haskell/NetworkTyped.hs#L85-91}
\OtherTok{train ::}\NormalTok{ forall i hs o}\FunctionTok{.}\NormalTok{ (}\DataTypeTok{KnownNat}\NormalTok{ i, }\DataTypeTok{SingI}\NormalTok{ hs, }\DataTypeTok{KnownNat}\NormalTok{ o)}
      ...
      \OtherTok{->} \DataTypeTok{Network}\NormalTok{ i hs o}
\NormalTok{train rate x0 target }\FunctionTok{=}\NormalTok{ train' rate x0 target sing}
\end{Highlighting}
\end{Shaded}
...
\href{https://github.com/mstksg/inCode/tree/master/code-samples/dependent-haskell/NetworkTyped.hs\#L201-209}{\texttt{main}}
...
\item
  ...
  \href{https://github.com/mstksg/inCode/tree/master/code-samples/dependent-haskell/NetworkTyped.hs\#L217-218}{``pops''
...
\item
  Write a
  \href{https://github.com/mstksg/inCode/tree/master/code-samples/dependent-haskell/NetworkTyped.hs\#L220-237}{function
...
\item
  ...
  \href{https://github.com/mstksg/inCode/tree/master/code-samples/dependent-haskell/NetworkTyped.hs\#L239-242}{returns
