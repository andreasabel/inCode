...
``the last item'':\footnote{Fun haskell challenge: the version of \texttt{match}
  ...
  \href{https://github.com/mstksg/inCode/tree/master/code-samples/misc/lenses-and-prisms.hs\#L16-L24}{using
  a difference list}!}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{-- source: https://github.com/mstksg/inCode/tree/master/code-samples/misc/lenses-and-prisms.hs#L28-L54}
...
\end{Shaded}
  ...
  \href{https://github.com/mstksg/inCode/tree/master/code-samples/misc/lenses-and-prisms.hs\#L28-L66}{online
