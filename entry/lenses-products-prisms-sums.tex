...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{-- source: https://github.com/mstksg/inCode/tree/master/code-samples/misc/lenses-and-prisms.hs#L132-L135}
...
\item
  ...
  they mean? (what are \texttt{view}, \texttt{set} for those lenses?)
