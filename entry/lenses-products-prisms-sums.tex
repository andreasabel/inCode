...
\begin{Highlighting}[]
\CommentTok{-- [a] <~> Either () ([a], a)}
\CommentTok{-- source: https://github.com/mstksg/inCode/tree/master/code-samples/misc/lenses-and-prisms.hs#L249-L267}
...
\end{Shaded}
  ...
  \tightlist
  \item
    ``Construct'' an \texttt{{[}a{]}} given an original list \texttt{{[}a{]}}
    and an item to add to the end, \texttt{a}
  \item
