...
``the last item'':\footnote{Fun haskell challenge: the version of \texttt{match}
  ...
  \href{https://github.com/mstksg/inCode/tree/master/code-samples/misc/lenses-and-prisms.hs\#L15-L22}{using
  a difference list}!}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{-- source: https://github.com/mstksg/inCode/tree/master/code-samples/misc/lenses-and-prisms.hs#L26-L52}
...
\end{Shaded}
  ...
  \href{https://github.com/mstksg/inCode/tree/master/code-samples/misc/lenses-and-prisms.hs\#L26-L64}{online
