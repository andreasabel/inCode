...
\begin{Highlighting}[]
\CommentTok{-- | s <~> (a, q)}
\CommentTok{-- source: https://github.com/mstksg/inCode/tree/master/code-samples/misc/lenses-and-prisms.hs#L35-L38}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{-- source: https://github.com/mstksg/inCode/tree/master/code-samples/misc/lenses-and-prisms.hs#L77-L82}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{-- source: https://github.com/mstksg/inCode/tree/master/code-samples/misc/lenses-and-prisms.hs#L84-L85}
...
\CommentTok{-- source: https://github.com/mstksg/inCode/tree/master/code-samples/misc/lenses-and-prisms.hs#L101-L103}
...
\begin{Highlighting}[]
\CommentTok{-- a <~> (a, ())}
\CommentTok{-- source: https://github.com/mstksg/inCode/tree/master/code-samples/misc/lenses-and-prisms.hs#L117-L127}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{-- source: https://github.com/mstksg/inCode/tree/master/code-samples/misc/lenses-and-prisms.hs#L129-L139}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{-- source: https://github.com/mstksg/inCode/tree/master/code-samples/misc/lenses-and-prisms.hs#L149-L153}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{-- source: https://github.com/mstksg/inCode/tree/master/code-samples/misc/lenses-and-prisms.hs#L155-L159}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{-- source: https://github.com/mstksg/inCode/tree/master/code-samples/misc/lenses-and-prisms.hs#L163-L164}
...
``the last item'':\footnote{Fun haskell challenge: the version of \texttt{match}
  ...
  \href{https://github.com/mstksg/inCode/tree/master/code-samples/misc/lenses-and-prisms.hs\#L23-L31}{using
  a difference list}!}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{-- source: https://github.com/mstksg/inCode/tree/master/code-samples/misc/lenses-and-prisms.hs#L166-L171}
...
\CommentTok{-- source: https://github.com/mstksg/inCode/tree/master/code-samples/misc/lenses-and-prisms.hs#L250-L250}
...
\CommentTok{-- source: https://github.com/mstksg/inCode/tree/master/code-samples/misc/lenses-and-prisms.hs#L54-L57}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{-- source: https://github.com/mstksg/inCode/tree/master/code-samples/misc/lenses-and-prisms.hs#L87-L90}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{-- source: https://github.com/mstksg/inCode/tree/master/code-samples/misc/lenses-and-prisms.hs#L84-L96}
...
\CommentTok{-- source: https://github.com/mstksg/inCode/tree/master/code-samples/misc/lenses-and-prisms.hs#L173-L191}
...
\begin{Highlighting}[]
\CommentTok{-- [a] <~> Either () (NonEmpty a)}
\CommentTok{-- source: https://github.com/mstksg/inCode/tree/master/code-samples/misc/lenses-and-prisms.hs#L193-L211}
...
\begin{Highlighting}[]
\CommentTok{-- [a] <~> Either () ([a], a)}
\CommentTok{-- source: https://github.com/mstksg/inCode/tree/master/code-samples/misc/lenses-and-prisms.hs#L213-L231}
...
\begin{Highlighting}[]
\CommentTok{-- a <~> Either a Void}
\CommentTok{-- source: https://github.com/mstksg/inCode/tree/master/code-samples/misc/lenses-and-prisms.hs#L233-L248}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{-- source: https://github.com/mstksg/inCode/tree/master/code-samples/misc/lenses-and-prisms.hs#L252-L270}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{-- source: https://github.com/mstksg/inCode/tree/master/code-samples/misc/lenses-and-prisms.hs#L272-L276}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{-- source: https://github.com/mstksg/inCode/tree/master/code-samples/misc/lenses-and-prisms.hs#L278-L282}
...
\item
  ...
  restricted interface. For example, the
...
\OtherTok{match ::} \DataTypeTok{Char} \OtherTok{->} \DataTypeTok{Either}\NormalTok{ () }\DataTypeTok{CharButNotA}
\NormalTok{match }\CharTok{'a'} \FunctionTok{=} \DataTypeTok{Left}\NormalTok{ ()}
\NormalTok{match x   }\FunctionTok{=} \DataTypeTok{Right}\NormalTok{ x}

\OtherTok{inject ::} \DataTypeTok{Either}\NormalTok{ () }\DataTypeTok{CharButNotA} \OtherTok{->} \DataTypeTok{Char}
\NormalTok{inject (}\DataTypeTok{Left}\NormalTok{  _) }\FunctionTok{=} \CharTok{'a'}
\NormalTok{inject (}\DataTypeTok{Right}\NormalTok{ x) }\FunctionTok{=}\NormalTok{ x}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\OtherTok{split ::} \DataTypeTok{S.Set} \DataTypeTok{Char} \OtherTok{->}\NormalTok{ (}\DataTypeTok{Bool}\NormalTok{, }\DataTypeTok{S.Set} \DataTypeTok{CharButNotA}\NormalTok{)}
\NormalTok{split s }\FunctionTok{=}\NormalTok{ (}\CharTok{'a'} \OtherTok{`S.member`}\NormalTok{ s, S.delete }\CharTok{'a'}\NormalTok{ s)}

\OtherTok{unsplit ::}\NormalTok{ (}\DataTypeTok{Bool}\NormalTok{, }\DataTypeTok{S.Set} \DataTypeTok{CharButNotA}\NormalTok{) }\OtherTok{->} \DataTypeTok{S.Set} \DataTypeTok{Char}
\NormalTok{unsplit (}\DataTypeTok{False}\NormalTok{, s) }\FunctionTok{=}\NormalTok{ s}
\NormalTok{unsplit (}\DataTypeTok{True}\NormalTok{ , s) }\FunctionTok{=}\NormalTok{ S.insert a s}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{-- source: https://github.com/mstksg/inCode/tree/master/code-samples/misc/lenses-and-prisms.hs#L35-L61}
...
\end{Shaded}
  ...
  \href{https://github.com/mstksg/inCode/tree/master/code-samples/misc/lenses-and-prisms.hs\#L35-L73}{online
