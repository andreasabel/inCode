...
\end{Shaded}
  ...
  In fact, in the library, \texttt{binterpret} and \texttt{pureT} are actually
  defined \emph{in terms of} \texttt{SF} and \texttt{MF}, respectively.}
...
\OtherTok{    ::} \DataTypeTok{Monoidal}\NormalTok{ t}
    \OtherTok{=>}\NormalTok{ t (}\DataTypeTok{Chain}\NormalTok{ t (}\DataTypeTok{I}\NormalTok{ t) f) (}\DataTypeTok{Chain}\NormalTok{ t (}\DataTypeTok{I}\NormalTok{ t) f) }\OperatorTok{\textasciitilde{}>} \DataTypeTok{Chain}\NormalTok{ t (}\DataTypeTok{I}\NormalTok{ t) f}

\NormalTok{appendChain1}
\OtherTok{    ::} \DataTypeTok{Semigroupoidal}\NormalTok{ t}
...
\end{Shaded}
  ...
  semigroupoidal/monoidal nature of \texttt{t}.
