...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{ghci}\OperatorTok{>}\NormalTok{ ((}\OperatorTok{<} \DecValTok{20}\NormalTok{) }\OperatorTok{.}\NormalTok{ (}\OperatorTok{+}\DecValTok{4}\NormalTok{)) }\OperatorTok{.}\NormalTok{ (}\OperatorTok{\^{}}\DecValTok{2}\NormalTok{) }\OperatorTok{$} \DecValTok{4}
\DataTypeTok{True}
\NormalTok{ghci}\OperatorTok{>}\NormalTok{ (}\OperatorTok{<} \DecValTok{20}\NormalTok{) }\OperatorTok{.}\NormalTok{ ((}\OperatorTok{+}\DecValTok{4}\NormalTok{) }\OperatorTok{.}\NormalTok{ (}\OperatorTok{\^{}}\DecValTok{2}\NormalTok{)) }\OperatorTok{$} \DecValTok{4}
\DataTypeTok{True}
\end{Highlighting}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{ghci}\OperatorTok{>}\NormalTok{      (}\OperatorTok{*}\DecValTok{3}\NormalTok{) }\OperatorTok{$} \DecValTok{7}
\DecValTok{21}
\NormalTok{ghci}\OperatorTok{>} \FunctionTok{id} \OperatorTok{.}\NormalTok{ (}\OperatorTok{*}\DecValTok{3}\NormalTok{) }\OperatorTok{$} \DecValTok{7}
\DecValTok{21}
\NormalTok{ghci}\OperatorTok{>}\NormalTok{ (}\OperatorTok{*}\DecValTok{3}\NormalTok{) }\OperatorTok{.} \FunctionTok{id} \OperatorTok{$} \DecValTok{7}
\DecValTok{21}
\end{Highlighting}
\end{Shaded}
...
\OtherTok{(\textasciitilde{}.\textasciitilde{}) ::} \DataTypeTok{Auto}\NormalTok{ b c }\OtherTok{{-}>} \DataTypeTok{Auto}\NormalTok{ a b }\OtherTok{{-}>} \DataTypeTok{Auto}\NormalTok{ a c}
\NormalTok{g }\OperatorTok{\textasciitilde{}.\textasciitilde{}}\NormalTok{ f }\OtherTok{=} \DataTypeTok{ACons} \OperatorTok{$}\NormalTok{ \textbackslash{}x }\OtherTok{{-}>} \KeywordTok{let}\NormalTok{ (y, f\textquotesingle{}) }\OtherTok{=}\NormalTok{ runAuto f x}
...
\NormalTok{toAuto f }\OtherTok{=} \DataTypeTok{ACons} \OperatorTok{$}\NormalTok{ \textbackslash{}x }\OtherTok{{-}>}\NormalTok{ (f x, toAuto f)}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{idA }\OtherTok{=} \DataTypeTok{ACons} \OperatorTok{$}\NormalTok{ \textbackslash{}x }\OtherTok{{-}>}\NormalTok{ (x, idA)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{ghci}\OperatorTok{>}\NormalTok{ doTwice (}\OperatorTok{*}\DecValTok{2}\NormalTok{) }\DecValTok{5}
\DecValTok{20}
\NormalTok{ghci}\OperatorTok{>}\NormalTok{ testAuto\_ (doTwice (toAuto (}\OperatorTok{*}\DecValTok{2}\NormalTok{))) [}\DecValTok{5}\NormalTok{]}
\NormalTok{[}\DecValTok{20}\NormalTok{]}
\NormalTok{ghci}\OperatorTok{>}\NormalTok{ testAuto\_ (doTwice summer) [}\DecValTok{5}\NormalTok{,}\DecValTok{1}\NormalTok{,}\DecValTok{9}\NormalTok{,}\DecValTok{2}\NormalTok{,}\OperatorTok{{-}}\DecValTok{3}\NormalTok{,}\DecValTok{4}\NormalTok{]}
...
\NormalTok{ghci}\OperatorTok{>} \FunctionTok{take} \DecValTok{6} \OperatorTok{$}\NormalTok{ testAuto\_ (doTwice summer) (}\FunctionTok{repeat} \DecValTok{1}\NormalTok{)}
...
\KeywordTok{instance} \DataTypeTok{Applicative}\NormalTok{ (}\DataTypeTok{Auto}\NormalTok{ r) }\KeywordTok{where}
    \FunctionTok{pure}\NormalTok{ y    }\OtherTok{=} \DataTypeTok{ACons} \OperatorTok{$}\NormalTok{ \textbackslash{}\_ }\OtherTok{{-}>}\NormalTok{ (y, }\FunctionTok{pure}\NormalTok{ y)}
\NormalTok{    af }\OperatorTok{<*>}\NormalTok{ ay }\OtherTok{=} \DataTypeTok{ACons} \OperatorTok{$}\NormalTok{ \textbackslash{}x }\OtherTok{{-}>}
...
\NormalTok{                      (y, ay\textquotesingle{}) }\OtherTok{=}\NormalTok{ runAuto ay x}
                  \KeywordTok{in}\NormalTok{  (f y, af\textquotesingle{} }\OperatorTok{<*>}\NormalTok{ ay\textquotesingle{})}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{ghci}\OperatorTok{>} \KeywordTok{let}\NormalTok{ sumDoub }\OtherTok{=}\NormalTok{ summer }\OperatorTok{\&\&\&}\NormalTok{ doubleA}
\NormalTok{ghci}\OperatorTok{>}\NormalTok{ testAuto\_ sumDoub [}\DecValTok{5}\NormalTok{,}\DecValTok{1}\NormalTok{,}\DecValTok{9}\NormalTok{,}\DecValTok{2}\NormalTok{,}\OperatorTok{{-}}\DecValTok{3}\NormalTok{,}\DecValTok{4}\NormalTok{]}
...
\NormalTok{    left a }\OtherTok{=} \DataTypeTok{ACons} \OperatorTok{$}\NormalTok{ \textbackslash{}x }\OtherTok{{-}>}
...
\hypertarget{simple-useful-example}{%
...
\NormalTok{dualCounterR }\OtherTok{=}\NormalTok{ dualCounterWith (}\DecValTok{0}\NormalTok{, }\DecValTok{0}\NormalTok{)}
  \KeywordTok{where}
\NormalTok{    dualCounterWith (x, y) }\OtherTok{=} \DataTypeTok{ACons} \OperatorTok{$}\NormalTok{ \textbackslash{}inp }\OtherTok{{-}>}
                               \KeywordTok{let}\NormalTok{ newC }\OtherTok{=} \KeywordTok{case}\NormalTok{ inp }\KeywordTok{of}
                                            \DataTypeTok{Left}\NormalTok{ i  }\OtherTok{{-}>}\NormalTok{ (x }\OperatorTok{+}\NormalTok{ i, y)}
                                            \DataTypeTok{Right}\NormalTok{ i }\OtherTok{{-}>}\NormalTok{ (x, y }\OperatorTok{+} \DecValTok{1}\NormalTok{)}
...
\hypertarget{locally-stateful-composition}{%
...
\NormalTok{    counterFrom ((x, y), s) }\OtherTok{=}
      \DataTypeTok{ACons} \OperatorTok{$}\NormalTok{ \textbackslash{}inp }\OtherTok{{-}>}
        \KeywordTok{let}\NormalTok{ newCS }\OtherTok{=} \KeywordTok{case}\NormalTok{ inp }\KeywordTok{of}
                      \DataTypeTok{Left}\NormalTok{ i  }\OperatorTok{|} \FunctionTok{odd}\NormalTok{ s     }\OtherTok{{-}>}\NormalTok{ ((x }\OperatorTok{+}\NormalTok{ i, y), s }\OperatorTok{+} \DecValTok{1}\NormalTok{)}
                              \OperatorTok{|} \FunctionTok{otherwise} \OtherTok{{-}>}\NormalTok{ ((x    , y), s }\OperatorTok{+} \DecValTok{1}\NormalTok{)}
                      \DataTypeTok{Right}\NormalTok{ i             }\OtherTok{{-}>}\NormalTok{ ((x, y }\OperatorTok{+}\NormalTok{ i), s    )}
