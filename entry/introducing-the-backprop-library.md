...
functions computing their gradients. This has been something I've been working
on for a while (trying to find a good API for *heterogeneous* automatic
differentiation), and I'm happy to finally find something that I feel good
...
error. It tells us how to "nudge" each component to increase the error function.
