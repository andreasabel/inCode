...
\NormalTok{promptFoo }\OtherTok{=} \DataTypeTok{Foo}
        \OperatorTok{<$>}\NormalTok{ prompt }\StringTok{"bar"}
        \OperatorTok{<*>} \FunctionTok{fmap} \FunctionTok{length}\NormalTok{ (prompt }\StringTok{"baz"}\NormalTok{)}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{ghci}\OperatorTok{>}\NormalTok{ runPromptM promptFoo }\OperatorTok{$}\NormalTok{ \textbackslash{}str }\OtherTok{{-}>} \FunctionTok{putStrLn}\NormalTok{ str }\OperatorTok{>>} \FunctionTok{getLine}
\NormalTok{bar                 }\CommentTok{{-}{-} stdout prompt}
\OperatorTok{>}\NormalTok{ hello}\OperatorTok{!}            \CommentTok{{-}{-} stdin response typed in}
\NormalTok{baz                 }\CommentTok{{-}{-} stdout prompt}
\OperatorTok{>}\NormalTok{ i am baz          }\CommentTok{{-}{-} stdin response typed in}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{ghci}\OperatorTok{>} \KeywordTok{import} \DataTypeTok{System.Environment}
\NormalTok{ghci}\OperatorTok{>}\NormalTok{ setEnv }\StringTok{"bar"} \StringTok{"hello!"}
\NormalTok{ghci}\OperatorTok{>}\NormalTok{ setEnv }\StringTok{"baz"} \StringTok{"i am baz"}
\NormalTok{ghci}\OperatorTok{>}\NormalTok{ runPromptM promptFoo getEnv}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{ghci}\OperatorTok{>} \KeywordTok{import} \KeywordTok{qualified} \DataTypeTok{Data.Map} \KeywordTok{as} \DataTypeTok{M}
\NormalTok{ghci}\OperatorTok{>} \KeywordTok{let}\NormalTok{ testMap }\OtherTok{=}\NormalTok{ M.fromList [(}\StringTok{"bar"}\NormalTok{, }\StringTok{"hello!"}\NormalTok{), (}\StringTok{"baz"}\NormalTok{, }\StringTok{"i am baz"}\NormalTok{)]}
\NormalTok{ghci}\OperatorTok{>}\NormalTok{ runPrompt promptFoo (testMap }\OperatorTok{M.!}\NormalTok{)}
\DataTypeTok{Foo} \StringTok{"hello!"} \DecValTok{8}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{ghci}\OperatorTok{>} \KeywordTok{let}\NormalTok{ logHelloWord }\OtherTok{=} \FunctionTok{mapM\_}\NormalTok{ prompt [}\StringTok{"hello"}\NormalTok{, }\StringTok{"world"}\NormalTok{]}
\NormalTok{ghci}\OperatorTok{>}\NormalTok{ runPromptM logHelloWorld }\FunctionTok{putStrLn}
\NormalTok{hello}
\NormalTok{world}
\NormalTok{ghci}\OperatorTok{>}\NormalTok{ execWriter }\OperatorTok{$}\NormalTok{ runPromptM logHelloWorld tell}
...
\NormalTok{    str }\OtherTok{<{-}}\NormalTok{ prompt }\StringTok{"baz"}
    \KeywordTok{case}\NormalTok{ readMaybe str }\KeywordTok{of}
        \DataTypeTok{Just}\NormalTok{ baz }\OtherTok{{-}>} \FunctionTok{return} \OperatorTok{$} \DataTypeTok{Foo}\NormalTok{ bar baz}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{ghci}\OperatorTok{>}\NormalTok{ interactP }\OperatorTok{.}\NormalTok{ runMaybeT }\OperatorTok{$}\NormalTok{ promptFoo2}
\NormalTok{bar}
\OperatorTok{>}\NormalTok{ hello}\OperatorTok{!}
\NormalTok{baz}
\OperatorTok{>}\NormalTok{ i am baz}
\DataTypeTok{Nothing}
\NormalTok{ghci}\OperatorTok{>}\NormalTok{ interactP }\OperatorTok{.}\NormalTok{ runMaybeT }\OperatorTok{$}\NormalTok{ promptFoo2}
\NormalTok{bar}
\OperatorTok{>}\NormalTok{ hello}\OperatorTok{!}
\NormalTok{baz}
\OperatorTok{>} \DecValTok{19}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{ghci}\OperatorTok{>}\NormalTok{ interactPT promptFoo2}
\NormalTok{bar}
\OperatorTok{>}\NormalTok{ hello}\OperatorTok{!}
\NormalTok{baz}
\OperatorTok{>}\NormalTok{ i am baz}
\DataTypeTok{Nothing}
\NormalTok{ghci}\OperatorTok{>}\NormalTok{ interactPT }\OperatorTok{$}\NormalTok{ promptFoo2 }\OperatorTok{<|>}\NormalTok{ promptFoo}
\NormalTok{bar}
\OperatorTok{>}\NormalTok{ hello}\OperatorTok{!}
\NormalTok{baz}
\OperatorTok{>}\NormalTok{ i am baz}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{ghci}\OperatorTok{>}\NormalTok{ runPromptT (}\OtherTok{logHelloWorld ::} \DataTypeTok{PromptT} \DataTypeTok{String}\NormalTok{ () (}\DataTypeTok{Writer} \DataTypeTok{String}\NormalTok{) ()) tell}
\StringTok{"helloworld"}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{    resp }\OtherTok{<{-}}\NormalTok{ prompt k}
    \KeywordTok{case}\NormalTok{ readMaybe resp }\KeywordTok{of}
      \DataTypeTok{Nothing} \OtherTok{{-}>}\NormalTok{ throwError }\OperatorTok{$} \DataTypeTok{MEParse}\NormalTok{ k resp}
      \DataTypeTok{Just}\NormalTok{ v  }\OtherTok{{-}>} \FunctionTok{return}\NormalTok{ v}
...
\NormalTok{promptFoo3 }\OtherTok{=} \DataTypeTok{Foo} \OperatorTok{<$>}\NormalTok{ prompt }\StringTok{"bar"} \OperatorTok{<*>}\NormalTok{ promptRead }\StringTok{"baz"}
...
\NormalTok{throughEnv }\OtherTok{=}\NormalTok{ runPromptTM parseFoo3 }\OperatorTok{$}\NormalTok{ \textbackslash{}k }\OtherTok{{-}>} \KeywordTok{do}
...
\NormalTok{throughStdIOBlankIsError }\OtherTok{=}\NormalTok{ runPromptTM parseFoo3 }\OperatorTok{$}\NormalTok{ \textbackslash{}k }\OtherTok{{-}>} \KeywordTok{do}
    \FunctionTok{putStrLn}\NormalTok{ k}
\NormalTok{    resp }\OtherTok{<{-}} \FunctionTok{getLine}
...
\NormalTok{throughMap m }\OtherTok{=}\NormalTok{ runPromptT parseFoo3 }\OperatorTok{$}\NormalTok{ \textbackslash{}k }\OtherTok{{-}>}
...
\begin{Shaded}
\begin{Highlighting}[]
\KeywordTok{newtype} \DataTypeTok{PromptT}\NormalTok{ a b t r }\OtherTok{=} \DataTypeTok{PromptT}\NormalTok{ \{}\OtherTok{ runPromptTM ::} \KeywordTok{forall}\NormalTok{ m}\OperatorTok{.} \DataTypeTok{Monad}\NormalTok{ m }\OtherTok{=>}\NormalTok{ (a }\OtherTok{{-}>}\NormalTok{ m (t b)) }\OtherTok{{-}>}\NormalTok{ m (t r) \}}
\end{Highlighting}
\end{Shaded}
