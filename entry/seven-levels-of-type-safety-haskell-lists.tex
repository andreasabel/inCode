...
\NormalTok{    items}\OperatorTok{@}\NormalTok{(}\DataTypeTok{MkSomeList} \DataTypeTok{WitOrd}\NormalTok{ xs) }\OtherTok{<{-}}\NormalTok{ getItems}
...
\begin{Shaded}
\begin{Highlighting}[]
\OtherTok{hlistToSomeList ::} \DataTypeTok{HList} \DataTypeTok{TypeRep} \OtherTok{{-}>} \DataTypeTok{Maybe}\NormalTok{ (}\DataTypeTok{SomeList} \DataTypeTok{TypeRep}\NormalTok{)}
