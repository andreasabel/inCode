...
\NormalTok{       help    argHelp}
    \OperatorTok{<>}\NormalTok{ metavar argName}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{ghci}\OperatorTok{>}\NormalTok{ testParser (argParser (}\FunctionTok{map} \FunctionTok{toUpper} \OperatorTok{<$>}\NormalTok{ nameArg)) }\StringTok{"carol"}
\StringTok{"CAROL"}
\end{Highlighting}
\end{Shaded}
...
\NormalTok{       long optString}
    \OperatorTok{<>}\NormalTok{ help optHelp}
    \OperatorTok{<>}\NormalTok{ metavar optMeta}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\NormalTok{ghci}\OperatorTok{>}\NormalTok{ optSummary ageOpt}
\DataTypeTok{Const}\NormalTok{ [}\StringTok{"--age <int>: A pesron's age"}\NormalTok{]}
\NormalTok{ghci}\OperatorTok{>}\NormalTok{ testParser (optParser ageOpt) }\StringTok{"--help"}
\CommentTok{-- Usage: <interactive> --age <int>}
\CommentTok{--}
\CommentTok{-- Available options:}
\CommentTok{--   --age <int>              A person's age}
\CommentTok{--   -h,--help                Show this help text}
\NormalTok{ghci}\OperatorTok{>}\NormalTok{ testParser (optParser ageOpt) }\StringTok{"--age 25"}
\CommentTok{-- 25}
\NormalTok{ghci}\OperatorTok{>}\NormalTok{ testParser (optParser ((}\OperatorTok{*}\DecValTok{2}\NormalTok{) }\OperatorTok{<$>}\NormalTok{ ageOpt)) }\StringTok{"--age 25"}
\CommentTok{-- 50}
\end{Highlighting}
\end{Shaded}
...
\begin{Shaded}
\begin{Highlighting}[]
\CommentTok{-- source: https://github.com/mstksg/inCode/tree/master/code-samples/misc/applicative-interp.hs#L67-L74}

\OtherTok{flagSummary ::} \DataTypeTok{Flag}\NormalTok{ a }\OtherTok{->} \DataTypeTok{Summary}\NormalTok{ a}
\NormalTok{flagSummary }\DataTypeTok{Flag}\NormalTok{\{}\OperatorTok{..}\NormalTok{\} }\OtherTok{=} \DataTypeTok{Const}
\NormalTok{    [ }\StringTok{"--"} \OperatorTok{++}\NormalTok{ flagString }\OperatorTok{++} \StringTok{": "} \OperatorTok{++}\NormalTok{ flagHelp ]}

\OtherTok{flagParser ::} \DataTypeTok{Flag}\NormalTok{ a }\OtherTok{->} \DataTypeTok{Parser}\NormalTok{ a}
\NormalTok{flagParser }\DataTypeTok{Flag}\NormalTok{\{}\OperatorTok{..}\NormalTok{\} }\OtherTok{=}\NormalTok{ switch }\OperatorTok{$}
\NormalTok{       long flagString}
    \OperatorTok{<>}\NormalTok{ help flagHelp}
\end{Highlighting}
\end{Shaded}
